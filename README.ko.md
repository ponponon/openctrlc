...
OpenCtrlC 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/ponponon/openctrlc/releases) 에서 직접 다운로드하세요.
