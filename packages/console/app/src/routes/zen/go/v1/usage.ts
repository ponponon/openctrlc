...
import { and, Database, eq, isNull } from "@openctrlc/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@openctrlc/console-core/schema/billing.sql.js"
    ...
    return new Response(
      JSON.stringify({
        ...
        error: {
          ...
          message: "OpenCtrlC hosted subscription is not configured.",
        },
      }),
      {
        status: 403,
