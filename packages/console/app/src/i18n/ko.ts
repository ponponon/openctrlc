...
export const dict = {
  ...
  "home.faq.a3.p1": "꼭 그렇지는 않습니다. OpenCtrlC에는 계정 없이도 사용할 수 있는 무료 모델 세트가 포함되어 있습니다.",
  ...
  "download.faq.a3.afterZen": " 사용을 권장하지만, OpenCtrlC는 OpenAI, Anthropic, xAI 등 모든 인기 제공자와 작동합니다.",
