export const dict = {
  ...
  "notFound.title": "Not Found | openctrlc",
  ...
  "temp.feature.zen.afterLink": "provided by openctrlc",
  "temp.feature.models.beforeLink": "Supports 75+ LLM providers through",
  "temp.feature.models.afterLink": ", including local models",
  "temp.screenshot.caption": "openctrlc TUI with the tokyonight theme",
  "temp.screenshot.alt": "openctrlc TUI with tokyonight theme",
  ...
  "home.what.title": "What is OpenCtrlC?",
  "home.what.body": "OpenCtrlC is an open source agent that helps you write code in your terminal, IDE, or desktop.",
  ...
  "home.growth.body":
    "With over <strong>{{stars}}</strong> GitHub stars, <strong>{{contributors}}</strong> contributors, and over <strong>{{commits}}</strong> commits, OpenCtrlC is used and trusted by over <strong>{{monthlyUsers}}</strong> developers every month.",
  ...
  "home.privacy.body":
    "OpenCtrlC does not store any of your code or context data, so that it can operate in privacy sensitive environments.",
  "home.privacy.learnMore": "Learn more about",
  "home.privacy.link": "privacy",

  "home.faq.q1": "What is OpenCtrlC?",
  "home.faq.a1":
    "OpenCtrlC is an open source agent that helps you write and run code with any AI model. It's available as a terminal-based interface, desktop app, or IDE extension.",
  "home.faq.q2": "How do I use OpenCtrlC?",
  "home.faq.a2.before": "The easiest way to get started is to read the",
  "home.faq.a2.link": "intro",
  "home.faq.q3": "Do I need extra AI subscriptions to use OpenCtrlC?",
  "home.faq.a3.p1":
    "Not necessarily, OpenCtrlC comes with a set of free models that you can use without creating an account.",
  ...
  "home.faq.a3.p3":
    "While we encourage users to use Zen, OpenCtrlC also works with all popular providers such as OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "You can even connect your",
  "home.faq.a3.p4.localLink": "local models",
  "home.faq.q4": "Can I use my existing AI subscriptions with OpenCtrlC?",
  "home.faq.a4.p1":
    "Yes, OpenCtrlC supports subscription plans from all major providers. You can use your Claude Pro/Max, ChatGPT Plus/Pro, or GitHub Copilot subscriptions.",
  "home.faq.q5": "Can I only use OpenCtrlC in the terminal?",
  "home.faq.a5.beforeDesktop": "Not anymore! OpenCtrlC is now available as an app for your",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "and",
  "home.faq.a5.web": "web",
  "home.faq.q6": "How much does OpenCtrlC cost?",
  "home.faq.a6":
    "OpenCtrlC is 100% free to use. It also comes with a set of free models. There might be additional costs if you connect any other provider.",
  ...
  "home.faq.q8": "Is OpenCtrlC open source?",
  "home.faq.a8.p1": "Yes, OpenCtrlC is fully open source. The source code is public on",
  ...
  "home.zenCta.body":
    "Zen gives you access to a handpicked set of AI models that OpenCtrlC has tested and benchmarked specifically for coding agents. No need to worry about inconsistent performance and quality across providers, use validated models that work.",
  "home.zenCta.link": "Learn about Zen",

  "zen.title": "OpenCtrlC Zen | A curated set of reliable optimized models for coding agents",
  "zen.hero.title": "Reliable optimized models for coding agents",
  "zen.hero.body":
    "Zen gives you access to a curated set of AI models that OpenCtrlC has tested and benchmarked specifically for coding agents. No need to worry about inconsistent performance and quality, use validated models that work.",

  "zen.faq.q1": "What is OpenCtrlC Zen?",
  "zen.faq.a1":
    "Zen is a curated set of AI models tested and benchmarked for coding agents created by the team behind OpenCtrlC.",
  ...
  "zen.faq.a3":
    "Zen is not for profit. Zen passes through the costs from the model providers to you. The higher Zen's usage the more OpenCtrlC can negotiate better rates and pass those to you.",
  ...
  "zen.faq.a4.p3":
    "To cover costs, OpenCtrlC adds only a small payment processing fee of $1.23 per $20 balance top-up.",
  ...
  "zen.faq.a8":
    "While Zen works great with OpenCtrlC, you can use Zen with any agent. Follow the setup instructions in your preferred coding agent.",
  ...
  "zen.problem.subtitle": "We're fixing this for everyone, not just OpenCtrlC users.",
  ...
  "zen.how.body": "While we suggest you use Zen with OpenCtrlC, you can use Zen with any agent.",
  ...
  "go.title": "OpenCtrlC Go | Low cost coding models for everyone",
  "go.meta.description":
  ...
  "go.problem.body":
    "We're focused on bringing the OpenCtrlC experience to as many people as possible. OpenCtrlC Go is a low cost subscription: $5 for your first month, then $10/month. It provides generous limits and reliable access to the most capable open source models.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go starts at $5 for your first month, then $10/month. You can use it with OpenCtrlC or any agent.",
  ...
  "go.faq.q1": "What is OpenCtrlC Go?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "Free promotion has ended for {{model}}. You can continue using the model by subscribing to OpenCtrlC Go - {{link}}",

  "black.meta.title": "OpenCtrlC Black | Access all the world's best coding models",
  "black.meta.description": "Get access to Claude, GPT, Gemini and more with OpenCtrlC Black subscription plans.",
  "black.hero.title": "Access all the world's best coding models",
  "black.hero.subtitle": "Including Claude, GPT, Gemini and more",
  "black.title": "OpenCtrlC Black | Pricing",
  ...
  "black.workspace.title": "OpenCtrlC Black | Select Workspace",
  "black.workspace.selectPlan": "Select a workspace for this plan",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Subscribe to OpenCtrlC Black",
  ...
  "black.subscribe.success.title": "You're on the OpenCtrlC Black waitlist",
  ...
  "workspace.newUser.feature.lockin.body":
    "Use Zen with any coding agent, and continue using other providers with openctrlc whenever you want.",
  ...
  "workspace.newUser.step.login.after": "and select openctrlc",
  "workspace.newUser.step.pasteKey": "Paste your API key",
  "workspace.newUser.step.models.before": "Start openctrlc and run",
  ...
  "workspace.keys.subtitle": "Manage your API keys for accessing openctrlc services.",
  "workspace.keys.create": "Create API Key",
  "workspace.keys.placeholder": "Enter key name",
  "workspace.keys.empty": "Create an openctrlc Gateway API key",
  ...
  "workspace.black.subscription.message": "You are subscribed to OpenCtrlC Black for ${{plan}} per month.",
  ...
  "workspace.black.waitlist.joined": "You are on the waitlist for the ${{plan}} per month OpenCtrlC Black plan.",
  "workspace.black.waitlist.ready": "We're ready to enroll you into the ${{plan}} per month OpenCtrlC Black plan.",
  ...
  "workspace.lite.subscription.message": "You are subscribed to OpenCtrlC Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Select "OpenCtrlC Go" as the provider in your openctrlc configuration to use Go models.',
  ...
  "workspace.lite.black.message":
    "You're currently subscribed to OpenCtrlC Black or on the waitlist. Please unsubscribe first if you'd like to switch to Go.",
  "workspace.lite.other.message":
    "Another member in this workspace is already subscribed to OpenCtrlC Go. Only one member per workspace can subscribe.",
  "workspace.lite.promo.description":
    "OpenCtrlC Go starts at {{price}}, then $10/month, and provides reliable access to popular open coding models with generous usage limits.",
  ...
  "download.meta.description": "Download OpenCtrlC for macOS, Windows, and Linux",
  ...
  "download.platform.macosIntelNote":
    "On macOS, the Desktop app is currently published for Apple Silicon only. Intel Macs can use the CLI download.",
  ...
  "download.faq.a3.beforeLocal":
    "Not necessarily, but probably. You'll need an AI subscription if you want to connect OpenCtrlC to a paid provider, although you can work with",
  "download.faq.a3.localLink": "local models",
  "download.faq.a3.afterLocal.beforeZen": "for free. While we encourage users to use",
  "download.faq.a3.afterZen": ", OpenCtrlC works with all popular providers such as OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "OpenCtrlC is 100% free to use.",
  "download.faq.a5.p2.beforeZen":
    "Any additional costs will come from your subscription to a model provider. While OpenCtrlC works with any model provider, we recommend using",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Your data and information is only stored when you create sharable links in OpenCtrlC.",
  "download.faq.a6.p2.beforeShare": "Learn more about",
  "download.faq.a6.shareLink": "share pages",

  "enterprise.title": "OpenCtrlC | Enterprise solutions for your organisation",
  "enterprise.meta.description": "Contact OpenCtrlC for enterprise solutions",
  "enterprise.hero.title": "Your code is yours",
  "enterprise.hero.body1":
    "OpenCtrlC operates securely inside your organization with no data or context stored and no licensing restrictions or ownership claims. Start a trial with your team, then deploy it across your organization by integrating it with your SSO and internal AI gateway.",
  ...
  "enterprise.faq.q1": "What is OpenCtrlC Enterprise?",
  "enterprise.faq.a1":
  ...
  "enterprise.faq.q2": "How do I get started with OpenCtrlC Enterprise?",
  "enterprise.faq.a2":
    "Simply start with an internal trial with your team. OpenCtrlC by default does not store your code or context data, making it easy to get started. Then contact us to discuss pricing and implementation options.",
  ...
  "enterprise.faq.q4": "Is my data secure with OpenCtrlC Enterprise?",
  "enterprise.faq.a4":
  ...
  "brand.meta.description": "OpenCtrlC brand guidelines",
  "brand.heading": "Brand guidelines",
  "brand.subtitle": "Resources and assets to help you work with the OpenCtrlC brand.",
  "brand.downloadAll": "Download all assets",

  "changelog.title": "OpenCtrlC | Changelog",
  "changelog.meta.description": "OpenCtrlC release notes and changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "New updates and improvements to OpenCtrlC",
