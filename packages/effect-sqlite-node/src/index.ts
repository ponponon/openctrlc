...
export const TypeId: TypeId = "~@openctrlc/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@openctrlc/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@openctrlc/effect-sqlite-node/NodeSqliteClient")
