import { OpenCode } from "@openctrlc/client/effect"
...
import { createEmbeddedRoutes } from "@openctrlc/server/routes"
...
export class Service extends Context.Service<Service, Interface>()("@openctrlc/sdk-next/OpenCode") {}
