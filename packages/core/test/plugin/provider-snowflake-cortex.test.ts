...
import { SnowflakeCortexPlugin, cortexFetch } from "@openctrlc/core/plugin/provider/snowflake-cortex"
import { ProviderPlugins } from "@openctrlc/core/plugin/provider"
