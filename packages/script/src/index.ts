...
const env = {
  OPENCTRLC_CHANNEL: process.env["OPENCTRLC_CHANNEL"],
  OPENCTRLC_BUMP: process.env["OPENCTRLC_BUMP"],
  OPENCTRLC_VERSION: process.env["OPENCTRLC_VERSION"],
...
const VERSION = await (async () => {
  ...
  const t = env.OPENCTRLC_BUMP?.toLowerCase()
