...
import { SessionProgressIndicatorV2 } from "@openctrlc/session-ui/v2/session-progress-indicator-v2"
...
export function SessionTabAvatar(props: {
  ...
  return (
    <SessionTabAvatarView
      ...
      unread={state.unread()}
      unreadTone={state.hasError() ? "error" : undefined}
