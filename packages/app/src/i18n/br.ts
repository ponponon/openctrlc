export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do OpenCtrlC",
  ...
  "desktop.menu.ariaLabel": "Menu do OpenCtrlC",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o OpenCtrlC",
  "desktop.recovery.terminated": "A janela do OpenCtrlC foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O OpenCtrlC não está respondendo",
  ...
  "desktop.wsl.error.installOpenctrlc": "Falha na instalação do OpenCtrlC",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.openctrlcMissing": "O openctrlc não está instalado nesta distribuição",
  "desktop.wsl.error.openctrlcCannotRun": "O openctrlc está instalado, mas não pôde ser executado",
  "desktop.wsl.error.openctrlcNotInstalled": "O OpenCtrlC não está instalado em {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "A atualização do OpenCtrlC foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Aceitar permissões automaticamente",
  "prompt.permissions.autoaccept.enabled": "Aceitando permissões automaticamente",
  "prompt.permissions.autoaccept.enable": "Aceitar permissões automaticamente",
  "prompt.permissions.autoaccept.disable": "Parar de aceitar permissões automaticamente",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no OpenCtrlC.",
  ...
  "dialog.plugins.empty": "Plugins configurados em openctrlc.json",
  ...
  "dialog.server.description": "Trocar para qual servidor OpenCtrlC este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Verificando o OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Verificando o OpenCtrlC em {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Atualizando o OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Atualizando o OpenCtrlC em {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Atualize o OpenCtrlC em {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Atualizar o OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "O OpenCtrlC está pronto em {{distro}}.",
  "wsl.onboarding.openctrlcReady": "O OpenCtrlC está pronto.",
  "wsl.onboarding.installOpenctrlcIn": "Instale o OpenCtrlC em {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Instalar o OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o OpenCtrlC possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O OpenCtrlC não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o OpenCtrlC novamente.",
  ...
  "help.tabs.introduction": "Agora, o OpenCtrlC Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do OpenCtrlC ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do OpenCtrlC",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (openctrlc.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: OpenCtrlC ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor OpenCtrlC dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "Personalize como o OpenCtrlC aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o OpenCtrlC segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o OpenCtrlC é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o OpenCtrlC iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do OpenCtrlC.",
  ...
  "session.search.placeholder": "Pesquisar nesta sessão",
  "session.search.input": "Pesquisar mensagens da sessão",
  "session.search.scope": "Escopo da pesquisa",
  "session.search.scope.conversation": "Conversa",
  "session.search.scope.all": "Todo o conteúdo",
  "session.search.results": "{{current}} de {{total}} resultados",
  "session.search.noResults": "Nenhum resultado",
  "session.search.loading": "Carregando resultados...",
  "session.search.partial": "Histórico parcial",
  "session.search.retry": "Tentar novamente",
  "session.search.previous": "Resultado anterior",
  "session.search.next": "Próximo resultado",
  "session.search.close": "Fechar pesquisa",
