export const dict = {
  ...
  "desktop.menu.documentation": "OpenCtrlC दस्तावेज़",
  ...
  "desktop.menu.ariaLabel": "OpenCtrlC मेन्यू",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC लोड नहीं हो सका",
  "desktop.recovery.terminated": "OpenCtrlC विंडो अनपेक्षित रूप से बंद हो गई",
  "desktop.recovery.unresponsive": "OpenCtrlC प्रतिसाद नहीं दे रहा है",
  ...
  "desktop.wsl.error.installOpenctrlc": "OpenCtrlC इंस्टॉल नहीं हो सका",
  "desktop.wsl.error.alreadyAdded": "{{distro}} पहले ही जोड़ा जा चुका है",
  "desktop.wsl.error.openctrlcMissing": "इस डिस्ट्रो में openctrlc इंस्टॉल नहीं है",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc इंस्टॉल है, लेकिन चल नहीं सका",
  "desktop.wsl.error.openctrlcNotInstalled": "{{distro}} में OpenCtrlC इंस्टॉल नहीं है",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC अपडेट पूरा हो गया, लेकिन {{distro}} अब भी {{installed}} रिपोर्ट कर रहा है; अपेक्षित संस्करण {{expected}} है",
  ...
  "prompt.permissions.autoaccept": "अनुमतियाँ स्वतः स्वीकार करें",
  "prompt.permissions.autoaccept.enabled": "अनुमतियाँ स्वतः स्वीकार करना",
  "prompt.permissions.autoaccept.enable": "अनुमतियाँ स्वतः स्वीकार करें",
  "prompt.permissions.autoaccept.disable": "अनुमतियाँ स्वत: स्वीकार करना बंद करें",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenCtrlC द्वारा उपलब्ध निःशुल्क मॉडल",
  ...
  "provider.connect.apiKey.description":
    "अपने खाते को कनेक्ट करने के लिए अपनी {{provider}} API कुंजी दर्ज करें और OpenCtrlC में {{provider}} मॉडल का उपयोग करें।",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " अपने खाते को कनेक्ट करने और OpenCtrlC में {{provider}} मॉडल का उपयोग करने के लिए अपना प्राधिकरण कोड प्राप्त करें।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " और अपने खाते को कनेक्ट करने तथा OpenCtrlC में {{provider}} मॉडल का उपयोग करने के लिए नीचे दिया गया कोड दर्ज करें।",
  ...
  "dialog.plugins.empty": "प्लगइन openctrlc.json में कॉन्फ़िगर किए गए हैं",
  ...
  "dialog.server.description": "स्विच करें कि यह ऐप किस OpenCtrlC सर्वर से कनेक्ट होता है।",
  ...
  "wsl.onboarding.checkingOpenctrlc": "OpenCtrlC की जाँच हो रही है...",
  "wsl.onboarding.checkingOpenctrlcIn": "{{distro}} में OpenCtrlC की जाँच हो रही है...",
  "wsl.onboarding.updatingOpenctrlc": "OpenCtrlC अपडेट हो रहा है...",
  "wsl.onboarding.updatingOpenctrlcIn": "{{distro}} में OpenCtrlC अपडेट हो रहा है...",
  "wsl.onboarding.updateOpenctrlcIn": "{{distro}} में OpenCtrlC को अपडेट करें।",
  "wsl.onboarding.updateOpenctrlc": "OpenCtrlC को अपडेट करें",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC {{distro}} में तैयार है।",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC तैयार है।",
  "wsl.onboarding.installOpenctrlcIn": "{{distro}} में OpenCtrlC स्थापित करें।",
  "wsl.onboarding.installOpenctrlc": "OpenCtrlC स्थापित करें",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC स्थापित नहीं है",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "OpenCtrlC द्वारा WSL सर्वर जोड़ने से पहले WSL (Linux के लिए Windows सबसिस्टम) आवश्यक है",
  "wsl.onboarding.wslUnavailable.title": "WSL अनुपलब्ध है",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC इस मशीन पर WSL को सत्यापित नहीं कर सका।",
  "wsl.onboarding.installWsl": "WSL स्थापित करें",
  "wsl.onboarding.windowsRestartRequired":
    "WSL की स्थापना समाप्त करने के लिए Windows को पुनरारंभ करें, फिर OpenCtrlC को फिर से खोलें।",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop अब टैब पर आधारित है।",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "कृपया इस त्रुटि की रिपोर्ट OpenCtrlC टीम को करें",
  ...
  "error.chain.checkConfig": "अपने कॉन्फ़िगरेशन (openctrlc.json) प्रोवाइडर/मॉडल नामों की जाँच करें",
  "error.chain.mcpFailed":
    'MCP सर्वर "{{name}}" विफल रहा। ध्यान दें, OpenCtrlC अभी तक MCP प्रमाणीकरण का समर्थन नहीं करता है।',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC में निःशुल्क मॉडल शामिल है ताकि आप तुरंत शुरू कर सकें।",
  ...
  "settings.desktop.wsl.description": "Windows पर WSL के अंदर OpenCtrlC सर्वर चलाएँ।",
  ...
  "settings.general.row.language.description": "OpenCtrlC के लिए प्रदर्शन भाषा बदलें",
  ...
  "settings.general.row.appearance.description": "अनुकूलित करें कि OpenCtrlC आपके डिवाइस पर कैसा दिखता है",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description": "चुनें कि OpenCtrlC सिस्टम, हल्की या गहरी थीम में से किसका उपयोग करे",
  "settings.general.row.theme.title": "थीम",
  "settings.general.row.theme.description": "अनुकूलित करें कि OpenCtrlC की थीम कैसी है।",
  ...
  "settings.updates.row.startup.description": "OpenCtrlC लॉन्च होने पर अपने-आप अपडेट की जाँच करें",
  ...
  "settings.updates.toast.latest.description": "आप OpenCtrlC का नवीनतम संस्करण चला रहे हैं।",
  ...
  "session.search.placeholder": "इस सत्र में खोजें",
  "session.search.input": "सत्र संदेशों में खोजें",
  "session.search.scope": "खोज का दायरा",
  "session.search.scope.conversation": "वार्तालाप",
  "session.search.scope.all": "सभी सामग्री",
  "session.search.results": "{{total}} परिणामों में {{current}}",
  "session.search.noResults": "कोई परिणाम नहीं",
  "session.search.loading": "परिणाम लोड हो रहे हैं...",
  "session.search.partial": "आंशिक इतिहास",
  "session.search.retry": "पुनः प्रयास करें",
  "session.search.previous": "पिछला परिणाम",
  "session.search.next": "अगला परिणाम",
  "session.search.close": "खोज बंद करें",
