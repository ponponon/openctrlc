...
export const dict = {
  ...
  "desktop.menu.documentation": "OpenCtrlC-dokumentasjon",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC kunne ikke lastes inn",
  "desktop.recovery.terminated": "OpenCtrlC-vinduet ble uventet avsluttet",
  ...
  "desktop.wsl.error.installOpenctrlc": "Installasjonen av OpenCtrlC mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.openctrlcMissing": "openctrlc er ikke installert i denne distribusjonen",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc er installert, men kunne ikke kjøres",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC er ikke installert i {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "Oppdateringen av OpenCtrlC er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Aksepter tillatelser automatisk",
  "prompt.permissions.autoaccept.enabled": "Aksepterer tillatelser automatisk",
  "prompt.permissions.autoaccept.enable": "Aksepter tillatelser automatisk",
  "prompt.permissions.autoaccept.disable": "Stopp automatisk akseptering av tillatelser",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i OpenCtrlC.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i openctrlc.json",
  ...
  "dialog.server.description": "Bytt hvilken OpenCtrlC-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av OpenCtrlC ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til OpenCtrlC-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (openctrlc.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at OpenCtrlC ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør OpenCtrlC-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for OpenCtrlC",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan OpenCtrlC ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om OpenCtrlC skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i OpenCtrlC.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når OpenCtrlC starter",
  ...
  "settings.updates.toast.latest.title": "OpenCtrlC er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av OpenCtrlC.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Sjekker OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Sjekker OpenCtrlC i {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Oppdaterer OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Oppdaterer OpenCtrlC i {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Oppdater OpenCtrlC i {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Oppdater OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC er klar i {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC er klar.",
  "wsl.onboarding.installOpenctrlcIn": "Installer OpenCtrlC i {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Installer OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før OpenCtrlC kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter OpenCtrlC på nytt.",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
  ...
  "session.search.placeholder": "Søk i denne økten",
  "session.search.input": "Søk i øktens meldinger",
  "session.search.scope": "Søkeområde",
  "session.search.scope.conversation": "Samtale",
  "session.search.scope.all": "Alt innhold",
  "session.search.results": "{{current}} av {{total}} resultater",
  "session.search.noResults": "Ingen resultater",
  "session.search.loading": "Laster inn resultater...",
  "session.search.partial": "Delvis historikk",
  "session.search.retry": "Prøv igjen",
  "session.search.previous": "Forrige resultat",
  "session.search.next": "Neste resultat",
  "session.search.close": "Lukk søk",
