export const dict = {
  ...
  "desktop.menu.documentation": "OpenCtrlC Ҳуҷҷатҳо",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC бор карда натавонист",
  "desktop.recovery.terminated": "OpenCtrlC тиреза ба таври ғайричашмдошт қатъ карда шуд",
  "desktop.recovery.unresponsive": "OpenCtrlC ҷавоб намедиҳад",
  ...
  "desktop.wsl.error.installOpenctrlc": "OpenCtrlC насб карда нашуд",
  "desktop.wsl.error.alreadyAdded": "{{distro}} аллакай илова карда шудааст",
  "desktop.wsl.error.openctrlcMissing": "openctrlc дар ин паҳнкунӣ насб нашудааст",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc насб шудааст, аммо иҷро карда натавонист",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC дар {{distro}} насб нашудааст",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC навсозӣ анҷом ёфт, аммо {{distro}} то ҳол гузориш медиҳад {{installed}}; интизорӣ {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Иҷозатҳоро худкор қабул кунед",
  "prompt.permissions.autoaccept.enabled": "Қабули худкор иҷозатҳо",
  "prompt.permissions.autoaccept.enable": "Иҷозатҳоро худкор қабул кунед",
  "prompt.permissions.autoaccept.disable": "Қабули худкори иҷозатҳоро қатъ кунед",
  ...
  "dialog.model.unpaid.freeModels.title": "Моделҳои ройгон аз ҷониби OpenCtrlC пешниҳодшуда",
  ...
  "provider.connect.apiKey.description":
    "Барои пайваст кардани ҳисоби худ калиди {{provider}} API-ро ворид кунед ва моделҳои {{provider}}-ро дар OpenCtrlC истифода баред.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "Барои ҷамъ овардани рамзи иҷозати шумо барои пайваст кардани ҳисоби шумо ва истифода бурдани моделҳои {{provider}} дар OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ва рамзи зерро ворид кунед, то ҳисоби худро пайваст кунед ва моделҳои {{provider}}-ро дар OpenCtrlC истифода баред.",
  ...
  "dialog.plugins.empty": "Плагинҳо дар openctrlc.json танзим карда шудаанд",
  ...
  "dialog.server.description": "Гузариш кунед, ки ин барнома ба кадом сервери OpenCtrlC пайваст мешавад.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Санҷиш OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Санҷиш OpenCtrlC дар {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Навсозӣ OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Навсозии OpenCtrlC дар {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Навсозии OpenCtrlC дар {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Навсозӣ OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC дар {{distro}} тайёр аст.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC тайёр аст.",
  "wsl.onboarding.installOpenctrlcIn": "OpenCtrlC дар {{distro}} насб кунед.",
  "wsl.onboarding.installOpenctrlc": "Насб кунед OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC насб нашудааст",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) лозим аст, то OpenCtrlC сервери WSL илова карда шавад",
  "wsl.onboarding.wslUnavailable.title": "WSL дастрас нест",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC WSL-ро дар ин мошин тафтиш карда натавонист.",
  "wsl.onboarding.installWsl": "Насб кунед WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Барои анҷом додани насби WSL Windows-ро аз нав оғоз кунед, сипас OpenCtrlC-ро боз кунед.",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop ҳоло дар атрофи ҷадвалҳо сохта шудааст.",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "Лутфан дар бораи ин хато ба дастаи OpenCtrlC хабар диҳед",
  ...
  "error.chain.checkConfig": "Номҳои провайдери конфигуратсияи худро (openctrlc.json) санҷед",
  "error.chain.mcpFailed":
    'MCP сервери "{{name}}" ноком шуд. Дар хотир доред, ки OpenCtrlC тасдиқи MCP-ро ҳанӯз дастгирӣ намекунад.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC моделҳои ройгонро дар бар мегирад, то шумо метавонед фавран оғоз кунед.",
  ...
  "settings.desktop.wsl.description": "Сервери OpenCtrlC-ро дар WSL дар Windows иҷро кунед.",
  ...
  "settings.general.row.language.description": "Забони намоишро барои OpenCtrlC иваз кунед",
  ...
  "settings.general.row.appearance.description":
    "Фармоиш диҳед, ки чӣ гуна OpenCtrlC дар дастгоҳи шумо намуди зоҳирӣ дорад",
  "settings.general.row.colorScheme.title": "Схемаи ранг",
  "settings.general.row.colorScheme.description":
    "Интихоб кунед, ки OpenCtrlC аз рӯи система, равшанӣ ё мавзӯи торик пайравӣ мекунад",
  "settings.general.row.theme.title": "Мавзӯъ",
  "settings.general.row.theme.description": "Чӣ тавр OpenCtrlC мавзӯъро танзим кунед.",
  ...
  "settings.updates.row.startup.description": "Ҳангоми оғоз кардани OpenCtrlC навсозиҳо ба таври худкор санҷед",
  ...
  "settings.updates.toast.latest.description": "Шумо версияи охирини OpenCtrlC-ро иҷро карда истодаед.",
  ...
  "session.search.placeholder": "Дар ин ҷаласа ҷустуҷӯ кунед",
  "session.search.input": "Дар паёмҳои ҷаласа ҷустуҷӯ кунед",
  "session.search.scope": "Доираи ҷустуҷӯ",
  "session.search.scope.conversation": "Гуфтугӯ",
  "session.search.scope.all": "Ҳамаи мундариҷа",
  "session.search.results": "{{current}} аз {{total}} натиҷа",
  "session.search.noResults": "Натиҷа нест",
  "session.search.loading": "Натиҷаҳо бор мешаванд...",
  "session.search.partial": "Таърихи нопурра",
  "session.search.retry": "Аз нав кӯшиш кунед",
  "session.search.previous": "Натиҷаи қаблӣ",
  "session.search.next": "Натиҷаи навбатӣ",
  "session.search.close": "Ҷустуҷӯро пӯшед",
