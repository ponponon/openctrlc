export const dict = {
  ...
  "desktop.menu.documentation": "OpenCtrlC დოკუმენტაცია",
  ...
  "desktop.menu.ariaLabel": "OpenCtrlC მენიუ",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC ვერ ჩაიტვირთა",
  "desktop.recovery.terminated": "OpenCtrlC ფანჯარა მოულოდნელად შეწყდა",
  "desktop.recovery.unresponsive": "OpenCtrlC არ პასუხობს",
  ...
  "desktop.wsl.error.installOpenctrlc": "OpenCtrlC ინსტალაცია ვერ მოხერხდა",
  "desktop.wsl.error.alreadyAdded": "{{distro}} უკვე დამატებულია",
  "desktop.wsl.error.openctrlcMissing": "openctrlc არ არის დაინსტალირებული ამ დისტროში",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc დაინსტალირებულია, მაგრამ ვერ გაშვება",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC არ არის დაინსტალირებული {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC განახლება დასრულდა, მაგრამ {{distro}} კვლავ იუწყება {{installed}}; მოსალოდნელია {{expected}}",
  ...
  "prompt.permissions.autoaccept": "ნებართვების ავტომატური მიღება",
  "prompt.permissions.autoaccept.enabled": "ნებართვების ავტომატური მიღება",
  "prompt.permissions.autoaccept.enable": "ნებართვების ავტომატური მიღება",
  "prompt.permissions.autoaccept.disable": "ნებართვების ავტომატური მიღების შეწყვეტა",
  ...
  "dialog.model.unpaid.freeModels.title": "უფასო მოდელები მოწოდებულია OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "შეიყვანეთ თქვენი {{provider}} API გასაღები თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები OpenCtrlC-ში.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " შეაგროვეთ თქვენი ავტორიზაციის კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენოთ {{provider}} მოდელები OpenCtrlC-ში.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " და შეიყვანეთ ქვემოთ კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები OpenCtrlC-ში.",
  ...
  "dialog.plugins.empty": "პლაგინები კონფიგურირებულია openctrlc.json-ში",
  ...
  "dialog.server.description": "გადართეთ რომელ OpenCtrlC სერვერს უკავშირდება ეს აპი.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "შემოწმებულია OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "შემოწმებულია OpenCtrlC-ში {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "განახლება OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "OpenCtrlC განახლება ხდება {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "განახლება OpenCtrlC {{distro}}-ში.",
  "wsl.onboarding.updateOpenctrlc": "განახლება OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC მზად არის {{distro}}-ში.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC მზად არის.",
  "wsl.onboarding.installOpenctrlcIn": "დააინსტალირეთ OpenCtrlC {{distro}}-ში.",
  "wsl.onboarding.installOpenctrlc": "დააინსტალირეთ OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC არ არის დაინსტალირებული",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows ქვესისტემა Linux-ისთვის) საჭიროა, სანამ OpenCtrlC შეძლებს WSL სერვერის დამატებას",
  "wsl.onboarding.wslUnavailable.title": "WSL მიუწვდომელია",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC ვერ დაადასტურა WSL ამ მოწყობილობაზე.",
  "wsl.onboarding.installWsl": "დააინსტალირეთ WSL",
  "wsl.onboarding.windowsRestartRequired":
    "გადატვირთეთ Windows WSL-ის ინსტალაციის დასასრულებლად, შემდეგ ხელახლა გახსენით OpenCtrlC.",
  ...
  "help.tabs.introduction": "OpenCtrlC სამუშაო მაგიდა ახლა აგებულია ჩანართების გარშემო.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "OpenCtrlC-ის ({{version}}) ახალი ვერსია ახლა ხელმისაწვდომია დასაინსტალირებლად.",
  ...
  "error.page.report.prefix": "გთხოვთ, შეატყობინოთ ეს შეცდომა OpenCtrlC გუნდს",
  ...
  "error.chain.checkConfig": "შეამოწმეთ თქვენი კონფიგურაცია (openctrlc.json) პროვაიდერის/მოდელების სახელები",
  "error.chain.mcpFailed":
    'MCP სერვერი "{{name}}" ვერ მოხერხდა. შენიშვნა, OpenCtrlC ჯერ არ უჭერს მხარს MCP ავთენტიფიკაციას.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC მოიცავს უფასო მოდელებს, ასე რომ თქვენ შეგიძლიათ დაუყოვნებლივ დაიწყოთ.",
  ...
  "settings.desktop.wsl.description": "გაუშვით OpenCtrlC სერვერი WSL-ში Windows-ზე.",
  ...
  "settings.general.row.language.description": "შეცვალეთ ჩვენების ენა OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "მორგეთ, როგორ გამოიყურება OpenCtrlC თქვენს მოწყობილობაზე",
  "settings.general.row.colorScheme.title": "ფერთა სქემა",
  "settings.general.row.colorScheme.description": "აირჩიეთ, მიჰყვება თუ არა OpenCtrlC სისტემას, ღია თუ ბნელ თემას",
  "settings.general.row.theme.title": "თემა",
  "settings.general.row.theme.description": "მორგება, თუ როგორ არის OpenCtrlC თემატური.",
  ...
  "settings.updates.row.startup.description": "ავტომატურად შეამოწმეთ განახლებები, როდესაც OpenCtrlC გაშვება",
  ...
  "settings.updates.toast.latest.description": "თქვენ იყენებთ OpenCtrlC-ის უახლეს ვერსიას.",
  ...
  "session.search.placeholder": "ამ სესიაში ძიება",
  "session.search.input": "სესიის შეტყობინებებში ძიება",
  "session.search.scope": "ძიების არეალი",
  "session.search.scope.conversation": "საუბარი",
  "session.search.scope.all": "მთელი შინაარსი",
  "session.search.results": "{{total}} შედეგიდან {{current}}",
  "session.search.noResults": "შედეგები ვერ მოიძებნა",
  "session.search.loading": "შედეგები იტვირთება...",
  "session.search.partial": "ნაწილობრივი ისტორია",
  "session.search.retry": "ხელახლა ცდა",
  "session.search.previous": "წინა შედეგი",
  "session.search.next": "შემდეგი შედეგი",
  "session.search.close": "ძიების დახურვა",
