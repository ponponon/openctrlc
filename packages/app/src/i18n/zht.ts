...
export const dict = {
  ...
  "settings.skills.source.agents": "Agents 全域技能",
  "settings.skills.source.claude": "Claude Code 技能",
  "settings.skills.source.config": "OpenCtrlC 設定",
  "settings.skills.runtime.service": "服務",
  "settings.skills.runtime.v1": "V1 相容服務",
  "settings.skills.runtime.v2": "V2 服務",
  "settings.skills.runtime.detecting": "偵測中…",
  "settings.skills.runtime.sources": "技能來源",
  "settings.skills.runtime.sources.empty": "尚未發現來源",
  ...
  "desktop.menu.importOpenCodeSession": "從 OpenCode 匯入工作階段...",
  ...
  "desktop.wsl.error.installOpenctrlc": "OpenCtrlC 安裝失敗",
  "desktop.wsl.error.alreadyAdded": "已新增 {{distro}}",
  "desktop.wsl.error.openctrlcMissing": "此發行版中未安裝 openctrlc",
  "desktop.wsl.error.openctrlcCannotRun": "已安裝 openctrlc，但無法執行",
  "desktop.wsl.error.openctrlcNotInstalled": "{{distro}} 中未安裝 OpenCtrlC",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "command.session.importOpencode": "從 OpenCode 匯入工作階段",
  "command.session.importOpencode.description": "根據 Session ID 從 OpenCode 匯入工作階段記錄",
  ...
  "dialog.session.importOpencode.title": "從 OpenCode 匯入工作階段",
  "dialog.session.importOpencode.description": "從本機 OpenCode 資料庫匯入完整對話記錄。",
  "dialog.session.importOpencode.source.label": "來源工作階段",
  "dialog.session.importOpencode.source.found": "已找到",
  "dialog.session.importOpencode.source.messages": "{{count}} 則訊息",
  "dialog.session.importOpencode.source.workdir": "OpenCode 工作目錄",
  "dialog.session.importOpencode.source.notFound": "找不到這個工作階段，請檢查 Session ID 或所選資料庫。",
  "dialog.session.importOpencode.sessionID.label": "Session ID",
  "dialog.session.importOpencode.sessionID.placeholder": "ses_...",
  "dialog.session.importOpencode.lookup": "尋找工作階段",
  "dialog.session.importOpencode.lookup.loading": "尋找中…",
  "dialog.session.importOpencode.database.label": "OpenCode 資料庫",
  "dialog.session.importOpencode.database.default": "使用預設 OpenCode 資料庫",
  "dialog.session.importOpencode.database.choose": "選擇資料庫",
  "dialog.session.importOpencode.database.reset": "使用預設",
  "dialog.session.importOpencode.target.label": "匯入目標",
  "dialog.session.importOpencode.target.choose": "選擇資料夾",
  "dialog.session.importOpencode.target.fromSession": "來自工作階段",
  "dialog.session.importOpencode.target.hintSession": "預設使用此 OpenCode 工作階段中記錄的工作目錄",
  "dialog.session.importOpencode.target.hintCurrent": "選擇匯入目標資料夾",
  "dialog.session.importOpencode.target.reset": "恢復工作階段目錄",
  "dialog.session.importOpencode.error.sessionID": "請輸入有效的 OpenCode Session ID，例如 ses_abc123。",
  "dialog.session.importOpencode.error.unavailable": "目前 Desktop 工作階段不支援 OpenCode 匯入。",
  "dialog.session.importOpencode.error.localOnly": "OpenCode 匯入僅支援 Desktop 本機伺服器。",
  "dialog.session.importOpencode.error.project": "請先開啟專案，再匯入 OpenCode 工作階段。",
  "dialog.session.importOpencode.success.title": "工作階段匯入成功",
  "dialog.session.importOpencode.success.description": "已從 OpenCode 匯入 {{id}}。",
  ...
  "wsl.onboarding.checkingOpenctrlc": "正在檢查 OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "正在檢查 {{distro}} 中的 OpenCtrlC...",
  ...
  "wsl.onboarding.openctrlcReadyIn": "{{distro}} 中的 OpenCtrlC 已就緒。",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC 已就緒。",
  "wsl.onboarding.installOpenctrlcIn": "在 {{distro}} 中安裝 OpenCtrlC。",
  "wsl.onboarding.installOpenctrlc": "安裝 OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "未安裝 OpenCtrlC",
  ...
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 OpenCtrlC。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 OpenCtrlC 伺服器。",
  ...
  "session.search.placeholder": "搜尋此工作階段",
  "session.search.input": "搜尋工作階段訊息",
  "session.search.scope": "搜尋範圍",
  "session.search.scope.conversation": "對話",
  "session.search.scope.all": "所有內容",
  "session.search.results": "{{current}} / {{total}} 個結果",
  "session.search.noResults": "沒有結果",
  "session.search.loading": "正在載入結果...",
  "session.search.partial": "歷史記錄不完整",
  "session.search.retry": "重試",
  "session.search.previous": "上一個結果",
  "session.search.next": "下一個結果",
  "session.search.close": "關閉搜尋",
  "dialog.fork.location.title": "從這裡建立聊天分支",
  "dialog.fork.location.workspace.title": "在此工作區建立分支",
  "dialog.fork.location.workspace.description": "在目前工作區從此訊息建立分支",
  "dialog.fork.location.worktree.title": "在新的工作樹建立分支",
  "dialog.fork.location.worktree.description": "在新的工作樹從此訊息建立分支",
  "dialog.fork.back": "返回訊息清單",
  "dialog.fork.loading": "正在建立聊天分支…",
