export const dict = {
  ...
  "desktop.menu.documentation": "ເອກະສານ OpenCtrlC",
  ...
  "desktop.menu.ariaLabel": "ເມນູ OpenCtrlC",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC ລົ້ມເຫລວໃນການໂຫລດ",
  "desktop.recovery.terminated": "ປ່ອງຢ້ຽມ OpenCtrlC ຖືກປິດໂດຍບໍ່ຄາດຄິດ",
  "desktop.recovery.unresponsive": "OpenCtrlC ບໍ່ຕອບສະໜອງ",
  ...
  "desktop.wsl.error.installOpenctrlc": "ການຕິດຕັ້ງ OpenCtrlC ລົ້ມເຫລວ",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ຖືກເພີ່ມແລ້ວ",
  "desktop.wsl.error.openctrlcMissing": "openctrlc ບໍ່ໄດ້ຕິດຕັ້ງຢູ່ໃນ distro ນີ້",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc ຖືກຕິດຕັ້ງແຕ່ບໍ່ສາມາດດໍາເນີນການໄດ້",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC ບໍ່ໄດ້ຕິດຕັ້ງຢູ່ໃນ {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "ການປັບປຸງ OpenCtrlC ສໍາເລັດແລ້ວແຕ່ {{distro}} ຍັງລາຍງານ {{installed}}; ຄາດວ່າ {{expected}}",
  ...
  "prompt.permissions.autoaccept": "ຍອມຮັບການອະນຸຍາດອັດຕະໂນມັດ",
  "prompt.permissions.autoaccept.enabled": "ການອະນຸຍາດອັດຕະໂນມັດ",
  "prompt.permissions.autoaccept.enable": "ຍອມຮັບການອະນຸຍາດອັດຕະໂນມັດ",
  "prompt.permissions.autoaccept.disable": "ຢຸດການຍອມຮັບອັດຕະໂນມັດ",
  ...
  "dialog.model.unpaid.freeModels.title": "ແບບຟຣີສະໜອງໃຫ້ໂດຍ OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "ໃສ່ລະຫັດ API {{provider}} ຂອງທ່ານເພື່ອເຊື່ອມຕໍ່ບັນຊີຂອງທ່ານ ແລະໃຊ້ຕົວແບບ {{provider}} ໃນ OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "ເພື່ອເກັບກຳລະຫັດການອະນຸຍາດຂອງທ່ານເພື່ອເຊື່ອມຕໍ່ບັນຊີຂອງທ່ານ ແລະໃຊ້ຕົວແບບ {{provider}} ໃນ OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ແລະໃສ່ລະຫັດຂ້າງລຸ່ມນີ້ເພື່ອເຊື່ອມຕໍ່ບັນຊີຂອງທ່ານ ແລະໃຊ້ຕົວແບບ {{provider}} ໃນ OpenCtrlC.",
  ...
  "dialog.plugins.empty": "ປລັກອິນຖືກຕັ້ງຄ່າໃນ openctrlc.json",
  ...
  "dialog.server.description": "ສະຫຼັບເຊີບເວີ OpenCtrlC ທີ່ແອັບຯນີ້ເຊື່ອມຕໍ່ກັບ.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "ກຳລັງກວດສອບ OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "ກຳລັງກວດສອບ OpenCtrlC ໃນ {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "ກຳລັງອັບເດດ OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "ກຳລັງອັບເດດ OpenCtrlC ໃນ {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "ອັບເດດ OpenCtrlC ໃນ {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "ອັບເດດ OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC ແມ່ນພ້ອມແລ້ວໃນ {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC ພ້ອມແລ້ວ.",
  "wsl.onboarding.installOpenctrlcIn": "ຕິດຕັ້ງ OpenCtrlC ໃນ {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "ຕິດຕັ້ງ OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC ບໍ່ໄດ້ຕິດຕັ້ງ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (ລະບົບຍ່ອຍຂອງ Windows ສໍາລັບ Linux) ກ່ອນທີ່ OpenCtrlC ສາມາດເພີ່ມເຄື່ອງແມ່ຂ່າຍ WSL ໄດ້",
  "wsl.onboarding.wslUnavailable.title": "WSL ບໍ່ສາມາດໃຊ້ໄດ້",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC ບໍ່ສາມາດກວດສອບ WSL ໃນເຄື່ອງນີ້ໄດ້.",
  "wsl.onboarding.installWsl": "ຕິດຕັ້ງ WSL",
  "wsl.onboarding.windowsRestartRequired": "ຣີສະຕາດ Windows ເພື່ອສຳເລັດການຕິດຕັ້ງ WSL, ຈາກນັ້ນເປີດ OpenCtrlC ຄືນໃໝ່.",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop ຕອນນີ້ຖືກສ້າງຂຶ້ນໃນແຖບຕ່າງໆ.",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "ກະລຸນາລາຍງານຄວາມຜິດພາດນີ້ໃຫ້ທີມງານ OpenCtrlC",
  ...
  "error.chain.checkConfig": "ກວດເບິ່ງການຕັ້ງຄ່າ (openctrlc.json) ຜູ້ໃຫ້ບໍລິການ/ຊື່ແບບຈໍາລອງຂອງທ່ານ",
  "error.chain.mcpFailed": 'ເຊີບເວີ MCP "{{name}}" ລົ້ມເຫລວ. ໝາຍເຫດ, OpenCtrlC ບໍ່ຮອງຮັບການພິສູດຢືນຢັນ MCP ເທື່ອ.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC ປະກອບມີຮູບແບບຟຣີເພື່ອໃຫ້ທ່ານສາມາດເລີ່ມຕົ້ນໄດ້ທັນທີ.",
  ...
  "settings.desktop.wsl.description": "ແລ່ນເຊີບເວີ OpenCtrlC ພາຍໃນ WSL ໃນ Windows.",
  ...
  "settings.general.row.language.description": "ປ່ຽນພາສາສະແດງສໍາລັບ OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "ປັບແຕ່ງວິທີ OpenCtrlC ເບິ່ງຢູ່ໃນອຸປະກອນຂອງທ່ານ",
  "settings.general.row.colorScheme.title": "ຮູບແບບສີ",
  "settings.general.row.colorScheme.description": "ເລືອກວ່າ OpenCtrlC ປະຕິບັດຕາມລະບົບ, ແສງສະຫວ່າງ, ຫຼືຮູບແບບຊ້ໍາ",
  "settings.general.row.theme.title": "ຫົວຂໍ້",
  "settings.general.row.theme.description": "ປັບແຕ່ງວິທີ OpenCtrlC ເປັນຫົວຂໍ້.",
  ...
  "settings.updates.row.startup.description": "ກວດສອບການອັບເດດໂດຍອັດຕະໂນມັດເມື່ອ OpenCtrlC ເປີດ",
  ...
  "settings.updates.toast.latest.description": "ທ່ານກຳລັງໃຊ້ OpenCtrlC ເວີຊັນຫຼ້າສຸດ.",
  ...
  "session.search.placeholder": "ຄົ້ນຫາໃນເຊດຊັນນີ້",
  "session.search.input": "ຄົ້ນຫາຂໍ້ຄວາມໃນເຊດຊັນ",
  "session.search.scope": "ຂອບເຂດການຄົ້ນຫາ",
  "session.search.scope.conversation": "ການສົນທະນາ",
  "session.search.scope.all": "ເນື້ອຫາທັງໝົດ",
  "session.search.results": "{{current}} ຈາກ {{total}} ຜົນການຄົ້ນຫາ",
  "session.search.noResults": "ບໍ່ມີຜົນການຄົ້ນຫາ",
  "session.search.loading": "ກຳລັງໂຫຼດຜົນການຄົ້ນຫາ...",
  "session.search.partial": "ປະຫວັດບາງສ່ວນ",
  "session.search.retry": "ລອງອີກຄັ້ງ",
  "session.search.previous": "ຜົນການຄົ້ນຫາກ່ອນໜ້າ",
  "session.search.next": "ຜົນການຄົ້ນຫາຖັດໄປ",
  "session.search.close": "ປິດການຄົ້ນຫາ",
