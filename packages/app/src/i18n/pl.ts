export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja OpenCtrlC",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać OpenCtrlC",
  "desktop.recovery.terminated": "Okno OpenCtrlC zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "OpenCtrlC nie odpowiada",
  ...
  "desktop.wsl.error.installOpenctrlc": "Nie udało się zainstalować OpenCtrlC",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.openctrlcMissing": "Program openctrlc nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.openctrlcCannotRun": "Program openctrlc jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "Aktualizacja OpenCtrlC została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Automatycznie akceptuj uprawnienia",
  "prompt.permissions.autoaccept.enabled": "Automatyczne akceptowanie uprawnień",
  "prompt.permissions.autoaccept.enable": "Automatycznie akceptuj uprawnienia",
  "prompt.permissions.autoaccept.disable": "Zatrzymaj automatyczne akceptowanie uprawnień",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w OpenCtrlC.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku openctrlc.json",
  ...
  "dialog.server.description": "Przełącz serwer OpenCtrlC, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Sprawdzanie OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Sprawdzanie OpenCtrlC w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Aktualizowanie OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Aktualizowanie OpenCtrlC w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Zaktualizuj OpenCtrlC w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Zaktualizuj OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC jest gotowy.",
  "wsl.onboarding.installOpenctrlcIn": "Zainstaluj OpenCtrlC w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Zainstaluj OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim OpenCtrlC będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz OpenCtrlC.",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja OpenCtrlC ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu OpenCtrlC",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (openctrlc.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: OpenCtrlC nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer OpenCtrlC wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd OpenCtrlC na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy OpenCtrlC ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw OpenCtrlC.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania OpenCtrlC",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji OpenCtrlC.",
  ...
  "session.search.placeholder": "Szukaj w tej sesji",
  "session.search.input": "Szukaj w wiadomościach sesji",
  "session.search.scope": "Zakres wyszukiwania",
  "session.search.scope.conversation": "Rozmowa",
  "session.search.scope.all": "Cała zawartość",
  "session.search.results": "{{current}} z {{total}} wyników",
  "session.search.noResults": "Brak wyników",
  "session.search.loading": "Ładowanie wyników...",
  "session.search.partial": "Częściowa historia",
  "session.search.retry": "Spróbuj ponownie",
  "session.search.previous": "Poprzedni wynik",
  "session.search.next": "Następny wynik",
  "session.search.close": "Zamknij wyszukiwanie",
