export const dict = {
  ...
  "desktop.menu.documentation": "OpenCtrlC Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno OpenCtrlC se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "OpenCtrlC se ne odziva",
  ...
  "desktop.wsl.error.installOpenctrlc": "Namestitev OpenCtrlC ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.openctrlcMissing": "openctrlc ni nameščen v tej distribuciji",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC ni nameščen v {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "Posodobitev OpenCtrlC je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Samodejno sprejemanje dovoljenj",
  "prompt.permissions.autoaccept.enabled": "Samodejno sprejemanje dovoljenj",
  "prompt.permissions.autoaccept.enable": "Samodejno sprejemanje dovoljenj",
  "prompt.permissions.autoaccept.disable": "Ustavi samodejno sprejemanje dovoljenj",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v OpenCtrlC.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v openctrlc.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom OpenCtrlC se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Preverjanje OpenCtrlC ...",
  "wsl.onboarding.checkingOpenctrlcIn": "Preverjanje OpenCtrlC v {{distro}} ...",
  "wsl.onboarding.updatingOpenctrlc": "Posodabljanje OpenCtrlC ...",
  "wsl.onboarding.updatingOpenctrlcIn": "Posodabljanje OpenCtrlC v {{distro}} ...",
  "wsl.onboarding.updateOpenctrlcIn": "Posodobite OpenCtrlC v {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Posodobite OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC je pripravljen v {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC je pripravljen.",
  "wsl.onboarding.installOpenctrlcIn": "Namestite OpenCtrlC v {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Namestite OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko OpenCtrlC doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite OpenCtrlC.",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica OpenCtrlC ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi OpenCtrlC",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (openctrlc.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, OpenCtrlC še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik OpenCtrlC znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako OpenCtrlC izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali OpenCtrlC sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo OpenCtrlC.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene OpenCtrlC",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico OpenCtrlC.",
  ...
  "session.search.placeholder": "Išči v tej seji",
  "session.search.input": "Išči po sporočilih seje",
  "session.search.scope": "Obseg iskanja",
  "session.search.scope.conversation": "Pogovor",
  "session.search.scope.all": "Vsa vsebina",
  "session.search.results": "{{current}} od {{total}} rezultatov",
  "session.search.noResults": "Ni rezultatov",
  "session.search.loading": "Nalaganje rezultatov...",
  "session.search.partial": "Delna zgodovina",
  "session.search.retry": "Poskusi znova",
  "session.search.previous": "Prejšnji rezultat",
  "session.search.next": "Naslednji rezultat",
  "session.search.close": "Zapri iskanje",
