export const dict = {
  ...
  "desktop.menu.documentation": "OpenCtrlC Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "OpenCtrlC μενού",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "OpenCtrlC το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "OpenCtrlC δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installOpenctrlc": "OpenCtrlC η εγκατάσταση απέτυχε",
  "desktop.wsl.error.alreadyAdded": "{{distro}} έχει ήδη προστεθεί",
  "desktop.wsl.error.openctrlcMissing": "ο ανοιχτός κώδικας δεν είναι εγκατεστημένος σε αυτήν τη διανομή",
  "desktop.wsl.error.openctrlcCannotRun": "ο ανοιχτός κώδικας είναι εγκατεστημένος αλλά δεν ήταν δυνατή η εκτέλεση",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Αυτόματη αποδοχή δικαιωμάτων",
  "prompt.permissions.autoaccept.enabled": "Αυτόματη αποδοχή δικαιωμάτων",
  "prompt.permissions.autoaccept.enable": "Αυτόματη αποδοχή δικαιωμάτων",
  "prompt.permissions.autoaccept.disable": "Διακοπή αυτόματης αποδοχής δικαιωμάτων",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο OpenCtrlC.",
  ...
  "dialog.plugins.empty": "Προσθήκες ρυθμισμένες στο openctrlc.json",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή OpenCtrlC συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Έλεγχος OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Έλεγχος OpenCtrlC σε {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Ενημέρωση OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Ενημέρωση OpenCtrlC σε {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Ενημέρωση OpenCtrlC σε {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Ενημέρωση OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC είναι έτοιμο.",
  "wsl.onboarding.installOpenctrlcIn": "Εγκατάσταση του OpenCtrlC στο {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Εγκατάσταση OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο OpenCtrlC να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το OpenCtrlC.",
  ...
  "help.tabs.introduction": "OpenCtrlC Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του OpenCtrlC ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα OpenCtrlC",
  ...
  "error.chain.checkConfig": "Ελέγξτε τη διαμόρφωση (openctrlc.json) ονόματα παρόχου/μοντέλων",
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το OpenCtrlC δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή OpenCtrlC μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του OpenCtrlC στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το OpenCtrlC ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το OpenCtrlC.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του OpenCtrlC",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του OpenCtrlC.",
  ...
  "session.search.placeholder": "Αναζήτηση σε αυτή τη συνεδρία",
  "session.search.input": "Αναζήτηση στα μηνύματα της συνεδρίας",
  "session.search.scope": "Εύρος αναζήτησης",
  "session.search.scope.conversation": "Συνομιλία",
  "session.search.scope.all": "Όλο το περιεχόμενο",
  "session.search.results": "{{current}} από {{total}} αποτελέσματα",
  "session.search.noResults": "Δεν βρέθηκαν αποτελέσματα",
  "session.search.loading": "Φόρτωση αποτελεσμάτων...",
  "session.search.partial": "Μερικό ιστορικό",
  "session.search.retry": "Επανάληψη",
  "session.search.previous": "Προηγούμενο αποτέλεσμα",
  "session.search.next": "Επόμενο αποτέλεσμα",
  "session.search.close": "Κλείσιμο αναζήτησης",
