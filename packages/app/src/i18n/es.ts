export const dict = {
  ...
  "desktop.wsl.error.installOpenctrlc": "No se pudo instalar OpenCtrlC",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.openctrlcMissing": "openctrlc no está instalado en esta distribución",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC no está instalado en {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "La actualización de OpenCtrlC finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Aceptar permisos automáticamente",
  "prompt.permissions.autoaccept.enabled": "Aceptando permisos automáticamente",
  "prompt.permissions.autoaccept.enable": "Aceptar permisos automáticamente",
  "prompt.permissions.autoaccept.disable": "Dejar de aceptar permisos automáticamente",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Comprobando OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Comprobando OpenCtrlC en {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Actualizando OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Actualizando OpenCtrlC en {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Actualiza OpenCtrlC en {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Actualizar OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC está listo en {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC está listo.",
  "wsl.onboarding.installOpenctrlcIn": "Instala OpenCtrlC en {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Instalar OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que OpenCtrlC pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir OpenCtrlC.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor OpenCtrlC dentro de WSL en Windows.",
  ...
  "session.search.placeholder": "Buscar en esta sesión",
  "session.search.input": "Buscar en los mensajes de la sesión",
  "session.search.scope": "Ámbito de búsqueda",
  "session.search.scope.conversation": "Conversación",
  "session.search.scope.all": "Todo el contenido",
  "session.search.results": "{{current}} de {{total}} resultados",
  "session.search.noResults": "No hay resultados",
  "session.search.loading": "Cargando resultados...",
  "session.search.partial": "Historial parcial",
  "session.search.retry": "Reintentar",
  "session.search.previous": "Resultado anterior",
  "session.search.next": "Resultado siguiente",
  "session.search.close": "Cerrar búsqueda",
