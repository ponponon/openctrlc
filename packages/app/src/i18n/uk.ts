export const dict = {
  ...
  "desktop.wsl.error.installOpenctrlc": "Не вдалося встановити OpenCtrlC",
  "desktop.wsl.error.alreadyAdded": "{{distro}} уже додано",
  "desktop.wsl.error.openctrlcMissing": "openctrlc не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc встановлено, але його не вдалося запустити",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC не встановлено в {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "Оновлення OpenCtrlC завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Автоматично приймати дозволи",
  "prompt.permissions.autoaccept.enabled": "Автоматичне прийняття дозволів",
  "prompt.permissions.autoaccept.enable": "Автоматично приймати дозволи",
  "prompt.permissions.autoaccept.disable": "Зупинити автоматичне прийняття дозволів",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Перевірка OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Перевірка OpenCtrlC у {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Оновлення OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Оновлення OpenCtrlC у {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Оновіть OpenCtrlC у {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Оновити OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC готовий до роботи у {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC готовий до роботи.",
  "wsl.onboarding.installOpenctrlcIn": "Встановіть OpenCtrlC у {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Встановити OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в OpenCtrlC потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте OpenCtrlC.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер OpenCtrlC всередині WSL на Windows.",
  ...
  "session.search.placeholder": "Пошук у цьому сеансі",
  "session.search.input": "Пошук у повідомленнях сеансу",
  "session.search.scope": "Область пошуку",
  "session.search.scope.conversation": "Розмова",
  "session.search.scope.all": "Увесь вміст",
  "session.search.results": "{{current}} із {{total}} результатів",
  "session.search.noResults": "Результатів немає",
  "session.search.loading": "Завантаження результатів...",
  "session.search.partial": "Неповна історія",
  "session.search.retry": "Повторити",
  "session.search.previous": "Попередній результат",
  "session.search.next": "Наступний результат",
  "session.search.close": "Закрити пошук",
