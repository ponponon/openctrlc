export const dict = {
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap OpenCtrlC ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "OpenCtrlC tidak memberi respons",
  ...
  "desktop.wsl.error.installOpenctrlc": "Pemasangan OpenCtrlC gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.openctrlcMissing": "openctrlc tidak dipasang dalam distro ini",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "Kemas kini OpenCtrlC selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Terima kebenaran secara automatik",
  "prompt.permissions.autoaccept.enabled": "Kebenaran diterima secara automatik",
  "prompt.permissions.autoaccept.enable": "Terima kebenaran secara automatik",
  "prompt.permissions.autoaccept.disable": "Henti terima kebenaran automatik",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam OpenCtrlC.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam openctrlc.json",
  ...
  "dialog.server.description": "Tukar pelayan OpenCtrlC yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Sedang menyemak OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Sedang menyemak OpenCtrlC dalam {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Sedang mengemas kini OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Sedang mengemas kini OpenCtrlC dalam {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Kemas kini OpenCtrlC dalam {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Kemas kini OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC sedia digunakan.",
  "wsl.onboarding.installOpenctrlcIn": "Pasang OpenCtrlC dalam {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Pasang OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum OpenCtrlC boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula OpenCtrlC.",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan OpenCtrlC",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (openctrlc.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, OpenCtrlC belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan OpenCtrlC dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa OpenCtrlC pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada OpenCtrlC mengikut sistem, tema cerah, atau gelap",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila OpenCtrlC dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini OpenCtrlC.",
  ...
  "session.search.placeholder": "Cari sesi ini",
  "session.search.input": "Cari mesej sesi",
  "session.search.scope": "Skop carian",
  "session.search.scope.conversation": "Perbualan",
  "session.search.scope.all": "Semua kandungan",
  "session.search.results": "{{current}} daripada {{total}} hasil",
  "session.search.noResults": "Tiada hasil",
  "session.search.loading": "Memuatkan hasil...",
  "session.search.partial": "Sejarah separa",
  "session.search.retry": "Cuba lagi",
  "session.search.previous": "Hasil sebelumnya",
  "session.search.next": "Hasil seterusnya",
  "session.search.close": "Tutup carian",
