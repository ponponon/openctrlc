export const dict = {
  ...
  "desktop.menu.documentation": "OpenCtrlC-documentatie",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC kan niet worden geladen",
  "desktop.recovery.terminated": "Het OpenCtrlC-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "OpenCtrlC reageert niet",
  ...
  "desktop.wsl.error.installOpenctrlc": "Installatie van OpenCtrlC is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.openctrlcMissing": "openctrlc is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "De OpenCtrlC-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Machtigingen automatisch accepteren",
  "prompt.permissions.autoaccept.enabled": "Machtigingen automatisch accepteren",
  "prompt.permissions.autoaccept.enable": "Machtigingen automatisch accepteren",
  "prompt.permissions.autoaccept.disable": "Stop met het automatisch accepteren van machtigingen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in OpenCtrlC te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in OpenCtrlC te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in OpenCtrlC te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in openctrlc.json",
  ...
  "dialog.server.description": "Wijzig met welke OpenCtrlC-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "OpenCtrlC controleren...",
  "wsl.onboarding.checkingOpenctrlcIn": "OpenCtrlC controleren in {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "OpenCtrlC bijwerken...",
  "wsl.onboarding.updatingOpenctrlcIn": "OpenCtrlC bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Werk OpenCtrlC bij in {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "OpenCtrlC bijwerken",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC is gereed in {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC is klaar.",
  "wsl.onboarding.installOpenctrlcIn": "Installeer OpenCtrlC in {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Installeer OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat OpenCtrlC een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens OpenCtrlC opnieuw.",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van OpenCtrlC ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het OpenCtrlC-team",
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de OpenCtrlC-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe OpenCtrlC eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of OpenCtrlC het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van OpenCtrlC aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer OpenCtrlC wordt gestart",
  ...
  "settings.updates.toast.latest.title": "OpenCtrlC is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van OpenCtrlC.",
