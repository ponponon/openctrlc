export const dict = {
  ...
  "desktop.menu.documentation": "OpenCtrlC Документация",
  ...
  "desktop.menu.ariaLabel": "OpenCtrlC меню",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC не успя да се зареди",
  "desktop.recovery.terminated": "Прозорецът OpenCtrlC приключи неочаквано",
  "desktop.recovery.unresponsive": "OpenCtrlC не отговаря",
  ...
  "desktop.wsl.error.installOpenctrlc": "Инсталирането на OpenCtrlC е неуспешно",
  "desktop.wsl.error.alreadyAdded": "{{distro}} вече е добавен",
  "desktop.wsl.error.openctrlcMissing": "openctrlc не е инсталиран в тази дистрибуция",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc е инсталиран, но не може да стартира",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC не е инсталиран в {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC актуализацията приключи, но {{distro}} все още съобщава {{installed}}; очаквано {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Автоматично приемане на разрешения",
  "prompt.permissions.autoaccept.enabled": "Автоматично приемане на разрешения",
  "prompt.permissions.autoaccept.enable": "Автоматично приемане на разрешения",
  "prompt.permissions.autoaccept.disable": "Спрете автоматичното приемане на разрешения",
  ...
  "dialog.model.unpaid.freeModels.title": "Безплатни модели, предоставени от OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "Въведете своя {{provider}} API ключ, за да свържете акаунта си и да използвате {{provider}} модели в OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "за да вземете вашия код за оторизация, за да свържете акаунта си и да използвате {{provider}} модели в OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и въведете кода по-долу, за да свържете акаунта си и да използвате {{provider}} модели в OpenCtrlC.",
  ...
  "dialog.plugins.empty": "Добавки, конфигурирани в openctrlc.json",
  ...
  "dialog.server.description": "Превключете към кой OpenCtrlC сървър се свързва това приложение.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Проверява се OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Проверява се OpenCtrlC в {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Актуализиране на OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Актуализиране на OpenCtrlC в {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Актуализирайте OpenCtrlC в {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Актуализация OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC е готов в {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC е готов.",
  "wsl.onboarding.installOpenctrlcIn": "Инсталирайте OpenCtrlC в {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Инсталирайте OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC не е инсталиран",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) се изисква, преди OpenCtrlC да може да добави WSL сървър",
  "wsl.onboarding.wslUnavailable.title": "WSL не е наличен",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC не можа да провери WSL на тази машина.",
  "wsl.onboarding.installWsl": "Инсталирайте WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирайте Windows, за да завършите инсталирането на WSL, след което отворете отново OpenCtrlC.",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop вече е изграден около раздели.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Вече е достъпна за инсталиране нова версия на OpenCtrlC ({{version}}).",
  ...
  "error.page.report.prefix": "Моля, докладвайте тази грешка на екипа на OpenCtrlC",
  ...
  "error.chain.checkConfig": "Проверете имената на доставчика/модела на вашата конфигурация (openctrlc.json).",
  "error.chain.mcpFailed":
    'MCP сървър "{{name}}" не успя. Имайте предвид, че OpenCtrlC все още не поддържа MCP удостоверяване.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC включва безплатни модели, така че можете да започнете веднага.",
  ...
  "settings.desktop.wsl.description": "Стартирайте сървъра OpenCtrlC вътре в WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете езика на дисплея за OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "Персонализирайте как изглежда OpenCtrlC на вашето устройство",
  "settings.general.row.colorScheme.title": "Цветова схема",
  "settings.general.row.colorScheme.description": "Изберете дали OpenCtrlC следва системната, светла или тъмна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Персонализирайте как е тематично OpenCtrlC.",
  ...
  "settings.updates.row.startup.description": "Автоматично проверявайте за актуализации при стартиране на OpenCtrlC",
  ...
  "settings.updates.toast.latest.description": "Вие използвате най-новата версия на OpenCtrlC.",
  ...
  "session.search.placeholder": "Търсене в тази сесия",
  "session.search.input": "Търсене в съобщенията на сесията",
  "session.search.scope": "Обхват на търсене",
  "session.search.scope.conversation": "Разговор",
  "session.search.scope.all": "Цялото съдържание",
  "session.search.results": "{{current}} от {{total}} резултата",
  "session.search.noResults": "Няма резултати",
  "session.search.loading": "Зареждане на резултатите...",
  "session.search.partial": "Непълна история",
  "session.search.retry": "Опитай отново",
  "session.search.previous": "Предишен резултат",
  "session.search.next": "Следващ резултат",
  "session.search.close": "Затвори търсенето",
