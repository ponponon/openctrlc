export const dict = {
  ...
  "desktop.menu.documentation": "OpenCtrlC Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "OpenCtrlC մենյու",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "OpenCtrlC պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "OpenCtrlC-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installOpenctrlc": "OpenCtrlC տեղադրումը ձախողվեց",
  "desktop.wsl.error.alreadyAdded": "{{distro}} արդեն ավելացված է",
  "desktop.wsl.error.openctrlcMissing": "openctrlc-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Ավտոմատ ընդունել թույլտվությունները",
  "prompt.permissions.autoaccept.enabled": "Ավտոմատների ընդունում",
  "prompt.permissions.autoaccept.enable": "Ավտոմատ ընդունել թույլտվությունները",
  "prompt.permissions.autoaccept.disable": "Դադարեցնել թույլտվությունների ավտոմատ ընդունումը",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և OpenCtrlC-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և OpenCtrlC-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և OpenCtrlC-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են openctrlc.json-ում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ OpenCtrlC սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Ստուգում է OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Ստուգում է OpenCtrlC-ը {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Թարմացվում է OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Թարմացվում է OpenCtrlC-ը {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Թարմացնել OpenCtrlC-ը {{distro}}-ում։",
  "wsl.onboarding.updateOpenctrlc": "Թարմացնել OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC պատրաստ է։",
  "wsl.onboarding.installOpenctrlcIn": "Տեղադրեք OpenCtrlC-ը {{distro}}-ում։",
  "wsl.onboarding.installOpenctrlc": "Տեղադրեք OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի OpenCtrlC-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք OpenCtrlC։",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին OpenCtrlC թիմին",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (openctrlc.json) մատակարարի/մոդելի անունները",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ OpenCtrlC-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք OpenCtrlC սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է OpenCtrlC տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ OpenCtrlC-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է OpenCtrlC-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ OpenCtrlC-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք OpenCtrlC-ի վերջին տարբերակը։",
  ...
  "session.search.placeholder": "Որոնել այս աշխատաշրջանում",
  "session.search.input": "Որոնել աշխատաշրջանի հաղորդագրություններում",
  "session.search.scope": "Որոնման շրջանակ",
  "session.search.scope.conversation": "Զրույց",
  "session.search.scope.all": "Ամբողջ բովանդակությունը",
  "session.search.results": "{{total}} արդյունքից {{current}}-րդը",
  "session.search.noResults": "Արդյունքներ չկան",
  "session.search.loading": "Արդյունքները բեռնվում են...",
  "session.search.partial": "Մասնակի պատմություն",
  "session.search.retry": "Կրկին փորձել",
  "session.search.previous": "Նախորդ արդյունքը",
  "session.search.next": "Հաջորդ արդյունքը",
  "session.search.close": "Փակել որոնումը",
