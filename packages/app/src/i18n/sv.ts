export const dict = {
  ...
  "desktop.menu.ariaLabel": "OpenCtrlC-meny",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC kunde inte läsas in",
  "desktop.recovery.terminated": "OpenCtrlC-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "OpenCtrlC svarar inte",
  ...
  "desktop.wsl.error.installOpenctrlc": "Installationen av OpenCtrlC misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.openctrlcMissing": "openctrlc är inte installerat i den här distributionen",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc är installerat men kunde inte köras",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC är inte installerat i {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "prompt.permissions.autoaccept": "Autoacceptera behörigheter",
  "prompt.permissions.autoaccept.enabled": "Autoaccepterar behörigheter",
  "prompt.permissions.autoaccept.enable": "Autoacceptera behörigheter",
  "prompt.permissions.autoaccept.disable": "Sluta att automatiskt acceptera behörigheter",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i OpenCtrlC.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i openctrlc.json",
  ...
  "dialog.server.description": "Växla vilken OpenCtrlC-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Kontrollerar OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Kontrollerar OpenCtrlC i {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Uppdaterar OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Uppdaterar OpenCtrlC i {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Uppdatera OpenCtrlC i {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Uppdatera OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC är redo i {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC är redo.",
  "wsl.onboarding.installOpenctrlcIn": "Installera OpenCtrlC i {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Installera OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan OpenCtrlC kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan OpenCtrlC igen.",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av OpenCtrlC ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till OpenCtrlC-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (openctrlc.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, OpenCtrlC stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör OpenCtrlC-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "Anpassa hur OpenCtrlC ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om OpenCtrlC följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa OpenCtrlCs tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när OpenCtrlC startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av OpenCtrlC.",
  ...
  "session.search.placeholder": "Sök i den här sessionen",
  "session.search.input": "Sök i sessionens meddelanden",
  "session.search.scope": "Sökområde",
  "session.search.scope.conversation": "Konversation",
  "session.search.scope.all": "Allt innehåll",
  "session.search.results": "{{current}} av {{total}} resultat",
  "session.search.noResults": "Inga resultat",
  "session.search.loading": "Läser in resultat...",
  "session.search.partial": "Delvis historik",
  "session.search.retry": "Försök igen",
  "session.search.previous": "Föregående resultat",
  "session.search.next": "Nästa resultat",
  "session.search.close": "Stäng sökningen",
