export const dict = {
  ...
  "desktop.menu.documentation": "OpenCtrlC dokumentācija",
  ...
  "desktop.menu.ariaLabel": "OpenCtrlC izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt OpenCtrlC",
  "desktop.recovery.terminated": "OpenCtrlC logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "OpenCtrlC neatbild",
  ...
  "desktop.wsl.error.installOpenctrlc": "OpenCtrlC instalēšana neizdevās",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau ir pievienota",
  "desktop.wsl.error.openctrlcMissing": "openctrlc nav instalēts šajā distribūcijā",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC nav instalēts {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Automātiski pieņemt atļaujas",
  "prompt.permissions.autoaccept.enabled": "Atļaujas tiek automātiski apstiprinātas",
  "prompt.permissions.autoaccept.enable": "Automātiski pieņemt atļaujas",
  "prompt.permissions.autoaccept.disable": "Apturēt automātisku atļauju pieņemšanu",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus OpenCtrlC.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti openctrlc.json",
  ...
  "dialog.server.description": "Mainiet, pie kura OpenCtrlC servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Pārbaudu OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Pārbaudu OpenCtrlC distribūcijā {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Atjauninu OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Atjauninu OpenCtrlC distribūcijā {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Atjauniniet OpenCtrlC distribūcijā {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Atjauniniet OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC ir gatavs.",
  "wsl.onboarding.installOpenctrlcIn": "Instalējiet OpenCtrlC distribūcijā {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Instalējiet OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms OpenCtrlC var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet OpenCtrlC no jauna.",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu OpenCtrlC komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (openctrlc.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, OpenCtrlC vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "settings.desktop.wsl.description": "Palaist OpenCtrlC serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt OpenCtrlC saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā OpenCtrlC izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai OpenCtrlC sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet OpenCtrlC tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot OpenCtrlC",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko OpenCtrlC versiju.",
  ...
  "session.search.placeholder": "Meklēt šajā sesijā",
  "session.search.input": "Meklēt sesijas ziņojumos",
  "session.search.scope": "Meklēšanas tvērums",
  "session.search.scope.conversation": "Saruna",
  "session.search.scope.all": "Viss saturs",
  "session.search.results": "{{current}} no {{total}} rezultātiem",
  "session.search.noResults": "Rezultātu nav",
  "session.search.loading": "Ielādē rezultātus...",
  "session.search.partial": "Daļēja vēsture",
  "session.search.retry": "Mēģināt vēlreiz",
  "session.search.previous": "Iepriekšējais rezultāts",
  "session.search.next": "Nākamais rezultāts",
  "session.search.close": "Aizvērt meklēšanu",
