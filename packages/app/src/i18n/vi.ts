export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu OpenCtrlC",
  ...
  "desktop.recovery.loadFailed": "Không tải được OpenCtrlC",
  "desktop.recovery.terminated": "Cửa sổ OpenCtrlC đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "OpenCtrlC không phản hồi",
  ...
  "desktop.wsl.error.installOpenctrlc": "Không cài đặt được OpenCtrlC",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.openctrlcMissing": "openctrlc chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "Đã cập nhật OpenCtrlC nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Tự động chấp nhận quyền",
  "prompt.permissions.autoaccept.enabled": "Tự động chấp nhận quyền",
  "prompt.permissions.autoaccept.enable": "Tự động chấp nhận quyền",
  "prompt.permissions.autoaccept.disable": "Dừng tự động chấp nhận quyền",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do OpenCtrlC cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong OpenCtrlC.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong openctrlc.json",
  ...
  "dialog.server.description": "Chuyển máy chủ OpenCtrlC mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Đang kiểm tra OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Đang kiểm tra OpenCtrlC trong {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Đang cập nhật OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Đang cập nhật OpenCtrlC trong {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Cập nhật OpenCtrlC trong {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Cập nhật OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC đã sẵn sàng.",
  "wsl.onboarding.installOpenctrlcIn": "Cài đặt OpenCtrlC trong {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Cài đặt OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi OpenCtrlC có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại OpenCtrlC.",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm OpenCtrlC",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (openctrlc.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: OpenCtrlC chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ OpenCtrlC bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của OpenCtrlC trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem OpenCtrlC tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của OpenCtrlC.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi OpenCtrlC khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của OpenCtrlC.",
  ...
  "session.search.placeholder": "Tìm kiếm trong phiên này",
  "session.search.input": "Tìm kiếm trong tin nhắn phiên",
  "session.search.scope": "Phạm vi tìm kiếm",
  "session.search.scope.conversation": "Cuộc trò chuyện",
  "session.search.scope.all": "Tất cả nội dung",
  "session.search.results": "{{current}} trên {{total}} kết quả",
  "session.search.noResults": "Không có kết quả",
  "session.search.loading": "Đang tải kết quả...",
  "session.search.partial": "Lịch sử chưa đầy đủ",
  "session.search.retry": "Thử lại",
  "session.search.previous": "Kết quả trước",
  "session.search.next": "Kết quả tiếp theo",
  "session.search.close": "Đóng tìm kiếm",
