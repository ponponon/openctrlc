export const dict = {
  ...
  "desktop.menu.documentation": "OpenCtrlC دستاویزات",
  ...
  "desktop.menu.ariaLabel": "OpenCtrlC مینو",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "OpenCtrlC ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "OpenCtrlC جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpenctrlc": "OpenCtrlC کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.openctrlcMissing": "اس ڈسٹری بیوشن میں openctrlc انسٹال نہیں ہے",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.openctrlcNotInstalled": "{{distro}} میں OpenCtrlC انسٹال نہیں ہے",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "prompt.permissions.autoaccept": "اجازتیں خود بخود قبول کریں۔",
  "prompt.permissions.autoaccept.enabled": "خودکار طور پر قبول کرنے کی اجازتیں۔",
  "prompt.permissions.autoaccept.enable": "اجازتیں خود بخود قبول کریں۔",
  "prompt.permissions.autoaccept.disable": "اجازتوں کو خودکار طور پر قبول کرنا بند کریں۔",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenCtrlC کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور OpenCtrlC میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور OpenCtrlC میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور OpenCtrlC میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.plugins.empty": "openctrlc.json میں کنفیگر کردہ پلگ انز",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس OpenCtrlC سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpenctrlc": "OpenCtrlC چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpenctrlcIn": "{{distro}} میں OpenCtrlC چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpenctrlc": "OpenCtrlC کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpenctrlcIn": "{{distro}} میں OpenCtrlC کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpenctrlcIn": "{{distro}} میں OpenCtrlC کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpenctrlc": "OpenCtrlC کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC {{distro}} میں تیار ہے۔",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC تیار ہے۔",
  "wsl.onboarding.installOpenctrlcIn": "{{distro}} میں OpenCtrlC انسٹال کریں۔",
  "wsl.onboarding.installOpenctrlc": "OpenCtrlC انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ OpenCtrlC WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر OpenCtrlC کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "OpenCtrlC ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم OpenCtrlC ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (openctrlc.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، OpenCtrlC ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر OpenCtrlC سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "OpenCtrlC کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر OpenCtrlC کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا OpenCtrlC سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "OpenCtrlC کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "OpenCtrlC لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ OpenCtrlC کا تازہ ترین ورژن چلا رہے ہیں۔",
  ...
  "session.search.placeholder": "اس سیشن میں تلاش کریں",
  "session.search.input": "سیشن کے پیغامات میں تلاش کریں",
  "session.search.scope": "تلاش کا دائرہ",
  "session.search.scope.conversation": "گفتگو",
  "session.search.scope.all": "تمام مواد",
  "session.search.results": "{{total}} نتائج میں سے {{current}}",
  "session.search.noResults": "کوئی نتیجہ نہیں",
  "session.search.loading": "نتائج لوڈ ہو رہے ہیں...",
  "session.search.partial": "نامکمل تاریخ",
  "session.search.retry": "دوبارہ کوشش کریں",
  "session.search.previous": "پچھلا نتیجہ",
  "session.search.next": "اگلا نتیجہ",
  "session.search.close": "تلاش بند کریں",
