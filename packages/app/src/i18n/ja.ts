export const dict = {
  ...
  "desktop.recovery.loadFailed": "OpenCtrlCを読み込めませんでした",
  "desktop.recovery.terminated": "OpenCtrlCのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "OpenCtrlCが応答していません",
  ...
  "desktop.wsl.error.installOpenctrlc": "OpenCtrlCのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.openctrlcMissing": "このディストリビューションにはopenctrlcがインストールされていません",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlcはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.openctrlcNotInstalled": "{{distro}}にはOpenCtrlCがインストールされていません",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlCのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "prompt.permissions.autoaccept": "権限を自動承認する",
  "prompt.permissions.autoaccept.enabled": "権限を自動承認しています",
  "prompt.permissions.autoaccept.enable": "権限を自動承認する",
  "prompt.permissions.autoaccept.disable": "権限の自動承認を停止する",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenCtrlCが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、OpenCtrlCで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してOpenCtrlCで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、OpenCtrlCで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "openctrlc.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するOpenCtrlCサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpenctrlc": "OpenCtrlCを確認中...",
  "wsl.onboarding.checkingOpenctrlcIn": "{{distro}}内のOpenCtrlCを確認中...",
  "wsl.onboarding.updatingOpenctrlc": "OpenCtrlCを更新中...",
  "wsl.onboarding.updatingOpenctrlcIn": "{{distro}}内のOpenCtrlCを更新中...",
  "wsl.onboarding.updateOpenctrlcIn": "{{distro}}内のOpenCtrlCを更新してください。",
  "wsl.onboarding.updateOpenctrlc": "OpenCtrlCを更新",
  "wsl.onboarding.openctrlcReadyIn": "{{distro}}内のOpenCtrlCの準備ができました。",
  "wsl.onboarding.openctrlcReady": "OpenCtrlCの準備ができました。",
  "wsl.onboarding.installOpenctrlcIn": "{{distro}}にOpenCtrlCをインストールしてください。",
  "wsl.onboarding.installOpenctrlc": "OpenCtrlCをインストール",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlCがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "OpenCtrlCでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、OpenCtrlCをもう一度開いてください。",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "OpenCtrlCの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをOpenCtrlCチームに報告してください: ",
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlCには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でOpenCtrlCサーバーを実行します。",
  ...
  "settings.general.row.appearance.description": "デバイスでのOpenCtrlCの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "OpenCtrlCがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "OpenCtrlCのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "OpenCtrlC の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "OpenCtrlC は最新バージョンです。",
