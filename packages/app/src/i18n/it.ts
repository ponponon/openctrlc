export const dict = {
  ...
  "prompt.permissions.autoaccept": "Accetta automaticamente le autorizzazioni",
  "prompt.permissions.autoaccept.enabled": "Accettazione automatica delle autorizzazioni",
  "prompt.permissions.autoaccept.enable": "Accetta automaticamente le autorizzazioni",
  "prompt.permissions.autoaccept.disable": "Interrompi l'accettazione automatica delle autorizzazioni",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in OpenCtrlC.",
  ...
  "dialog.plugins.empty": "Plugin configurati in openctrlc.json",
  ...
  "dialog.server.description": "Cambia il server OpenCtrlC a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Controllo OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Controllo OpenCtrlC in {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Aggiornamento OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Aggiornamento OpenCtrlC in {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Aggiorna OpenCtrlC in {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Aggiorna OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC è pronto in {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC è pronto.",
  "wsl.onboarding.installOpenctrlcIn": "Installa OpenCtrlC in {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Installa OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che OpenCtrlC possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri OpenCtrlC.",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "Segnala questo errore al team OpenCtrlC",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (openctrlc.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: OpenCtrlC non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server OpenCtrlC all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di OpenCtrlC sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se OpenCtrlC segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di OpenCtrlC.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di OpenCtrlC",
  ...
  "settings.updates.toast.latest.title": "OpenCtrlC è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di OpenCtrlC.",
  ...
  "desktop.menu.documentation": "Documentazione di OpenCtrlC",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare OpenCtrlC",
  "desktop.recovery.terminated": "La finestra di OpenCtrlC si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "OpenCtrlC non risponde",
  ...
  "desktop.wsl.error.installOpenctrlc": "Installazione di OpenCtrlC non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.openctrlcMissing": "openctrlc non è installato in questa distribuzione",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC non è installato in {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "L'aggiornamento di OpenCtrlC è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
  ...
  "session.search.placeholder": "Cerca in questa sessione",
  "session.search.input": "Cerca nei messaggi della sessione",
  "session.search.scope": "Ambito di ricerca",
  "session.search.scope.conversation": "Conversazione",
  "session.search.scope.all": "Tutti i contenuti",
  "session.search.results": "{{current}} di {{total}} risultati",
  "session.search.noResults": "Nessun risultato",
  "session.search.loading": "Caricamento dei risultati...",
  "session.search.partial": "Cronologia parziale",
  "session.search.retry": "Riprova",
  "session.search.previous": "Risultato precedente",
  "session.search.next": "Risultato successivo",
  "session.search.close": "Chiudi ricerca",
