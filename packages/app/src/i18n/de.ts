...
export const dict = {
  ...
  "settings.skills.noProject": "Open a project to view its available skills.",
  "settings.skills.load.error": "Unable to load skills",
  "settings.skills.action.retry": "Retry",
  "settings.skills.action.expand": "Show skill details",
  "settings.skills.action.collapse": "Hide skill details",
  "settings.skills.source.builtin": "Built-in",
  "settings.skills.source.project": "Project or server",
  "settings.skills.tag.used": "Used in this session",
  "settings.skills.detail.location": "Source",
  "settings.skills.detail.unknownLocation": "Location unavailable",
  "settings.skills.detail.slash": "Invokable as",
  "settings.skills.description.missing": "No description provided",
  "settings.skills.empty.filter": "No skills match this search.",
  "settings.skills.empty.available": "No skills are available for this project.",
  ...
  "command.session.importOpencode": "Import OpenCode session",
  "command.session.importOpencode.description": "Import a session by ID from OpenCode",
  ...
  "prompt.permissions.autoaccept": "Berechtigungen automatisch akzeptieren",
  "prompt.permissions.autoaccept.enabled": "Berechtigungen werden automatisch akzeptiert",
  "prompt.permissions.autoaccept.enable": "Berechtigungen automatisch akzeptieren",
  "prompt.permissions.autoaccept.disable": "Automatische Akzeptanz von Berechtigungen stoppen",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in OpenCtrlC zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in OpenCtrlC zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in OpenCtrlC zu nutzen.",
  ...
  "dialog.plugins.empty": "In openctrlc.json konfigurierte Plugins",
  ...
  "dialog.session.importOpencode.title": "Import OpenCode session",
  "dialog.session.importOpencode.description": "Import the complete conversation from your local OpenCode database.",
  "dialog.session.importOpencode.source.label": "Source session",
  "dialog.session.importOpencode.source.found": "Found",
  "dialog.session.importOpencode.source.messages": "{{count}} messages",
  "dialog.session.importOpencode.source.workdir": "OpenCode workdir",
  "dialog.session.importOpencode.source.notFound": "Session not found. Check the ID or selected database.",
  "dialog.session.importOpencode.lookup": "Find session",
  "dialog.session.importOpencode.lookup.loading": "Finding...",
  "dialog.session.importOpencode.database.reset": "Use default",
  "dialog.session.importOpencode.target.choose": "Choose folder",
  "dialog.session.importOpencode.target.fromSession": "From session",
  "dialog.session.importOpencode.target.hintSession": "Using the workdir stored in this OpenCode session.",
  "dialog.session.importOpencode.target.hintCurrent": "Choose a folder where this session should be imported.",
  "dialog.session.importOpencode.target.reset": "Use session workdir",
  "dialog.session.importOpencode.sessionID.label": "Session ID",
  "dialog.session.importOpencode.sessionID.placeholder": "ses_...",
  "dialog.session.importOpencode.database.label": "OpenCode database",
  "dialog.session.importOpencode.database.default": "Use the default OpenCode database",
  "dialog.session.importOpencode.database.choose": "Choose database",
  "dialog.session.importOpencode.target.label": "Import into",
  "dialog.session.importOpencode.error.sessionID": "Enter a valid OpenCode session ID, for example ses_abc123.",
  "dialog.session.importOpencode.error.unavailable": "OpenCode import is unavailable in this desktop session.",
  "dialog.session.importOpencode.error.localOnly": "OpenCode import is only available for the local desktop server.",
  "dialog.session.importOpencode.error.project": "Open a project before importing an OpenCode session.",
  "dialog.session.importOpencode.success.title": "Session imported",
  "dialog.session.importOpencode.success.description": "Imported {{id}} from OpenCode.",
  "dialog.server.title": "Server",
  "dialog.server.description": "Wechseln Sie den OpenCtrlC-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.openctrlc": "OpenCtrlC",
  ...
  "wsl.onboarding.checkingOpenctrlc": "OpenCtrlC wird geprüft…",
  "wsl.onboarding.checkingOpenctrlcIn": "OpenCtrlC in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpenctrlc": "OpenCtrlC wird aktualisiert…",
  "wsl.onboarding.updatingOpenctrlcIn": "OpenCtrlC in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpenctrlcIn": "Aktualisieren Sie OpenCtrlC in {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "OpenCtrlC aktualisieren",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC ist in {{distro}} bereit.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC ist bereit.",
  "wsl.onboarding.installOpenctrlcIn": "Installieren Sie OpenCtrlC in {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "OpenCtrlC installieren",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor OpenCtrlC einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann OpenCtrlC erneut.",
  ...
  "toast.update.description": "Eine neue Version von OpenCtrlC ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem OpenCtrlC-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (openctrlc.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: OpenCtrlC unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "OpenCtrlC mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "OpenCtrlC-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für OpenCtrlC ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie OpenCtrlC auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob OpenCtrlC dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von OpenCtrlC anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von OpenCtrlC automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "OpenCtrlC ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von OpenCtrlC wird verwendet.",
  ...
  "desktop.menu.ariaLabel": "OpenCtrlC-Menü",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das OpenCtrlC-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "OpenCtrlC reagiert nicht",
  ...
  "desktop.wsl.error.installOpenctrlc": "OpenCtrlC-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.openctrlcMissing": "openctrlc ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "Das OpenCtrlC-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
  ...
  "session.search.placeholder": "Diese Sitzung durchsuchen",
  "session.search.input": "Sitzungsnachrichten durchsuchen",
  "session.search.scope": "Suchbereich",
  "session.search.scope.conversation": "Unterhaltung",
  "session.search.scope.all": "Alle Inhalte",
  "session.search.results": "{{current}} von {{total}} Ergebnissen",
  "session.search.noResults": "Keine Ergebnisse",
  "session.search.loading": "Ergebnisse werden geladen...",
  "session.search.partial": "Unvollständiger Verlauf",
  "session.search.retry": "Erneut versuchen",
  "session.search.previous": "Vorheriges Ergebnis",
  "session.search.next": "Nächstes Ergebnis",
  "session.search.close": "Suche schließen",
  "dialog.fork.location.title": "Create chat branch from here",
  "settings.skills.source.agents": "Agents global skills",
  "settings.skills.source.claude": "Claude Code skills",
  "settings.skills.source.config": "OpenCtrlC config",
  "settings.skills.runtime.service": "Service",
  "settings.skills.runtime.v1": "V1 compatibility service",
  "settings.skills.runtime.v2": "V2 service",
  "settings.skills.runtime.detecting": "Detecting…",
  "settings.skills.runtime.sources": "Skill sources",
  "settings.skills.runtime.sources.empty": "No discovered source yet",
