export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل OpenCtrlC",
  "desktop.recovery.terminated": "توقفت نافذة OpenCtrlC بشكل غير متوقع",
  "desktop.recovery.unresponsive": "OpenCtrlC لا يستجيب",
  ...
  "desktop.wsl.error.installOpenctrlc": "فشل تثبيت OpenCtrlC",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.openctrlcMissing": "openctrlc غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC غير مثبت في {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "اكتمل تحديث OpenCtrlC، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "prompt.permissions.autoaccept": "قبول الأذونات تلقائيًا",
  "prompt.permissions.autoaccept.enabled": "يتم قبول الأذونات تلقائيًا",
  "prompt.permissions.autoaccept.enable": "قبول الأذونات تلقائيًا",
  "prompt.permissions.autoaccept.disable": "إيقاف قبول الأذونات تلقائيًا",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في OpenCtrlC.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في openctrlc.json",
  ...
  "dialog.server.description": "تبديل خادم OpenCtrlC الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "جارٍ التحقق من OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "جارٍ التحقق من OpenCtrlC في {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "جارٍ تحديث OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "جارٍ تحديث OpenCtrlC في {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "حدّث OpenCtrlC في {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "تحديث OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC جاهز في {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC جاهز.",
  "wsl.onboarding.installOpenctrlcIn": "ثبّت OpenCtrlC في {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "تثبيت OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن OpenCtrlC من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على OpenCtrlC التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح OpenCtrlC.",
  ...
  "help.tabs.introduction": "أصبح OpenCtrlC Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من OpenCtrlC ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق OpenCtrlC",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (openctrlc.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن OpenCtrlC لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن OpenCtrlC نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم OpenCtrlC داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور OpenCtrlC على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان OpenCtrlC يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة OpenCtrlC.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل OpenCtrlC",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من OpenCtrlC.",
  ...
  "session.search.placeholder": "ابحث في هذه الجلسة",
  "session.search.input": "ابحث في رسائل الجلسة",
  "session.search.scope": "نطاق البحث",
  "session.search.scope.conversation": "المحادثة",
  "session.search.scope.all": "كل المحتوى",
  "session.search.results": "{{current}} من {{total}} من النتائج",
  "session.search.noResults": "لا توجد نتائج",
  "session.search.loading": "جارٍ تحميل النتائج...",
  "session.search.partial": "السجل غير مكتمل",
  "session.search.retry": "إعادة المحاولة",
  "session.search.previous": "النتيجة السابقة",
  "session.search.next": "النتيجة التالية",
  "session.search.close": "إغلاق البحث",
