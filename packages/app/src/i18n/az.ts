export const dict = {
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC yüklənə bilmədi",
  "desktop.recovery.terminated": "OpenCtrlC pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "OpenCtrlC cavab vermir",
  ...
  "desktop.wsl.error.installOpenctrlc": "OpenCtrlC quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.openctrlcMissing": "Bu distribütivdə openctrlc quraşdırılmayıb",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "prompt.permissions.autoaccept": "İcazələri avtomatik qəbul et",
  "prompt.permissions.autoaccept.enabled": "İcazələr avtomatik qəbul edilir",
  "prompt.permissions.autoaccept.enable": "İcazələri avtomatik qəbul et",
  "prompt.permissions.autoaccept.disable": "İcazələrin avtomatik qəbulu dayandırıldı",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenCtrlC tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və OpenCtrlC-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və OpenCtrlC-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və OpenCtrlC-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər openctrlc.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu OpenCtrlC serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "OpenCtrlC yoxlanılır...",
  "wsl.onboarding.checkingOpenctrlcIn": "{{distro}}-də OpenCtrlC yoxlanılır...",
  "wsl.onboarding.updatingOpenctrlc": "OpenCtrlC yenilənir...",
  "wsl.onboarding.updatingOpenctrlcIn": "{{distro}}-də OpenCtrlC yenilənir...",
  "wsl.onboarding.updateOpenctrlcIn": "{{distro}}-də OpenCtrlC-u yeniləyin.",
  "wsl.onboarding.updateOpenctrlc": "OpenCtrlC-u yeniləyin",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC {{distro}}-də hazırdır.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC hazırdır.",
  "wsl.onboarding.installOpenctrlcIn": "OpenCtrlC-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpenctrlc": "OpenCtrlC quraşdırın",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "OpenCtrlC WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra OpenCtrlC-u yenidən açın.",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "Bu xətanı OpenCtrlC komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (openctrlc.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: OpenCtrlC hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində OpenCtrlC serverini işlət.",
  ...
  "settings.general.row.language.description": "OpenCtrlC üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "OpenCtrlC-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "OpenCtrlC-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "OpenCtrlC-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "OpenCtrlC açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "OpenCtrlC-un ən son versiyasından istifadə edirsiniz.",
  ...
  "session.search.placeholder": "Bu sessiyada axtar",
  "session.search.input": "Sessiya mesajlarında axtar",
  "session.search.scope": "Axtarış sahəsi",
  "session.search.scope.conversation": "Söhbət",
  "session.search.scope.all": "Bütün məzmun",
  "session.search.results": "{{total}} nəticədən {{current}}",
  "session.search.noResults": "Nəticə yoxdur",
  "session.search.loading": "Nəticələr yüklənir...",
  "session.search.partial": "Tarixçənin bir hissəsi",
  "session.search.retry": "Yenidən yoxla",
  "session.search.previous": "Əvvəlki nəticə",
  "session.search.next": "Növbəti nəticə",
  "session.search.close": "Axtarışı bağla",
