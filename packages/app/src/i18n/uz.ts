export const dict = {
  ...
  "desktop.menu.documentation": "OpenCtrlC hujjatlari",
  ...
  "desktop.menu.ariaLabel": "OpenCtrlC menyusi",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC yuklanmadi",
  "desktop.recovery.terminated": "OpenCtrlC oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "OpenCtrlC javob bermayapti",
  ...
  "desktop.wsl.error.installOpenctrlc": "OpenCtrlC oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.openctrlcMissing": "Opencode ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Ruxsatlarni avtomatik qabul qilish",
  "prompt.permissions.autoaccept.enabled": "Ruxsatlarni avtomatik qabul qilish",
  "prompt.permissions.autoaccept.enable": "Ruxsatlarni avtomatik qabul qilish",
  "prompt.permissions.autoaccept.disable": "Ruxsatlarni avtomatik qabul qilishni to'xtating",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenCtrlC tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va OpenCtrlC’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va OpenCtrlC da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va OpenCtrlC da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "openctrlc.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi OpenCtrlC serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "OpenCtrlC tekshirilmoqda...",
  "wsl.onboarding.checkingOpenctrlcIn": "OpenCtrlC {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpenctrlc": "OpenCtrlC yangilanmoqda...",
  "wsl.onboarding.updatingOpenctrlcIn": "OpenCtrlC {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpenctrlcIn": "OpenCtrlC-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpenctrlc": "OpenCtrlC-ni yangilang",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC {{distro}} da tayyor.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC tayyor.",
  "wsl.onboarding.installOpenctrlcIn": "OpenCtrlC-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpenctrlc": "OpenCtrlC-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "OpenCtrlC WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra OpenCtrlC-ni qayta oching.",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida OpenCtrlC jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (openctrlc.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, OpenCtrlC hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "OpenCtrlC bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi OpenCtrlC serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "OpenCtrlC uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "OpenCtrlC qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "OpenCtrlC tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "OpenCtrlC mavzusini sozlash.",
  ...
  "settings.updates.toast.latest.description": "Siz OpenCtrlC oxirgi versiyasini ishga tushiryapsiz.",
  ...
  "session.search.placeholder": "Bu sessiyada qidiring",
  "session.search.input": "Sessiya xabarlaridan qidiring",
  "session.search.scope": "Qidiruv doirasi",
  "session.search.scope.conversation": "Suhbat",
  "session.search.scope.all": "Barcha tarkib",
  "session.search.results": "{{total}} natijadan {{current}}",
  "session.search.noResults": "Natijalar topilmadi",
  "session.search.loading": "Natijalar yuklanmoqda...",
  "session.search.partial": "Qisman tarix",
  "session.search.retry": "Qayta urinish",
  "session.search.previous": "Oldingi natija",
  "session.search.next": "Keyingi natija",
  "session.search.close": "Qidiruvni yopish",
