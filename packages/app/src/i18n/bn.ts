export const dict: Record<string, string> = {
  ...
  "desktop.menu.documentation": "OpenCtrlC ডকুমেন্টেশন",
  ...
  "desktop.menu.ariaLabel": "OpenCtrlC মেনু",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC লোড হতে ব্যর্থ হয়েছে৷",
  "desktop.recovery.terminated": "OpenCtrlC উইন্ডো অপ্রত্যাশিতভাবে বন্ধ হয়ে গেছে",
  "desktop.recovery.unresponsive": "OpenCtrlC সাড়া দিচ্ছে না",
  ...
  "desktop.wsl.error.installOpenctrlc": "OpenCtrlC ইনস্টলেশন ব্যর্থ হয়েছে৷",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ইতিমধ্যেই যোগ করা হয়েছে৷",
  "desktop.wsl.error.openctrlcMissing": "এই ডিস্ট্রোতে openctrlc ইনস্টল করা নেই",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc ইনস্টল করা আছে কিন্তু চালানো যায়নি",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC {{distro}} এ ইনস্টল করা নেই",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC আপডেট শেষ হয়েছে কিন্তু {{distro}} এখনও রিপোর্ট করে {{installed}}; প্রত্যাশিত {{expected}}",
  ...
  "prompt.permissions.autoaccept": "স্বয়ংক্রিয়ভাবে অনুমতি গ্রহণ করুন",
  "prompt.permissions.autoaccept.enabled": "স্বয়ংক্রিয়ভাবে গ্রহণযোগ্য অনুমতি",
  "prompt.permissions.autoaccept.enable": "স্বয়ংক্রিয়ভাবে অনুমতি গ্রহণ করুন",
  "prompt.permissions.autoaccept.disable": "স্বয়ংক্রিয়ভাবে অনুমতি নেওয়া বন্ধ করুন",
  ...
  "dialog.model.unpaid.freeModels.title": "বিনামূল্যের মডেলগুলি OpenCtrlC দ্বারা প্রদত্ত",
  ...
  "provider.connect.apiKey.description":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার {{provider}} API কী লিখুন এবং OpenCtrlC-এ {{provider}} মডেলগুলি ব্যবহার করুন৷",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার অনুমোদন কোড সংগ্রহ করতে এবং {{provider}} মডেলগুলি OpenCtrlC-এ ব্যবহার করতে।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "এবং আপনার অ্যাকাউন্ট সংযোগ করতে নীচের কোডটি লিখুন এবং {{provider}} মডেলগুলি OpenCtrlC-এ ব্যবহার করুন৷",
  ...
  "dialog.plugins.empty": "openctrlc.json এ কনফিগার করা প্লাগইন",
  ...
  "dialog.server.description": "এই অ্যাপটি কোন OpenCtrlC সার্ভারের সাথে সংযোগ করে তা পরিবর্তন করুন।",
  ...
  "wsl.onboarding.checkingOpenctrlc": "OpenCtrlC পরীক্ষা করা হচ্ছে...",
  "wsl.onboarding.checkingOpenctrlcIn": "{{distro}} এ OpenCtrlC চেক করা হচ্ছে...",
  "wsl.onboarding.updatingOpenctrlc": "আপডেট করা হচ্ছে OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "{{distro}}-এ OpenCtrlC আপডেট করা হচ্ছে...",
  "wsl.onboarding.updateOpenctrlcIn": "{{distro}}-এ OpenCtrlC আপডেট করুন।",
  "wsl.onboarding.updateOpenctrlc": "OpenCtrlC আপডেট করুন",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC {{distro}}-এ প্রস্তুত।",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC প্রস্তুত।",
  "wsl.onboarding.installOpenctrlcIn": "{{distro}}-এ OpenCtrlC ইনস্টল করুন।",
  "wsl.onboarding.installOpenctrlc": "OpenCtrlC ইনস্টল করুন",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC ইনস্টল করা নেই",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux এর জন্য Windows সাবসিস্টেম) OpenCtrlC একটি WSL সার্ভার যোগ করার আগে প্রয়োজন",
  "wsl.onboarding.wslUnavailable.title": "WSL অনুপলব্ধ",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC এই মেশিনে WSL যাচাই করতে পারেনি।",
  "wsl.onboarding.installWsl": "WSL ইনস্টল করুন",
  "wsl.onboarding.windowsRestartRequired":
    "WSL ইনস্টল করা শেষ করতে Windows পুনরায় চালু করুন, তারপর OpenCtrlC আবার খুলুন।",
  ...
  "help.tabs.introduction": "OpenCtrlC ডেস্কটপ এখন ট্যাবের চারপাশে তৈরি।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "OpenCtrlC ({{version}}) এর একটি নতুন সংস্করণ এখন ইনস্টল করার জন্য উপলব্ধ৷",
  ...
  "error.page.report.prefix": "অনুগ্রহ করে এই ত্রুটিটি OpenCtrlC টিমের কাছে রিপোর্ট করুন",
  ...
  "error.chain.checkConfig": "আপনার কনফিগারেশন (openctrlc.json) প্রদানকারী/মডেলের নাম পরীক্ষা করুন",
  "error.chain.mcpFailed":
    'MCP সার্ভার "{{name}}" ব্যর্থ হয়েছে৷ মনে রাখবেন, OpenCtrlC এখনও MCP প্রমাণীকরণ সমর্থন করে না।',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC বিনামূল্যে মডেল অন্তর্ভুক্ত করে যাতে আপনি অবিলম্বে শুরু করতে পারেন।",
  ...
  "app.name.desktop": "OpenCtrlC ডেস্কটপ",
  ...
  "settings.desktop.wsl.description": "Windows-এ WSL-এর ভিতরে OpenCtrlC সার্ভার চালান।",
  ...
  "settings.general.row.language.description": "OpenCtrlC-এর জন্য প্রদর্শনের ভাষা পরিবর্তন করুন",
  ...
  "settings.general.row.appearance.description": "আপনার ডিভাইসে OpenCtrlC কেমন দেখায় তা কাস্টমাইজ করুন",
  "settings.general.row.colorScheme.title": "রঙের স্কিম",
  "settings.general.row.colorScheme.description": "OpenCtrlC সিস্টেম, হালকা বা অন্ধকার থিম অনুসরণ করে কিনা তা বেছে নিন",
  "settings.general.row.theme.title": "থিম",
  "settings.general.row.theme.description": "কিভাবে OpenCtrlC থিম করা হয় তা কাস্টমাইজ করুন।",
  ...
  "settings.updates.row.startup.description": "OpenCtrlC চালু হলে স্বয়ংক্রিয়ভাবে আপডেটের জন্য চেক করুন",
  ...
  "settings.updates.toast.latest.description": "আপনি OpenCtrlC এর সর্বশেষ সংস্করণ চালাচ্ছেন।",
  ...
  "session.search.placeholder": "এই সেশনে অনুসন্ধান করুন",
  "session.search.input": "সেশনের বার্তায় অনুসন্ধান করুন",
  "session.search.scope": "অনুসন্ধানের পরিসর",
  "session.search.scope.conversation": "কথোপকথন",
  "session.search.scope.all": "সমস্ত বিষয়বস্তু",
  "session.search.results": "{{total}}টি ফলাফলের মধ্যে {{current}}",
  "session.search.noResults": "কোনও ফলাফল নেই",
  "session.search.loading": "ফলাফল লোড হচ্ছে...",
  "session.search.partial": "আংশিক ইতিহাস",
  "session.search.retry": "আবার চেষ্টা করুন",
  "session.search.previous": "আগের ফলাফল",
  "session.search.next": "পরের ফলাফল",
  "session.search.close": "অনুসন্ধান বন্ধ করুন",
