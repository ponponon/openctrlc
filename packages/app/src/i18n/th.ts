export const dict = {
  ...
  "desktop.wsl.error.installOpenctrlc": "การติดตั้ง OpenCtrlC ล้มเหลว",
  "desktop.wsl.error.alreadyAdded": "เพิ่ม {{distro}} แล้ว",
  "desktop.wsl.error.openctrlcMissing": "ไม่ได้ติดตั้ง openctrlc ในดิสโทรนี้",
  "desktop.wsl.error.openctrlcCannotRun": "ติดตั้ง openctrlc แล้ว แต่ไม่สามารถเรียกใช้ได้",
  "desktop.wsl.error.openctrlcNotInstalled": "ไม่ได้ติดตั้ง OpenCtrlC ใน {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "อัปเดต OpenCtrlC เสร็จแล้ว แต่ {{distro}} ยังคงรายงานเวอร์ชัน {{installed}} ทั้งที่ควรเป็น {{expected}}",
  ...
  "prompt.permissions.autoaccept": "ยอมรับสิทธิ์โดยอัตโนมัติ",
  "prompt.permissions.autoaccept.enabled": "กำลังยอมรับสิทธิ์โดยอัตโนมัติ",
  "prompt.permissions.autoaccept.enable": "ยอมรับสิทธิ์โดยอัตโนมัติ",
  "prompt.permissions.autoaccept.disable": "หยุดยอมรับสิทธิ์โดยอัตโนมัติ",
  ...
  "wsl.onboarding.checkingOpenctrlc": "กำลังตรวจสอบ OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "กำลังตรวจสอบ OpenCtrlC ใน {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "กำลังอัปเดต OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "กำลังอัปเดต OpenCtrlC ใน {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "อัปเดต OpenCtrlC ใน {{distro}}",
  "wsl.onboarding.updateOpenctrlc": "อัปเดต OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC พร้อมใช้งานแล้ว",
  "wsl.onboarding.installOpenctrlcIn": "ติดตั้ง OpenCtrlC ใน {{distro}}",
  "wsl.onboarding.installOpenctrlc": "ติดตั้ง OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "ยังไม่ได้ติดตั้ง OpenCtrlC",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ OpenCtrlC จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด OpenCtrlC อีกครั้ง",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ OpenCtrlC ภายใน WSL บน Windows",
  ...
  "session.search.placeholder": "ค้นหาในเซสชันนี้",
  "session.search.input": "ค้นหาในข้อความของเซสชัน",
  "session.search.scope": "ขอบเขตการค้นหา",
  "session.search.scope.conversation": "การสนทนา",
  "session.search.scope.all": "เนื้อหาทั้งหมด",
  "session.search.results": "{{current}} จาก {{total}} ผลลัพธ์",
  "session.search.noResults": "ไม่พบผลลัพธ์",
  "session.search.loading": "กำลังโหลดผลลัพธ์...",
  "session.search.partial": "ประวัติบางส่วน",
  "session.search.retry": "ลองอีกครั้ง",
  "session.search.previous": "ผลลัพธ์ก่อนหน้า",
  "session.search.next": "ผลลัพธ์ถัดไป",
  "session.search.close": "ปิดการค้นหา",
