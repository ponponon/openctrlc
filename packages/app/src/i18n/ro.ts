export const dict = {
  ...
  "desktop.menu.documentation": "Documentație OpenCtrlC",
  ...
  "desktop.menu.ariaLabel": "Meniu OpenCtrlC",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra OpenCtrlC s-a închis neașteptat",
  "desktop.recovery.unresponsive": "OpenCtrlC nu răspunde",
  ...
  "desktop.wsl.error.installOpenctrlc": "Instalarea OpenCtrlC a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.openctrlcMissing": "openctrlc nu este instalat în această distribuție",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC nu este instalat în {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "Actualizarea OpenCtrlC s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Acceptă automat permisiunile",
  "prompt.permissions.autoaccept.enabled": "Permisiuni acceptate automat",
  "prompt.permissions.autoaccept.enable": "Acceptă automat permisiunile",
  "prompt.permissions.autoaccept.disable": "Oprește acceptarea automată a permisiunilor",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în OpenCtrlC.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în openctrlc.json",
  ...
  "dialog.server.description": "Schimbă serverul OpenCtrlC la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Se verifică OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Se verifică OpenCtrlC în {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Se actualizează OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Se actualizează OpenCtrlC în {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Actualizează OpenCtrlC în {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Actualizează OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC este gata în {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC este gata.",
  "wsl.onboarding.installOpenctrlcIn": "Instalează OpenCtrlC în {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Instalează OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca OpenCtrlC să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide OpenCtrlC.",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune OpenCtrlC ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei OpenCtrlC",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (openctrlc.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, OpenCtrlC nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul OpenCtrlC în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul OpenCtrlC pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă OpenCtrlC urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema OpenCtrlC.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea OpenCtrlC",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune OpenCtrlC.",
  ...
  "session.search.placeholder": "Caută în această sesiune",
  "session.search.input": "Caută în mesajele sesiunii",
  "session.search.scope": "Domeniul căutării",
  "session.search.scope.conversation": "Conversație",
  "session.search.scope.all": "Tot conținutul",
  "session.search.results": "{{current}} din {{total}} rezultate",
  "session.search.noResults": "Niciun rezultat",
  "session.search.loading": "Se încarcă rezultatele...",
  "session.search.partial": "Istoric parțial",
  "session.search.retry": "Încearcă din nou",
  "session.search.previous": "Rezultatul anterior",
  "session.search.next": "Rezultatul următor",
  "session.search.close": "Închide căutarea",
