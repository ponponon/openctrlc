...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC 加载失败",
  "desktop.recovery.terminated": "OpenCtrlC 窗口意外终止",
  "desktop.recovery.unresponsive": "OpenCtrlC 未响应",
  ...
  "desktop.wsl.error.installOpenctrlc": "OpenCtrlC 安装失败",
  "desktop.wsl.error.alreadyAdded": "已添加 {{distro}}",
  "desktop.wsl.error.openctrlcMissing": "此发行版中未安装 openctrlc",
  "desktop.wsl.error.openctrlcCannotRun": "已安装 openctrlc，但无法运行",
  "desktop.wsl.error.openctrlcNotInstalled": "{{distro}} 中未安装 OpenCtrlC",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenCtrlC 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 OpenCtrlC 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 OpenCtrlC 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 并输入以下代码，以连接你的账户并在 OpenCtrlC 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 openctrlc.json 中配置的插件",
  ...
  "dialog.session.importOpencode.source.label": "来源会话",
  "dialog.session.importOpencode.source.found": "已找到",
  "dialog.session.importOpencode.source.messages": "{{count}} 条消息",
  "dialog.session.importOpencode.source.workdir": "OpenCode 工作目录",
  "dialog.session.importOpencode.source.notFound": "没有找到这个会话，请检查 Session ID 或所选数据库。",
  "dialog.session.importOpencode.sessionID.label": "Session ID",
  "dialog.session.importOpencode.sessionID.placeholder": "ses_...",
  "dialog.session.importOpencode.lookup": "查找会话",
  "dialog.session.importOpencode.lookup.loading": "查找中…",
  ...
  "dialog.session.importOpencode.database.reset": "使用默认",
  "dialog.session.importOpencode.target.label": "导入目标",
  "dialog.session.importOpencode.target.choose": "选择文件夹",
  "dialog.session.importOpencode.target.fromSession": "来自会话",
  "dialog.session.importOpencode.target.hintSession": "默认使用此 OpenCode 会话中记录的工作目录",
  "dialog.session.importOpencode.target.hintCurrent": "选择导入目标文件夹",
  "dialog.session.importOpencode.target.reset": "恢复会话目录",
  ...
  "wsl.onboarding.checkingOpenctrlc": "正在检查 OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "正在检查 {{distro}} 中的 OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlc": "正在更新 OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "正在更新 {{distro}} 中的 OpenCtrlC...",
  "wsl.onboarding.updateOpenctrlcIn": "更新 {{distro}} 中的 OpenCtrlC。",
  "wsl.onboarding.updateOpenctrlc": "更新 OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "{{distro}} 中的 OpenCtrlC 已就绪。",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC 已就绪。",
  "wsl.onboarding.installOpenctrlcIn": "在 {{distro}} 中安装 OpenCtrlC。",
  "wsl.onboarding.installOpenctrlc": "安装 OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "未安装 OpenCtrlC",
  ...
  "wsl.onboarding.wslNotInstalled.description": "OpenCtrlC 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 OpenCtrlC。",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "OpenCtrlC 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 OpenCtrlC 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (openctrlc.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：OpenCtrlC 暂不支持 MCP 认证。',
  ...
  "session.messages.newOutputs.other": "{{count}} 条新输出",
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 OpenCtrlC 服务器。",
  ...
  "settings.general.row.appearance.description": "自定义 OpenCtrlC 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 OpenCtrlC 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 OpenCtrlC 的主题。",
  ...
  "settings.updates.row.startup.description": "在 OpenCtrlC 启动时自动检查更新",
  ...
  "settings.skills.description": "查看当前项目可用的技能、来源，以及本次会话已经使用的技能。",
  "settings.skills.section.available": "当前项目可用",
  "settings.skills.section.available.description": "这些技能来自项目和服务器配置，需要时智能体可以加载它们的指令。",
  "settings.skills.section.session": "本次会话已使用",
  "settings.skills.session.empty": "本次会话还没有激活任何技能。",
  "settings.skills.session.used": "智能体已在本次会话中激活",
  "settings.skills.search.placeholder": "搜索技能",
  "settings.skills.noProject": "打开一个项目后即可查看可用技能。",
  "settings.skills.load.error": "技能加载失败",
  "settings.skills.action.retry": "重试",
  "settings.skills.action.expand": "显示技能详情",
  "settings.skills.action.collapse": "隐藏技能详情",
  "settings.skills.source.builtin": "内置",
  "settings.skills.source.agents": "Agents 全局技能",
  "settings.skills.source.claude": "Claude Code 技能",
  "settings.skills.source.config": "OpenCtrlC 配置",
  "settings.skills.source.project": "项目或服务器",
  "settings.skills.runtime.service": "服务",
  "settings.skills.runtime.v1": "V1 兼容服务",
  "settings.skills.runtime.v2": "V2 服务",
  "settings.skills.runtime.detecting": "正在检测…",
  "settings.skills.runtime.sources": "Skill 来源",
  "settings.skills.runtime.sources.empty": "暂未发现来源",
  "settings.skills.tag.used": "本次会话已使用",
  "settings.skills.detail.location": "来源",
  "settings.skills.detail.unknownLocation": "来源未知",
  "settings.skills.detail.slash": "调用方式",
  "settings.skills.description.missing": "未提供描述",
  "settings.skills.empty.filter": "没有匹配的技能。",
  ...
  "session.search.placeholder": "搜索此会话",
  "session.search.input": "搜索会话消息",
  "session.search.scope": "搜索范围",
  "session.search.scope.conversation": "对话",
  "session.search.scope.all": "全部内容",
  "session.search.results": "{{current}} / {{total}} 个结果",
  "session.search.noResults": "无结果",
  "session.search.loading": "正在加载结果...",
  "session.search.partial": "历史记录不完整",
  "session.search.retry": "重试",
  "session.search.previous": "上一个结果",
  "session.search.next": "下一个结果",
  "session.search.close": "关闭搜索",
