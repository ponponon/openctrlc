export const dict = {
  ...
  "desktop.menu.documentation": "ឯកសារ OpenCtrlC",
  ...
  "desktop.menu.ariaLabel": "ម៉ឺនុយ OpenCtrlC",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC បានបរាជ័យក្នុងការផ្ទុក",
  "desktop.recovery.terminated": "បង្អួច OpenCtrlC ត្រូវបានបញ្ចប់ដោយមិននឹកស្មានដល់",
  "desktop.recovery.unresponsive": "OpenCtrlC មិនឆ្លើយតបទេ។",
  ...
  "desktop.wsl.error.installOpenctrlc": "ការដំឡើង OpenCtrlC បានបរាជ័យ",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ត្រូវបានបន្ថែមរួចហើយ",
  "desktop.wsl.error.openctrlcMissing": "openctrlc មិនត្រូវបានដំឡើងនៅក្នុង distro នេះទេ។",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc ត្រូវបានដំឡើង ប៉ុន្តែមិនអាចដំណើរការបានទេ។",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC មិនត្រូវបានដំឡើងនៅក្នុង {{distro}} ទេ។",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "ការធ្វើបច្ចុប្បន្នភាព OpenCtrlC បានបញ្ចប់ ប៉ុន្តែ {{distro}} នៅតែរាយការណ៍ {{installed}}; {{expected}} រំពឹងទុក",
  ...
  "prompt.permissions.autoaccept": "ការអនុញ្ញាតដោយស្វ័យប្រវត្តិ",
  "prompt.permissions.autoaccept.enabled": "ការអនុញ្ញាតដោយស្វ័យប្រវត្តិ",
  "prompt.permissions.autoaccept.enable": "ការអនុញ្ញាតដោយស្វ័យប្រវត្តិ",
  "prompt.permissions.autoaccept.disable": "បញ្ឈប់ការអនុញ្ញាតដោយស្វ័យប្រវត្តិ",
  ...
  "dialog.model.unpaid.freeModels.title": "ម៉ូដែលឥតគិតថ្លៃដែលផ្តល់ដោយ OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "បញ្ចូល {{provider}} API key របស់អ្នក ដើម្បីភ្ជាប់គណនីរបស់អ្នក ហើយប្រើម៉ូដែល {{provider}} នៅក្នុង OpenCtrlC។",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "ដើម្បីប្រមូលលេខកូដអនុញ្ញាតរបស់អ្នកដើម្បីភ្ជាប់គណនីរបស់អ្នក និងប្រើម៉ូដែល {{provider}} នៅក្នុង OpenCtrlC ។",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ហើយបញ្ចូលលេខកូដខាងក្រោមដើម្បីភ្ជាប់គណនីរបស់អ្នក ហើយប្រើម៉ូដែល {{provider}} នៅក្នុង OpenCtrlC។",
  ...
  "dialog.plugins.empty": "កម្មវិធីជំនួយដែលបានកំណត់រចនាសម្ព័ន្ធនៅក្នុង openctrlc.json",
  ...
  "dialog.server.description": "ប្តូរម៉ាស៊ីនមេ OpenCtrlC ដែលកម្មវិធីនេះភ្ជាប់ទៅ។",
  ...
  "wsl.onboarding.checkingOpenctrlc": "កំពុងពិនិត្យមើលកូដ OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "កំពុងពិនិត្យកូដ OpenCtrlC ក្នុង {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "កំពុងអាប់ដេត OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "កំពុងអាប់ដេត OpenCtrlC ក្នុង {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "ធ្វើបច្ចុប្បន្នភាព OpenCtrlC ក្នុង {{distro}} ។",
  "wsl.onboarding.updateOpenctrlc": "ធ្វើបច្ចុប្បន្នភាព OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC គឺរួចរាល់នៅក្នុង {{distro}} ។",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC គឺរួចរាល់។",
  "wsl.onboarding.installOpenctrlcIn": "ដំឡើង OpenCtrlC ក្នុង {{distro}} ។",
  "wsl.onboarding.installOpenctrlc": "ដំឡើង OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC មិនត្រូវបានដំឡើងទេ។",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (ប្រព័ន្ធរងវីនដូសម្រាប់លីនុច) ត្រូវបានទាមទារ មុនពេល OpenCtrlC អាចបន្ថែមម៉ាស៊ីនមេ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL មិនអាចប្រើបានទេ។",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC មិនអាចផ្ទៀងផ្ទាត់ WSL នៅលើម៉ាស៊ីននេះបានទេ។",
  "wsl.onboarding.installWsl": "ដំឡើង WSL",
  "wsl.onboarding.windowsRestartRequired":
    "ចាប់ផ្ដើម Windows ឡើងវិញ ដើម្បីបញ្ចប់ការដំឡើង WSL បន្ទាប់មកបើក OpenCtrlC ឡើងវិញ។",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop ឥឡូវនេះត្រូវបានបង្កើតឡើងនៅជុំវិញផ្ទាំង។",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "សូមរាយការណ៍ពីកំហុសនេះទៅកាន់ក្រុម OpenCtrlC",
  ...
  "error.chain.checkConfig": "ពិនិត្យការកំណត់រចនាសម្ព័ន្ធរបស់អ្នក (openctrlc.json) អ្នកផ្តល់សេវា/ឈ្មោះម៉ូដែល",
  "error.chain.mcpFailed": 'ម៉ាស៊ីនមេ MCP "{{name}}" បានបរាជ័យ។ ចំណាំ OpenCtrlC មិនគាំទ្រការផ្ទៀងផ្ទាត់ MCP នៅឡើយទេ។',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC រួមបញ្ចូលម៉ូដែលឥតគិតថ្លៃ ដូច្នេះអ្នកអាចចាប់ផ្តើមភ្លាមៗ។",
  ...
  "settings.desktop.wsl.description": "ដំណើរការម៉ាស៊ីនមេ OpenCtrlC នៅខាងក្នុង WSL នៅលើ Windows ។",
  ...
  "settings.general.row.language.description": "ប្តូរភាសាបង្ហាញសម្រាប់ OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "ប្ដូរតាមបំណងពីរបៀបដែល OpenCtrlC មើលទៅលើឧបករណ៍របស់អ្នក។",
  "settings.general.row.colorScheme.title": "ពណ៌ចម្រុះ",
  "settings.general.row.colorScheme.description": "ជ្រើសរើសថាតើ OpenCtrlC ធ្វើតាមប្រព័ន្ធ ពន្លឺ ឬរូបរាងងងឹត",
  "settings.general.row.theme.title": "ស្បែក",
  "settings.general.row.theme.description": "ប្ដូរតាមបំណងពីរបៀបដែល OpenCtrlC មានប្រធានបទ។",
  ...
  "settings.updates.row.startup.description": "ពិនិត្យមើលការអាប់ដេតដោយស្វ័យប្រវត្តិនៅពេលដែល OpenCtrlC ចាប់ផ្តើម",
  ...
  "settings.updates.toast.latest.description": "អ្នកកំពុងដំណើរការកំណែចុងក្រោយបំផុតនៃ OpenCtrlC ។",
  ...
  "session.search.placeholder": "ស្វែងរកក្នុងសម័យនេះ",
  "session.search.input": "ស្វែងរកក្នុងសាររបស់សម័យ",
  "session.search.scope": "វិសាលភាពស្វែងរក",
  "session.search.scope.conversation": "ការសន្ទនា",
  "session.search.scope.all": "មាតិកាទាំងអស់",
  "session.search.results": "{{current}} ក្នុងចំណោមលទ្ធផល {{total}}",
  "session.search.noResults": "គ្មានលទ្ធផល",
  "session.search.loading": "កំពុងផ្ទុកលទ្ធផល...",
  "session.search.partial": "ប្រវត្តិមិនពេញលេញ",
  "session.search.retry": "ព្យាយាមម្ដងទៀត",
  "session.search.previous": "លទ្ធផលមុន",
  "session.search.next": "លទ្ធផលបន្ទាប់",
  "session.search.close": "បិទការស្វែងរក",
