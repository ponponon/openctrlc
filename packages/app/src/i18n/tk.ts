export const dict = {
  ...
  "desktop.menu.documentation": "OpenCtrlC Resminamalar",
  ...
  "desktop.menu.ariaLabel": "OpenCtrlC menýusy",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC ýükläp bilmedi",
  "desktop.recovery.terminated": "OpenCtrlC penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "OpenCtrlC jogap berenok",
  ...
  "desktop.wsl.error.installOpenctrlc": "OpenCtrlC gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.openctrlcMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC {{distro}} gurulmady",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Rugsatlary awtomatiki kabul ediň",
  "prompt.permissions.autoaccept.enabled": "Awto-kabul ediş rugsatlary",
  "prompt.permissions.autoaccept.enable": "Rugsatlary awtomatiki kabul ediň",
  "prompt.permissions.autoaccept.disable": "Awto-kabul ediş rugsatlaryny bes ediň",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenCtrlC tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we OpenCtrlC-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini OpenCtrlC-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini OpenCtrlC-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "openctrlc.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy OpenCtrlC serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "OpenCtrlC barlamak ...",
  "wsl.onboarding.checkingOpenctrlcIn": "{{distro}} içinde OpenCtrlC barlanýar...",
  "wsl.onboarding.updatingOpenctrlc": "OpenCtrlC täzelenmek ...",
  "wsl.onboarding.updatingOpenctrlcIn": "{{distro}}-de OpenCtrlC täzelenmek ...",
  "wsl.onboarding.updateOpenctrlcIn": "OpenCtrlC-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateOpenctrlc": "OpenCtrlC täzeläň",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC {{distro}}-de taýýar.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC taýýar.",
  "wsl.onboarding.installOpenctrlcIn": "{{distro}}-de OpenCtrlC guruň.",
  "wsl.onboarding.installOpenctrlc": "OpenCtrlC guruň",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) OpenCtrlC WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra OpenCtrlC açyň.",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy OpenCtrlC toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (openctrlc.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, OpenCtrlC entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "OpenCtrlC serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "OpenCtrlC üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "OpenCtrlC enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "OpenCtrlC ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "OpenCtrlC-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "OpenCtrlC işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "OpenCtrlC-iň iň soňky wersiýasyny işleýärsiňiz.",
  ...
  "session.search.placeholder": "Bu sessiýada gözläň",
  "session.search.input": "Sessiýanyň habarlarynda gözläň",
  "session.search.scope": "Gözleg çägi",
  "session.search.scope.conversation": "Söhbet",
  "session.search.scope.all": "Ähli mazmun",
  "session.search.results": "{{total}} netijeden {{current}}",
  "session.search.noResults": "Netije tapylmady",
  "session.search.loading": "Netijeler ýüklenýär...",
  "session.search.partial": "Bölekleýin taryh",
  "session.search.retry": "Gaýtadan synanyşyň",
  "session.search.previous": "Öňki netije",
  "session.search.next": "Indiki netije",
  "session.search.close": "Gözlegi ýapyň",
