export const dict = {
  ...
  "desktop.menu.documentation": "OpenCtrlC Documentació",
  ...
  "desktop.menu.ariaLabel": "menú OpenCtrlC.",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra OpenCtrlC s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "OpenCtrlC no respon",
  ...
  "desktop.wsl.error.installOpenctrlc": "La instal·lació de OpenCtrlC ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.openctrlcMissing": "openctrlc no està instal·lat en aquesta distribució",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Permisos d'acceptació automàtica",
  "prompt.permissions.autoaccept.enabled": "Permisos d'acceptació automàtica",
  "prompt.permissions.autoaccept.enable": "Permisos d'acceptació automàtica",
  "prompt.permissions.autoaccept.disable": "Atura l'acceptació automàtica de permisos",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a OpenCtrlC.",
  ...
  "dialog.plugins.empty": "Connectors configurats a openctrlc.json",
  ...
  "dialog.server.description": "Canvia a quin OpenCtrlC servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "S'està comprovant OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "S'està registrant OpenCtrlC a {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "S'està actualitzant OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "S'està actualitzant OpenCtrlC a {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Actualitza OpenCtrlC a {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Actualització OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC està llest a {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC està llest.",
  "wsl.onboarding.installOpenctrlcIn": "Instal·leu OpenCtrlC a {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Instal·la OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que OpenCtrlC pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir OpenCtrlC.",
  ...
  "help.tabs.introduction": "OpenCtrlC L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip OpenCtrlC.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (openctrlc.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que OpenCtrlC encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor OpenCtrlC dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu OpenCtrlC al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si OpenCtrlC segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de OpenCtrlC.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï OpenCtrlC.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de OpenCtrlC.",
  ...
  "session.search.placeholder": "Cerca en aquesta sessió",
  "session.search.input": "Cerca als missatges de la sessió",
  "session.search.scope": "Àmbit de cerca",
  "session.search.scope.conversation": "Conversa",
  "session.search.scope.all": "Tot el contingut",
  "session.search.results": "{{current}} de {{total}} resultats",
  "session.search.noResults": "No s'han trobat resultats",
  "session.search.loading": "Carregant resultats...",
  "session.search.partial": "Historial parcial",
  "session.search.retry": "Torna-ho a provar",
  "session.search.previous": "Resultat anterior",
  "session.search.next": "Resultat següent",
  "session.search.close": "Tanca la cerca",
