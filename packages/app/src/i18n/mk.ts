export const dict = {
  ...
  "desktop.menu.documentation": "OpenCtrlC Документација",
  ...
  "desktop.menu.ariaLabel": "OpenCtrlC мени",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC не успеа да се вчита",
  "desktop.recovery.terminated": "Прозорецот OpenCtrlC неочекувано заврши",
  "desktop.recovery.unresponsive": "OpenCtrlC не реагира",
  ...
  "desktop.wsl.error.installOpenctrlc": "инсталацијата OpenCtrlC не успеа",
  "desktop.wsl.error.alreadyAdded": "{{distro}} е веќе додаден",
  "desktop.wsl.error.openctrlcMissing": "openctrlc не е инсталиран во оваа дистрибуција",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc е инсталиран, но не може да се изврши",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC не е инсталиран во {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC ажурирањето е завршено, но {{distro}} сè уште известува {{installed}}; се очекува {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Автоматско прифаќање дозволи",
  "prompt.permissions.autoaccept.enabled": "Автоматско прифаќање дозволи",
  "prompt.permissions.autoaccept.enable": "Автоматско прифаќање дозволи",
  "prompt.permissions.autoaccept.disable": "Стоп за автоматско прифаќање дозволи",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатни модели обезбедени од OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "Внесете го вашиот клуч {{provider}} API за да ја поврзете вашата сметка и да користите {{provider}} модели во OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "да го соберете вашиот код за авторизација за да ја поврзете вашата сметка и да користите {{provider}} модели во OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и внесете го кодот подолу за да ја поврзете вашата сметка и да користите {{provider}} модели во OpenCtrlC.",
  ...
  "dialog.plugins.empty": "Приклучоци конфигурирани во openctrlc.json",
  ...
  "dialog.server.description": "Променете на кој OpenCtrlC сервер се поврзува оваа апликација.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Се проверува OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Се проверува OpenCtrlC во {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Се ажурира OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Се ажурира OpenCtrlC во {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Ажурирајте OpenCtrlC во {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Ажурирај OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC е подготвен во {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC е подготвен.",
  "wsl.onboarding.installOpenctrlcIn": "Инсталирајте OpenCtrlC во {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Инсталирај OpenCtrlC",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) е потребно пред OpenCtrlC да може да додаде WSL сервер",
  "wsl.onboarding.wslUnavailable.title": "WSL недостапен",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC не можеше да го потврди WSL на оваа машина.",
  "wsl.onboarding.installWsl": "Инсталирај WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирајте го Windows за да завршите со инсталирањето WSL, а потоа повторно отворете OpenCtrlC.",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop сега е изграден околу картичките.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новата верзија на OpenCtrlC ({{version}}) сега е достапна за инсталирање.",
  ...
  "error.page.report.prefix": "Ве молиме пријавете ја оваа грешка на тимот OpenCtrlC",
  ...
  "error.chain.checkConfig": "Проверете ги имињата на давателот/моделот за конфигурација (openctrlc.json).",
  "error.chain.mcpFailed":
    "MCP серверот „{{name}}“ не успеа. Забелешка, OpenCtrlC сè уште не поддржува автентикација MCP.",
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC вклучува бесплатни модели за да можете веднаш да започнете.",
  ...
  "settings.desktop.wsl.description": "Стартувај го серверот OpenCtrlC во WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете го јазикот на прикажување за OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "Приспособете како изгледа OpenCtrlC на вашиот уред",
  "settings.general.row.colorScheme.title": "Шема на бои",
  "settings.general.row.colorScheme.description": "Изберете дали OpenCtrlC ја следи системската, светла или темна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Приспособете како OpenCtrlC е тематизирана.",
  ...
  "settings.updates.toast.latest.description": "Ја извршувате најновата верзија на OpenCtrlC.",
  ...
  "session.search.placeholder": "Пребарајте во оваа сесија",
  "session.search.input": "Пребарајте ги пораките во сесијата",
  "session.search.scope": "Опсег на пребарување",
  "session.search.scope.conversation": "Разговор",
  "session.search.scope.all": "Целата содржина",
  "session.search.results": "{{current}} од {{total}} резултати",
  "session.search.noResults": "Нема резултати",
  "session.search.loading": "Се вчитуваат резултатите...",
  "session.search.partial": "Делумна историја",
  "session.search.retry": "Обиди се повторно",
  "session.search.previous": "Претходен резултат",
  "session.search.next": "Следен резултат",
  "session.search.close": "Затвори го пребарувањето",
