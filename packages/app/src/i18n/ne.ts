export const dict: Record<string, string> = {
  ...
  "desktop.menu.documentation": "OpenCtrlC कागजात",
  ...
  "desktop.menu.ariaLabel": "OpenCtrlC मेनु",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC लोड हुन सकेन",
  "desktop.recovery.terminated": "OpenCtrlC विन्डो अप्रत्याशित रूपमा समाप्त भयो",
  "desktop.recovery.unresponsive": "OpenCtrlC ले प्रतिक्रिया दिइरहेको छैन",
  ...
  "desktop.wsl.error.installOpenctrlc": "OpenCtrlC स्थापना असफल भयो",
  "desktop.wsl.error.alreadyAdded": "{{distro}} पहिले नै थपिएको छ",
  "desktop.wsl.error.openctrlcMissing": "Opencode यस distro मा स्थापित छैन",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc स्थापित छ तर चलाउन सकिएन",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC {{distro}} मा स्थापित छैन",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC अद्यावधिक समाप्त भयो तर {{distro}} ले अझै पनि रिपोर्ट गर्छ {{installed}}; अपेक्षित {{expected}}",
  ...
  "prompt.permissions.autoaccept": "अनुमतिहरू स्वत: स्वीकार गर्नुहोस्",
  "prompt.permissions.autoaccept.enabled": "स्वत: स्वीकार गर्ने अनुमतिहरू",
  "prompt.permissions.autoaccept.enable": "अनुमतिहरू स्वत: स्वीकार गर्नुहोस्",
  "prompt.permissions.autoaccept.disable": "अनुमतिहरू स्वत: स्वीकार गर्न रोक्नुहोस्",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenCtrlC द्वारा प्रदान गरिएको नि:शुल्क मोडेलहरू",
  ...
  "provider.connect.apiKey.description":
    "आफ्नो खाता जडान गर्न आफ्नो {{provider}} API कुञ्जी प्रविष्ट गर्नुहोस् र OpenCtrlC मा {{provider}} मोडेलहरू प्रयोग गर्नुहोस्।",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "आफ्नो खाता जडान गर्न र OpenCtrlC मा {{provider}} मोडेलहरू प्रयोग गर्न आफ्नो प्राधिकरण कोड सङ्कलन गर्न।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "र आफ्नो खाता जडान गर्न तलको कोड प्रविष्ट गर्नुहोस् र {{provider}} मोडेलहरू OpenCtrlC मा प्रयोग गर्नुहोस्।",
  ...
  "dialog.plugins.empty": "openctrlc.json मा कन्फिगर गरिएका प्लगइनहरू",
  ...
  "dialog.server.description": "यो एप जडान भएको OpenCtrlC सर्भरलाई स्विच गर्नुहोस्।",
  ...
  "wsl.onboarding.checkingOpenctrlc": "OpenCtrlC जाँच गर्दै...",
  "wsl.onboarding.checkingOpenctrlcIn": "{{distro}} मा OpenCtrlC जाँच गर्दै...",
  "wsl.onboarding.updatingOpenctrlc": "अद्यावधिक गर्दै OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "{{distro}} मा OpenCtrlC अद्यावधिक गर्दै...",
  "wsl.onboarding.updateOpenctrlcIn": "अपडेट गर्नुहोस् OpenCtrlC {{distro}} मा।",
  "wsl.onboarding.updateOpenctrlc": "अपडेट गर्नुहोस् OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC {{distro}} मा तयार छ।",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC तयार छ।",
  "wsl.onboarding.installOpenctrlcIn": "{{distro}} मा OpenCtrlC स्थापना गर्नुहोस्।",
  "wsl.onboarding.installOpenctrlc": "OpenCtrlC स्थापना गर्नुहोस्",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC स्थापित छैन",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Linux को लागि सबसिस्टम) OpenCtrlC ले WSL सर्भर थप्न अघि आवश्यक छ।",
  "wsl.onboarding.wslUnavailable.title": "WSL उपलब्ध छैन",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC ले यो मेसिनमा WSL प्रमाणित गर्न सकेन।",
  "wsl.onboarding.installWsl": "WSL स्थापना गर्नुहोस्",
  "wsl.onboarding.windowsRestartRequired":
    "WSL स्थापना पूरा गर्न Windows पुन: सुरु गर्नुहोस्, त्यसपछि OpenCtrlC पुन: खोल्नुहोस्।",
  ...
  "help.tabs.introduction": "OpenCtrlC डेस्कटप अब ट्याब वरिपरि बनाइएको छ।",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "कृपया यो त्रुटि OpenCtrlC टोलीलाई रिपोर्ट गर्नुहोस्",
  ...
  "error.chain.checkConfig": "आफ्नो कन्फिगरेसन (openctrlc.json) प्रदायक/मोडेल नामहरू जाँच गर्नुहोस्",
  "error.chain.mcpFailed":
    'MCP सर्भर "{{name}}" असफल भयो। नोट गर्नुहोस्, OpenCtrlC ले अझै पनि MCP प्रमाणीकरणलाई समर्थन गर्दैन।',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC मा नि:शुल्क मोडेलहरू समावेश छन् ताकि तपाईं तुरुन्तै सुरु गर्न सक्नुहुन्छ।",
  ...
  "settings.desktop.wsl.description": "OpenCtrlC सर्भर भित्र WSL Windows मा चलाउनुहोस्।",
  ...
  "settings.general.row.language.description": "OpenCtrlC को लागि प्रदर्शन भाषा परिवर्तन गर्नुहोस्",
  ...
  "settings.general.row.appearance.description": "आफ्नो यन्त्रमा OpenCtrlC कस्तो देखिन्छ अनुकूलित गर्नुहोस्",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description":
    "OpenCtrlC ले प्रणाली, उज्यालो वा गाढा विषयवस्तुलाई फलो गर्छ कि गर्दैन भन्ने छनौट गर्नुहोस्",
  "settings.general.row.theme.title": "विषयवस्तु",
  "settings.general.row.theme.description": "कसरी OpenCtrlC विषयवस्तुलाई अनुकूलित गर्नुहोस्।",
  ...
  "settings.updates.row.startup.description": "OpenCtrlC सुरु हुँदा अद्यावधिकहरूको लागि स्वचालित रूपमा जाँच गर्नुहोस्",
  ...
  "settings.updates.toast.latest.description": "तपाईं OpenCtrlC को नवीनतम संस्करण चलाइरहनुभएको छ।",
  ...
  "session.search.placeholder": "यस सत्रमा खोज्नुहोस्",
  "session.search.input": "सत्रका सन्देशहरूमा खोज्नुहोस्",
  "session.search.scope": "खोजीको दायरा",
  "session.search.scope.conversation": "कुराकानी",
  "session.search.scope.all": "सबै सामग्री",
  "session.search.results": "{{total}} परिणाममध्ये {{current}}",
  "session.search.noResults": "कुनै परिणाम छैन",
  "session.search.loading": "परिणामहरू लोड हुँदैछन्...",
  "session.search.partial": "आंशिक इतिहास",
  "session.search.retry": "फेरि प्रयास गर्नुहोस्",
  "session.search.previous": "अघिल्लो परिणाम",
  "session.search.next": "अर्को परिणाम",
  "session.search.close": "खोजी बन्द गर्नुहोस्",
