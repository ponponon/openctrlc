export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'OpenCtrlC",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'OpenCtrlC",
  "desktop.recovery.terminated": "La fenêtre OpenCtrlC s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "OpenCtrlC ne répond pas",
  ...
  "desktop.wsl.error.installOpenctrlc": "Échec de l'installation d'OpenCtrlC",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.openctrlcMissing": "openctrlc n'est pas installé dans cette distribution",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "La mise à jour d'OpenCtrlC est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Accepter automatiquement les permissions",
  "prompt.permissions.autoaccept.enabled": "Acceptation automatique des permissions",
  "prompt.permissions.autoaccept.enable": "Accepter automatiquement les permissions",
  "prompt.permissions.autoaccept.disable": "Arrêter d'accepter automatiquement les permissions",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans OpenCtrlC.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans openctrlc.json",
  ...
  "dialog.server.description": "Changez le serveur OpenCtrlC auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Vérification d'OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Vérification d'OpenCtrlC dans {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Mise à jour d'OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Mise à jour d'OpenCtrlC dans {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Mettez à jour OpenCtrlC dans {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Mettre à jour OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC est prêt dans {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC est prêt.",
  "wsl.onboarding.installOpenctrlcIn": "Installez OpenCtrlC dans {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'OpenCtrlC puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez OpenCtrlC.",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'OpenCtrlC ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe OpenCtrlC",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (openctrlc.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'OpenCtrlC ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "OpenCtrlC inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur OpenCtrlC dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'OpenCtrlC sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si OpenCtrlC suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'OpenCtrlC.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'OpenCtrlC",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'OpenCtrlC.",
