...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða OpenCtrlC",
  "OpenCtrlC-glugganum var óvænt lokað",
  "OpenCtrlC svarar ekki",
  ...
  "Uppsetning OpenCtrlC mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "openctrlc er ekki uppsett í þessari dreifingu",
  "openctrlc er uppsett en ekki var hægt að keyra það",
  "OpenCtrlC er ekki uppsett í {{distro}}",
  "Uppfærslu OpenCtrlC lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "prompt.permissions.autoaccept": "Samþykkja sjálfkrafa heimildir",
  "prompt.permissions.autoaccept.enabled": "Sjálfvirkt samþykki heimilda",
  "prompt.permissions.autoaccept.enable": "Samþykkja sjálfkrafa heimildir",
  "prompt.permissions.autoaccept.disable": "Hætta að samþykkja heimildir sjálfkrafa",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í OpenCtrlC.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í openctrlc.json",
  ...
  "dialog.server.description": "Skiptu um hvaða OpenCtrlC miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Athugar OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Athugar OpenCtrlC í {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Uppfærir OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Uppfærir OpenCtrlC í {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Uppfærðu OpenCtrlC í {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Uppfærðu OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC er tilbúið í {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC er tilbúinn.",
  "wsl.onboarding.installOpenctrlcIn": "Settu upp OpenCtrlC í {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Settu upp OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en OpenCtrlC getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan OpenCtrlC aftur.",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til OpenCtrlC teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (openctrlc.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, OpenCtrlC styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "settings.desktop.wsl.description": "Keyrðu OpenCtrlC netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig OpenCtrlC lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort OpenCtrlC fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig OpenCtrlC er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar OpenCtrlC ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af OpenCtrlC.",
  ...
  "session.search.placeholder": "Leitaðu í þessari setu",
  "session.search.input": "Leitaðu í skilaboðum setunnar",
  "session.search.scope": "Leitarsvið",
  "session.search.scope.conversation": "Samtal",
  "session.search.scope.all": "Allt efni",
  "session.search.results": "{{current}} af {{total}} niðurstöðum",
  "session.search.noResults": "Engar niðurstöður",
  "session.search.loading": "Hleð niðurstöðum...",
  "session.search.partial": "Ófullkomin ferill",
  "session.search.retry": "Reyna aftur",
  "session.search.previous": "Fyrri niðurstaða",
  "session.search.next": "Næsta niðurstaða",
  "session.search.close": "Loka leit",
