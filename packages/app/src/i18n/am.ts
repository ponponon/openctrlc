export const dict = {
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC መጫን አልቻለም",
  "desktop.recovery.terminated": "OpenCtrlC መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "OpenCtrlC ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpenctrlc": "OpenCtrlCመጫኑ አልተሳካም",
  "desktop.wsl.error.alreadyAdded": "{{distro}} አስቀድሞ ታክሏል",
  "desktop.wsl.error.openctrlcMissing": "ክፍት ኮድ በዚህ ዲስትሪ ውስጥ አልተጫነም",
  "desktop.wsl.error.openctrlcCannotRun": "ክፍት ኮድ ተጭኗል ግን ማሄድ አልቻለም",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "prompt.permissions.autoaccept": "በራስ-ተቀበል ፈቃዶች",
  "prompt.permissions.autoaccept.enabled": "በራስ-ተቀባይ ፍቃዶች",
  "prompt.permissions.autoaccept.enable": "በራስ-ተቀበል ፈቃዶች",
  "prompt.permissions.autoaccept.disable": "በራስ-መቀበል ፍቃዶችን አቁም",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በOpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በOpenCtrlC ይጠቀሙ።",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በOpenCtrlC ውስጥ ይጠቀሙ።",
  ...
  "dialog.plugins.empty": "plugins በ openctrlc.json የተዋቀሩ",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው OpenCtrlC አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpenctrlc": "መፈተሽ OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "OpenCtrlCን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpenctrlc": "በማዘመን ላይ OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "በማዘመን ላይ OpenCtrlC በ{{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "አዘምን OpenCtrlC በ{{distro}}።",
  "wsl.onboarding.updateOpenctrlc": "አዘምን OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC ዝግጁ ነው።",
  "wsl.onboarding.installOpenctrlcIn": "መጫን OpenCtrlC በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpenctrlc": "ጫን OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlCአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) OpenCtrlC WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ OpenCtrlC።",
  ...
  "help.tabs.introduction": "OpenCtrlC ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለOpenCtrlC ቡድን ያሳውቁ",
  ...
  "error.chain.checkConfig": "የእርስዎን ውቅር (openctrlc.json) አቅራቢ/የሞዴል ስሞችን ያረጋግጡ",
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ OpenCtrlC እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "settings.desktop.wsl.description": "የOpenCtrlC አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለOpenCtrlC",
  ...
  "settings.general.row.appearance.description": "OpenCtrlCበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "OpenCtrlC ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "OpenCtrlC ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "OpenCtrlC ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የOpenCtrlC እትም እያሄዱ ነው።",
  ...
  "session.search.placeholder": "ይህን ክፍለ ጊዜ ይፈልጉ",
  "session.search.input": "የክፍለ ጊዜ መልዕክቶችን ይፈልጉ",
  "session.search.scope": "የፍለጋ ወሰን",
  "session.search.scope.conversation": "ውይይት",
  "session.search.scope.all": "ሁሉም ይዘት",
  "session.search.results": "{{total}} ውጤቶች ውስጥ {{current}}",
  "session.search.noResults": "ምንም ውጤት የለም",
  "session.search.loading": "ውጤቶች በመጫን ላይ...",
  "session.search.partial": "የተሟላ ያልሆነ ታሪክ",
  "session.search.retry": "እንደገና ሞክር",
  "session.search.previous": "የቀድሞ ውጤት",
  "session.search.next": "ቀጣይ ውጤት",
  "session.search.close": "ፍለጋን ዝጋ",
