export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni OpenCtrlC",
  ...
  "desktop.menu.ariaLabel": "Menuja OpenCtrlC",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja OpenCtrlC u mbyll papritur",
  "desktop.recovery.unresponsive": "OpenCtrlC nuk po përgjigjet",
  ...
  "desktop.wsl.error.installOpenctrlc": "Instalimi i OpenCtrlC dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.openctrlcMissing": "Opencode nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.openctrlcCannotRun": "Opencode është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "Përditësimi i OpenCtrlC përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Prano automatikisht lejet",
  "prompt.permissions.autoaccept.enabled": "Auto-pranimi i lejeve",
  "prompt.permissions.autoaccept.enable": "Prano automatikisht lejet",
  "prompt.permissions.autoaccept.disable": "Ndalo pranimin automatik të lejeve",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në OpenCtrlC.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në openctrlc.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server OpenCtrlC lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Po kontrollon OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Po kontrollon OpenCtrlC në {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "OpenCtrlC po përditësohet...",
  "wsl.onboarding.updatingOpenctrlcIn": "Po përditëson OpenCtrlC në {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Përditëso OpenCtrlC në {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Përditëso OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC është gati në {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC është gati.",
  "wsl.onboarding.installOpenctrlcIn": "Instaloni OpenCtrlC në {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Instaloni OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se OpenCtrlC të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap OpenCtrlC.",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i OpenCtrlC ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i OpenCtrlC",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (openctrlc.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, OpenCtrlC nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin OpenCtrlC brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket OpenCtrlC në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse OpenCtrlC ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e OpenCtrlC.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset OpenCtrlC",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të OpenCtrlC.",
  ...
  "session.search.placeholder": "Kërko në këtë sesion",
  "session.search.input": "Kërko në mesazhet e sesionit",
  "session.search.scope": "Fusha e kërkimit",
  "session.search.scope.conversation": "Bisedë",
  "session.search.scope.all": "E gjithë përmbajtja",
  "session.search.results": "{{current}} nga {{total}} rezultate",
  "session.search.noResults": "Nuk ka rezultate",
  "session.search.loading": "Po ngarkohen rezultatet...",
  "session.search.partial": "Historik i pjesshëm",
  "session.search.retry": "Provo përsëri",
  "session.search.previous": "Rezultati i mëparshëm",
  "session.search.next": "Rezultati tjetër",
  "session.search.close": "Mbyll kërkimin",
