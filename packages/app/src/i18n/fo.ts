export const dict = {
  ...
  "desktop.menu.documentation": "OpenCtrlC Skjøl",
  ...
  "desktop.menu.ariaLabel": "OpenCtrlC valmynd",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC miseydnaðist at heinta",
  "desktop.recovery.terminated": "OpenCtrlC vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "OpenCtrlC svarar ikki",
  ...
  "desktop.wsl.error.installOpenctrlc": "OpenCtrlC uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.openctrlcMissing": "openctrlc er ikki sett upp í hesi distro",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc er sett upp men kundi ikki koyra",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "prompt.permissions.autoaccept": "Sjálvvirkandi góðtaka loyvi",
  "prompt.permissions.autoaccept.enabled": "Sjálvvirkandi góðkenning av loyvum",
  "prompt.permissions.autoaccept.enable": "Sjálvvirkandi góðtaka loyvi",
  "prompt.permissions.autoaccept.disable": "Steðga sjálvvirkandi góðkenning av loyvum",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í OpenCtrlC.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í openctrlc.json",
  ...
  "dialog.server.description": "Skift hvønn OpenCtrlC ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Kanna OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Kanna OpenCtrlC í {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Dagføring OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Dagføring OpenCtrlC í {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Dagfør OpenCtrlC í {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Dagfør OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC er klárt í {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC er klárt.",
  "wsl.onboarding.installOpenctrlcIn": "Set OpenCtrlC upp í {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Set upp OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn OpenCtrlC kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani OpenCtrlC aftur.",
  ...
  "help.tabs.introduction": "OpenCtrlC Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av OpenCtrlC ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til OpenCtrlC toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (openctrlc.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, OpenCtrlC stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "settings.desktop.wsl.description": "Koyr OpenCtrlC ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu OpenCtrlC sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um OpenCtrlC fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu OpenCtrlC er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá OpenCtrlC byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av OpenCtrlC.",
  ...
  "session.search.placeholder": "Leita í hesi setuni",
  "session.search.input": "Leita í boðum setunnar",
  "session.search.scope": "Leitøki",
  "session.search.scope.conversation": "Samrøða",
  "session.search.scope.all": "Alt innihald",
  "session.search.results": "{{current}} av {{total}} úrslitum",
  "session.search.noResults": "Einki úrslit",
  "session.search.loading": "Lesi úrslit...",
  "session.search.partial": "Partvís søga",
  "session.search.retry": "Royn aftur",
  "session.search.previous": "Fyrra úrslit",
  "session.search.next": "Næsta úrslit",
  "session.search.close": "Lat leit aftur",
