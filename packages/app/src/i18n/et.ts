export const dict = {
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC laadimine ebaõnnestus",
  "desktop.recovery.terminated": "OpenCtrlC aken suleti ootamatult",
  "desktop.recovery.unresponsive": "OpenCtrlC ei vasta",
  ...
  "desktop.wsl.error.installOpenctrlc": "OpenCtrlC installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.openctrlcMissing": "openctrlc pole sellesse distrosse installitud",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Lubade automaatne aktsepteerimine",
  "prompt.permissions.autoaccept.enabled": "Lubade automaatne aktsepteerimine",
  "prompt.permissions.autoaccept.enable": "Lubade automaatne aktsepteerimine",
  "prompt.permissions.autoaccept.disable": "Peatage lubade automaatne vastuvõtmine",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid OpenCtrlC'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises OpenCtrlC.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis openctrlc.json",
  ...
  "dialog.server.description": "Lülitage, millise OpenCtrlC serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "OpenCtrlC kontrollimine...",
  "wsl.onboarding.checkingOpenctrlcIn": "OpenCtrlC kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "OpenCtrlC värskendamine...",
  "wsl.onboarding.updatingOpenctrlcIn": "OpenCtrlC värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Värskenda OpenCtrlC jaotises {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Värskenda OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC on valmis {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC on valmis.",
  "wsl.onboarding.installOpenctrlcIn": "Installige OpenCtrlC asukohta {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Installige OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui OpenCtrlC saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti OpenCtrlC.",
  ...
  "help.tabs.introduction": "OpenCtrlC Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "Teatage sellest veast OpenCtrlC meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (openctrlc.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, OpenCtrlC ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "settings.desktop.wsl.description": "Käivitage OpenCtrlC server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke OpenCtrlC kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas OpenCtrlC teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas OpenCtrlC järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas OpenCtrlC on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui OpenCtrlC käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse OpenCtrlC uusimat versiooni.",
  ...
  "session.search.placeholder": "Otsi sellest seansist",
  "session.search.input": "Otsi seansi sõnumitest",
  "session.search.scope": "Otsingu ulatus",
  "session.search.scope.conversation": "Vestlus",
  "session.search.scope.all": "Kogu sisu",
  "session.search.results": "{{current}} {{total}} tulemusest",
  "session.search.noResults": "Tulemusi pole",
  "session.search.loading": "Tulemuste laadimine...",
  "session.search.partial": "Osaline ajalugu",
  "session.search.retry": "Proovi uuesti",
  "session.search.previous": "Eelmine tulemus",
  "session.search.next": "Järgmine tulemus",
  "session.search.close": "Sulge otsing",
