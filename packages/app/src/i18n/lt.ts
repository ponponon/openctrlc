...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "OpenCtrlC įkelti nepavyko",
  "OpenCtrlC langas netikėtai užsidarė",
  "OpenCtrlC neatsako",
  ...
  "OpenCtrlC įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "openctrlc šiame distributyve neįdiegtas",
  "openctrlc įdiegtas, bet jo paleisti nepavyko",
  "OpenCtrlC neįdiegtas distributyve {{distro}}",
  "OpenCtrlC naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "prompt.permissions.autoaccept": "Automatiškai priimti leidimus",
  "prompt.permissions.autoaccept.enabled": "Automatinis leidimų priėmimas",
  "prompt.permissions.autoaccept.enable": "Automatiškai priimti leidimus",
  "prompt.permissions.autoaccept.disable": "Sustabdykite automatinį leidimų priėmimą",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami OpenCtrlC modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius OpenCtrlC.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio OpenCtrlC serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Tikrinama OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Tikrinama OpenCtrlC {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Atnaujinamas OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Atnaujinamas OpenCtrlC {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Atnaujinkite OpenCtrlC {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Atnaujinkite OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC yra paruoštas {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC yra paruoštas.",
  "wsl.onboarding.installOpenctrlcIn": "Įdiekite OpenCtrlC į {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Įdiekite OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad OpenCtrlC galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite OpenCtrlC.",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą OpenCtrlC komandai",
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "OpenCtrlC darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite OpenCtrlC serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite OpenCtrlC ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip OpenCtrlC atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar OpenCtrlC seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite OpenCtrlC temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas OpenCtrlC",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią OpenCtrlC versiją.",
  ...
  "session.search.placeholder": "Ieškoti šiame seanse",
  "session.search.input": "Ieškoti seanso pranešimuose",
  "session.search.scope": "Paieškos sritis",
  "session.search.scope.conversation": "Pokalbis",
  "session.search.scope.all": "Visas turinys",
  "session.search.results": "{{current}} iš {{total}} rezultatų",
  "session.search.noResults": "Rezultatų nėra",
  "session.search.loading": "Įkeliami rezultatai...",
  "session.search.partial": "Dalinė istorija",
  "session.search.retry": "Bandyti dar kartą",
  "session.search.previous": "Ankstesnis rezultatas",
  "session.search.next": "Kitas rezultatas",
  "session.search.close": "Užverti paiešką",
