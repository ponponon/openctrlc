...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in OpenCtrlC.",
  ...
  "dialog.plugins.empty": "Plugins configured in openctrlc.json",
  ...
  "dialog.server.description": "Switch which OpenCtrlC server this app connects to.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Checking OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Checking OpenCtrlC in {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Updating OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Updating OpenCtrlC in {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Update OpenCtrlC in {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Update OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC is ready in {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC is ready.",
  "wsl.onboarding.installOpenctrlcIn": "Install OpenCtrlC in {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Install OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before OpenCtrlC can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen OpenCtrlC.",
  ...
  "toast.update.description": "A new version of OpenCtrlC ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the OpenCtrlC team",
  ...
  "error.chain.checkConfig": "Check your config (openctrlc.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, OpenCtrlC does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the OpenCtrlC server inside WSL on Windows.",
  ...
  "settings.general.row.appearance.description": "Customise how OpenCtrlC looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether OpenCtrlC follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how OpenCtrlC is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when OpenCtrlC launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of OpenCtrlC.",
  ...
  "settings.skills.description":
    "See which skills are available to this project, where they came from, and which ones this session has used.",
