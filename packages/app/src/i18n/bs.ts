export const dict = {
  ...
  "desktop.wsl.error.installOpenctrlc": "Instalacija OpenCtrlC-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.openctrlcMissing": "openctrlc nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "Ažuriranje OpenCtrlC-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Automatski prihvati dozvole",
  "prompt.permissions.autoaccept.enabled": "Automatsko prihvatanje dozvola",
  "prompt.permissions.autoaccept.enable": "Automatski prihvati dozvole",
  "prompt.permissions.autoaccept.disable": "Zaustavi automatsko prihvatanje dozvola",
  ...
  "wsl.onboarding.checkingOpenctrlcIn": "Provjera OpenCtrlC u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Ažuriranje OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Ažuriranje OpenCtrlC u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Ažuriraj OpenCtrlC u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Ažuriraj OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC je spreman.",
  "wsl.onboarding.installOpenctrlcIn": "Instaliraj OpenCtrlC u distribuciji {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Instaliraj OpenCtrlC",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi OpenCtrlC mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori OpenCtrlC.",
  ...
  "settings.desktop.wsl.description": "Pokreni OpenCtrlC server unutar WSL-a na Windowsu.",
  ...
  "session.search.partial": "Djelimična historija",
