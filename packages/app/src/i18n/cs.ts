export const dict = {
  ...
  "desktop.menu.documentation": "OpenCtrlC Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka OpenCtrlC",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC se nepodařilo načíst",
  "desktop.recovery.terminated": "OpenCtrlC okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "OpenCtrlC nereaguje",
  ...
  "desktop.wsl.error.installOpenctrlc": "OpenCtrlC instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.openctrlcMissing": "openctrlc není v této distribuci nainstalováno",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC není nainstalován v {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Automaticky přijímat oprávnění",
  "prompt.permissions.autoaccept.enabled": "Automatické přijímání oprávnění",
  "prompt.permissions.autoaccept.enable": "Automaticky přijímat oprávnění",
  "prompt.permissions.autoaccept.disable": "Zastavit automatické přijímání oprávnění",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v OpenCtrlC.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v openctrlc.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému OpenCtrlC serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Kontrola OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Kontrola OpenCtrlC v {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Aktualizace OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Aktualizace OpenCtrlC v {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Aktualizace OpenCtrlC v {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Aktualizovat OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC je připraveno v {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC je připraven.",
  "wsl.onboarding.installOpenctrlcIn": "Nainstalujte OpenCtrlC do {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Instalovat OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než OpenCtrlC může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete OpenCtrlC.",
  ...
  "help.tabs.introduction": "OpenCtrlC Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu OpenCtrlC",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (openctrlc.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: OpenCtrlC zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server OpenCtrlC uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled OpenCtrlC na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude OpenCtrlC následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma OpenCtrlC.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění OpenCtrlC",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi OpenCtrlC.",
  ...
  "session.search.placeholder": "Hledat v této relaci",
  "session.search.input": "Hledat ve zprávách relace",
  "session.search.scope": "Rozsah hledání",
  "session.search.scope.conversation": "Konverzace",
  "session.search.scope.all": "Veškerý obsah",
  "session.search.results": "{{current}} z {{total}} výsledků",
  "session.search.noResults": "Žádné výsledky",
  "session.search.loading": "Načítání výsledků...",
  "session.search.partial": "Částečná historie",
  "session.search.retry": "Zkusit znovu",
  "session.search.previous": "Předchozí výsledek",
  "session.search.next": "Další výsledek",
  "session.search.close": "Zavřít hledání",
