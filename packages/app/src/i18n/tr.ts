...
export const dict = {
  ...
  "desktop.wsl.error.installOpenctrlc": "OpenCtrlC kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.openctrlcMissing": "openctrlc bu dağıtımda kurulu değil",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "prompt.permissions.autoaccept": "İzinleri otomatik kabul et",
  "prompt.permissions.autoaccept.enabled": "İzinler otomatik kabul ediliyor",
  "prompt.permissions.autoaccept.enable": "İzinleri otomatik kabul et",
  "prompt.permissions.autoaccept.disable": "İzinleri otomatik kabul etmeyi durdur",
  ...
  "wsl.onboarding.checkingOpenctrlc": "OpenCtrlC kontrol ediliyor...",
  "wsl.onboarding.checkingOpenctrlcIn": "{{distro}} içinde OpenCtrlC kontrol ediliyor...",
  "wsl.onboarding.updatingOpenctrlc": "OpenCtrlC güncelleniyor...",
  "wsl.onboarding.updatingOpenctrlcIn": "{{distro}} içinde OpenCtrlC güncelleniyor...",
  "wsl.onboarding.updateOpenctrlcIn": "{{distro}} içindeki OpenCtrlC'u güncelleyin.",
  "wsl.onboarding.updateOpenctrlc": "OpenCtrlC'u güncelle",
  "wsl.onboarding.openctrlcReadyIn": "{{distro}} içinde OpenCtrlC hazır.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC hazır.",
  "wsl.onboarding.installOpenctrlcIn": "OpenCtrlC'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpenctrlc": "OpenCtrlC'u kur",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "OpenCtrlC'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından OpenCtrlC'u tekrar açın.",
  ...
  "app.name.desktop": "OpenCtrlC Masaüstü",
  ...
  "settings.desktop.wsl.description": "OpenCtrlC sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "session.search.placeholder": "Bu oturumda ara",
  "session.search.input": "Oturum mesajlarında ara",
  "session.search.scope": "Arama kapsamı",
  "session.search.scope.conversation": "Konuşma",
  "session.search.scope.all": "Tüm içerik",
  "session.search.results": "{{total}} sonuçtan {{current}}",
  "session.search.noResults": "Sonuç yok",
  "session.search.loading": "Sonuçlar yükleniyor...",
  "session.search.partial": "Kısmi geçmiş",
  "session.search.retry": "Yeniden dene",
  "session.search.previous": "Önceki sonuç",
  "session.search.next": "Sonraki sonuç",
  "session.search.close": "Aramayı kapat",
