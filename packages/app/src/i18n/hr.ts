...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "OpenCtrlC se nije uspio učitati",
  "Prozor aplikacije OpenCtrlC neočekivano je zatvoren",
  "OpenCtrlC ne reagira",
  ...
  "Instalacija aplikacije OpenCtrlC nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "openctrlc nije instaliran u ovoj distribuciji",
  "openctrlc je instaliran, ali se ne može pokrenuti",
  "OpenCtrlC nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije OpenCtrlC je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "prompt.permissions.autoaccept": "Automatsko prihvaćanje dopuštenja",
  "prompt.permissions.autoaccept.enabled": "Automatsko prihvaćanje dopuštenja",
  "prompt.permissions.autoaccept.enable": "Automatsko prihvaćanje dopuštenja",
  "prompt.permissions.autoaccept.disable": "Zaustavi automatsko prihvaćanje dozvola",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u OpenCtrlC.",
  ...
  "dialog.server.description": "Promijenite na koji se OpenCtrlC poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Provjera OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Provjera OpenCtrlC u {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Ažuriranje OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Ažuriranje OpenCtrlC u {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Ažurirajte OpenCtrlC u {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Ažurirajte OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC je spreman u {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC je spreman.",
  "wsl.onboarding.installOpenctrlcIn": "Instalirajte OpenCtrlC u {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Instalirajte OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što OpenCtrlC može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite OpenCtrlC.",
  ...
  "help.tabs.introduction": "Radna površina OpenCtrlC sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "Prijavite ovu grešku OpenCtrlC timu",
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC uključuje besplatne modele tako da možete odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokrenite OpenCtrlC poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako OpenCtrlC izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li OpenCtrlC slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je OpenCtrlC tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se OpenCtrlC pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju OpenCtrlC.",
  ...
  "session.search.placeholder": "Pretraži ovu sesiju",
  "session.search.input": "Pretraži poruke sesije",
  "session.search.scope": "Opseg pretrage",
  "session.search.scope.conversation": "Razgovor",
  "session.search.scope.all": "Sav sadržaj",
  "session.search.results": "{{current}} od {{total}} rezultata",
  "session.search.noResults": "Nema rezultata",
  "session.search.loading": "Učitavanje rezultata...",
  "session.search.partial": "Djelomična historija",
  "session.search.retry": "Pokušaj ponovo",
  "session.search.previous": "Prethodni rezultat",
  "session.search.next": "Sljedeći rezultat",
  "session.search.close": "Zatvori pretragu",
