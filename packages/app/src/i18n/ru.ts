export const dict = {
  ...
  "desktop.menu.documentation": "Документация OpenCtrlC",
  ...
  "desktop.recovery.loadFailed": "Не удалось загрузить OpenCtrlC",
  "desktop.recovery.terminated": "Окно OpenCtrlC неожиданно завершило работу",
  "desktop.recovery.unresponsive": "OpenCtrlC не отвечает",
  ...
  "desktop.wsl.error.installOpenctrlc": "Не удалось установить OpenCtrlC",
  "desktop.wsl.error.alreadyAdded": "Дистрибутив {{distro}} уже добавлен",
  "desktop.wsl.error.openctrlcMissing": "openctrlc не установлен в этом дистрибутиве",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc установлен, но его не удалось запустить",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC не установлен в {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "Обновление OpenCtrlC завершено, но {{distro}} по-прежнему сообщает версию {{installed}}; ожидалась {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Автоматически принимать разрешения",
  "prompt.permissions.autoaccept.enabled": "Разрешения принимаются автоматически",
  "prompt.permissions.autoaccept.enable": "Автоматически принимать разрешения",
  "prompt.permissions.autoaccept.disable": "Остановить автоматическое принятие разрешений",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от OpenCtrlC",
  ...
  "provider.connect.apiKey.description":
    "Введите ключ API {{provider}}, чтобы подключить аккаунт и использовать модели {{provider}} в OpenCtrlC.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в OpenCtrlC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в OpenCtrlC.",
  ...
  "dialog.plugins.empty": "Плагины настроены в openctrlc.json",
  ...
  "dialog.server.description": "Выберите сервер OpenCtrlC, к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Проверка OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Проверка OpenCtrlC в {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Обновление OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Обновление OpenCtrlC в {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Обновите OpenCtrlC в {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Обновить OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC в {{distro}} готов к работе.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC готов к работе.",
  "wsl.onboarding.installOpenctrlcIn": "Установите OpenCtrlC в {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Установить OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в OpenCtrlC требуется WSL (Подсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте OpenCtrlC.",
  ...
  "help.tabs.introduction": "Теперь работа в OpenCtrlC Desktop организована с помощью вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новая версия OpenCtrlC ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде OpenCtrlC",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера и модели в конфигурации (openctrlc.json)",
  "error.chain.mcpFailed":
    'MCP-сервер "{{name}}" завершился с ошибкой. Обратите внимание: OpenCtrlC пока не поддерживает MCP-авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер OpenCtrlC внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения OpenCtrlC",
  ...
  "settings.general.row.appearance.description": "Настройте внешний вид OpenCtrlC на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли OpenCtrlC системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление OpenCtrlC.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске OpenCtrlC",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию OpenCtrlC.",
  ...
  "session.search.placeholder": "Поиск в этом сеансе",
  "session.search.input": "Поиск в сообщениях сеанса",
  "session.search.scope": "Область поиска",
  "session.search.scope.conversation": "Диалог",
  "session.search.scope.all": "Всё содержимое",
  "session.search.results": "{{current}} из {{total}} результатов",
  "session.search.noResults": "Нет результатов",
  "session.search.loading": "Загрузка результатов...",
  "session.search.partial": "Неполная история",
  "session.search.retry": "Повторить",
  "session.search.previous": "Предыдущий результат",
  "session.search.next": "Следующий результат",
  "session.search.close": "Закрыть поиск",
