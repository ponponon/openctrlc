export const dict = {
  ...
  "desktop.wsl.error.installOpenctrlc": "Instalasi OpenCtrlC gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.openctrlcMissing": "openctrlc belum terinstal di distro ini",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC belum terinstal di {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "Pembaruan OpenCtrlC selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "prompt.permissions.autoaccept": "Terima izin otomatis",
  "prompt.permissions.autoaccept.enabled": "Menerima izin secara otomatis",
  "prompt.permissions.autoaccept.enable": "Terima izin otomatis",
  "prompt.permissions.autoaccept.disable": "Hentikan penerimaan izin otomatis",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Memeriksa OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Memeriksa OpenCtrlC di {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Memperbarui OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Memperbarui OpenCtrlC di {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Perbarui OpenCtrlC di {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Perbarui OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC siap di {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC siap.",
  "wsl.onboarding.installOpenctrlcIn": "Instal OpenCtrlC di {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Instal OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum OpenCtrlC dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali OpenCtrlC.",
  ...
  "settings.desktop.wsl.description": "Jalankan server OpenCtrlC di dalam WSL di Windows.",
  ...
  "session.search.input": "Cari pesan sesi",
  "session.search.scope": "Ruang lingkup pencarian",
  "session.search.scope.conversation": "Percakapan",
  "session.search.scope.all": "Semua konten",
  "session.search.results": "{{current}} dari {{total}} hasil",
  "session.search.noResults": "Tidak ada hasil",
  "session.search.loading": "Memuat hasil...",
  "session.search.partial": "Riwayat sebagian",
  "session.search.retry": "Coba lagi",
  "session.search.previous": "Hasil sebelumnya",
  "session.search.next": "Hasil berikutnya",
  "session.search.close": "Tutup pencarian",
