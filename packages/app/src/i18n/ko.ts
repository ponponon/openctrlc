export const dict = {
  ...
  "prompt.permissions.autoaccept": "권한 자동 수락",
  "prompt.permissions.autoaccept.enabled": "권한 자동 수락 중",
  "prompt.permissions.autoaccept.enable": "권한 자동 수락",
  "prompt.permissions.autoaccept.disable": "권한 자동 수락 중지",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenCtrlC에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 OpenCtrlC에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 OpenCtrlC에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 OpenCtrlC에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.plugins.empty": "openctrlc.json에 구성된 플러그인",
  ...
  "dialog.server.description": "이 앱이 연결할 OpenCtrlC 서버를 전환합니다.",
  ...
  "toast.update.description": "OpenCtrlC의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 OpenCtrlC 팀에 제보해 주세요: ",
  ...
  "error.chain.checkConfig": "구성(openctrlc.json)의 공급자/모델 이름을 확인하세요",
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: OpenCtrlC는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 OpenCtrlC 서버를 실행합니다.",
  ...
  "settings.general.row.appearance.description": "기기에서 OpenCtrlC가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "OpenCtrlC가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "OpenCtrlC 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "OpenCtrlC를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 OpenCtrlC를 사용 중입니다.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "OpenCtrlC 확인 중...",
  "wsl.onboarding.checkingOpenctrlcIn": "{{distro}}에서 OpenCtrlC 확인 중...",
  "wsl.onboarding.updatingOpenctrlc": "OpenCtrlC 업데이트 중...",
  "wsl.onboarding.updatingOpenctrlcIn": "{{distro}}에서 OpenCtrlC 업데이트 중...",
  "wsl.onboarding.updateOpenctrlcIn": "{{distro}}에서 OpenCtrlC를 업데이트하세요.",
  "wsl.onboarding.updateOpenctrlc": "OpenCtrlC 업데이트",
  "wsl.onboarding.openctrlcReadyIn": "{{distro}}에서 OpenCtrlC를 사용할 준비가 되었습니다.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC가 준비되었습니다.",
  "wsl.onboarding.installOpenctrlcIn": "{{distro}}에 OpenCtrlC를 설치하세요.",
  "wsl.onboarding.installOpenctrlc": "OpenCtrlC 설치",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC가 설치되지 않음",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "OpenCtrlC에서 WSL 서버를 추가하려면 WSL (Windows Subsystem for Linux)이 필요합니다",
  "wsl.onboarding.wslUnavailable.title": "WSL을 사용할 수 없음",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC에서 이 컴퓨터의 WSL을 확인할 수 없습니다.",
  "wsl.onboarding.installWsl": "WSL 설치",
  "wsl.onboarding.windowsRestartRequired": "WSL 설치를 완료하려면 Windows를 다시 시작한 다음 OpenCtrlC를 다시 여세요.",
  ...
  "help.tabs.introduction": "이제 OpenCtrlC Desktop은 탭을 중심으로 구성됩니다.",
  "help.tabs.sessions":
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC를 불러오지 못했습니다",
  "desktop.recovery.terminated": "OpenCtrlC 윈도우가 예기치 않게 종료되었습니다",
  "desktop.recovery.unresponsive": "OpenCtrlC가 응답하지 않습니다",
  ...
  "desktop.wsl.error.installOpenctrlc": "OpenCtrlC 설치 실패",
  "desktop.wsl.error.alreadyAdded": "{{distro}} 배포판은 이미 추가되었습니다",
  "desktop.wsl.error.openctrlcMissing": "이 배포판에 openctrlc가 설치되어 있지 않습니다",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc가 설치되어 있지만 실행할 수 없습니다",
  "desktop.wsl.error.openctrlcNotInstalled": "{{distro}}에 OpenCtrlC가 설치되어 있지 않습니다",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC 업데이트가 완료되었지만 {{distro}}에서 여전히 {{installed}} 버전으로 표시됩니다. 예상 버전: {{expected}}",
