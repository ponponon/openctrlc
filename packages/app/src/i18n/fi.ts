export const dict = {
  ...
  "prompt.permissions.autoaccept": "Hyväksy käyttöoikeudet automaattisesti",
  "prompt.permissions.autoaccept.enabled": "Käyttöoikeudet hyväksytään automaattisesti",
  "prompt.permissions.autoaccept.enable": "Hyväksy käyttöoikeudet automaattisesti",
  "prompt.permissions.autoaccept.disable": "Lopeta käyttöoikeuksien automaattinen hyväksyminen",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenCtrlCn tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja OpenCtrlCssa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja OpenCtrlCssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja OpenCtrlCssa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään openctrlc.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda OpenCtrlC-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Tarkistetaan OpenCtrlCa...",
  "wsl.onboarding.checkingOpenctrlcIn": "Tarkistetaan OpenCtrlCa kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Päivitetään OpenCtrlCa...",
  "wsl.onboarding.updatingOpenctrlcIn": "Päivitetään OpenCtrlCa kohteessa {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Päivitä OpenCtrlC jakelussa {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Päivitä OpenCtrlC",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC on valmis jakelussa {{distro}}.",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC on valmis.",
  "wsl.onboarding.installOpenctrlcIn": "Asenna OpenCtrlC jakeluun {{distro}}.",
  "wsl.onboarding.installOpenctrlc": "Asenna OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlCa ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin OpenCtrlC voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten OpenCtrlC uudelleen.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä OpenCtrlC-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (openctrlc.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että OpenCtrlC ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita OpenCtrlC-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda OpenCtrlCn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä OpenCtrlC näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö OpenCtrlC järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta OpenCtrlCn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun OpenCtrlC käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät OpenCtrlCn uusinta versiota.",
  ...
  "desktop.menu.documentation": "OpenCtrlC-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "OpenCtrlC-valikko",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlCn lataaminen epäonnistui",
  "desktop.recovery.terminated": "OpenCtrlC-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "OpenCtrlC ei vastaa",
  ...
  "desktop.wsl.error.installOpenctrlc": "OpenCtrlCn asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.openctrlcMissing": "openctrlca ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlCa ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlCn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
