export const dict = {
  ...
  "prompt.permissions.autoaccept": "Accepter tilladelser automatisk",
  "prompt.permissions.autoaccept.enabled": "Accepterer tilladelser automatisk",
  "prompt.permissions.autoaccept.enable": "Accepter tilladelser automatisk",
  "prompt.permissions.autoaccept.disable": "Stop med at acceptere tilladelser automatisk",
  ...
  "wsl.onboarding.checkingOpenctrlc": "Tjekker OpenCtrlC...",
  "wsl.onboarding.checkingOpenctrlcIn": "Tjekker OpenCtrlC i {{distro}}...",
  "wsl.onboarding.updatingOpenctrlc": "Opdaterer OpenCtrlC...",
  "wsl.onboarding.updatingOpenctrlcIn": "Opdaterer OpenCtrlC i {{distro}}...",
  "wsl.onboarding.updateOpenctrlcIn": "Opdater OpenCtrlC i {{distro}}.",
  "wsl.onboarding.updateOpenctrlc": "Opdater OpenCtrlC",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før OpenCtrlC kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter OpenCtrlC igen.",
  ...
  "settings.desktop.wsl.description": "Kør OpenCtrlC-serveren inde i WSL på Windows.",
  ...
  "desktop.wsl.error.installOpenctrlc": "Installationen af OpenCtrlC mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.openctrlcMissing": "openctrlc er ikke installeret i denne distribution",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc er installeret, men kunne ikke køre",
  "desktop.wsl.error.openctrlcNotInstalled": "OpenCtrlC er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "Opdateringen af OpenCtrlC er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
