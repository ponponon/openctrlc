export const dict = {
  ...
  "desktop.menu.documentation": "OpenCtrlC دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "OpenCtrlC لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "OpenCtrlC دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "OpenCtrlC جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installOpenctrlc": "OpenCtrlC دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.openctrlcMissing": "اس ڈسٹرو وچ openctrlc انسٹال نئیں اے",
  "desktop.wsl.error.openctrlcCannotRun": "openctrlc انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.openctrlcNotInstalled": "{{distro}} وچ OpenCtrlC انسٹال نئیں اے",
  "desktop.wsl.error.updateOpenctrlcVersion":
    "OpenCtrlC دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "prompt.permissions.autoaccept": "خودکار اجازتاں قبول کرو",
  "prompt.permissions.autoaccept.enabled": "اجازتاں نوں خودکار قبول کرنا",
  "prompt.permissions.autoaccept.enable": "خودکار اجازتاں قبول کرو",
  "prompt.permissions.autoaccept.disable": "خودکار اجازتاں قبول کرنا بند کرو",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenCtrlC دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے OpenCtrlC وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے OpenCtrlC وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے OpenCtrlC وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "openctrlc.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس OpenCtrlC سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingOpenctrlc": "OpenCtrlC چیک کر رئے آں...",
  "wsl.onboarding.checkingOpenctrlcIn": "{{distro}} چ OpenCtrlC دی جانچ پڑتال...",
  "wsl.onboarding.updatingOpenctrlc": "OpenCtrlC نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingOpenctrlcIn": "{{distro}} وچ OpenCtrlC نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateOpenctrlcIn": "{{distro}} وچ OpenCtrlC نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateOpenctrlc": "OpenCtrlC اپ ڈیٹ کرو",
  "wsl.onboarding.openctrlcReadyIn": "OpenCtrlC {{distro}} چ تیار اے۔",
  "wsl.onboarding.openctrlcReady": "OpenCtrlC تیار اے۔",
  "wsl.onboarding.installOpenctrlcIn": "{{distro}} وچ OpenCtrlC انسٹال کرو۔",
  "wsl.onboarding.installOpenctrlc": "OpenCtrlC انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.openctrlcMissing": "OpenCtrlC انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "OpenCtrlC دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "OpenCtrlC ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر OpenCtrlC دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "OpenCtrlC Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "OpenCtrlC ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع OpenCtrlC ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (openctrlc.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، OpenCtrlC ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "OpenCtrlC چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر OpenCtrlC سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "OpenCtrlC لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے OpenCtrlC کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا OpenCtrlC سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "OpenCtrlC نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں OpenCtrlC لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی OpenCtrlC دا تازہ ترین ورژن چلا رئے او۔",
  ...
  "session.search.placeholder": "ਇਸ ਸੈਸ਼ਨ ਵਿੱਚ ਖੋਜੋ",
  "session.search.input": "ਸੈਸ਼ਨ ਸੁਨੇਹਿਆਂ ਵਿੱਚ ਖੋਜੋ",
  "session.search.scope": "ਖੋਜ ਦਾ ਘੇਰਾ",
  "session.search.scope.conversation": "ਗੱਲਬਾਤ",
  "session.search.scope.all": "ਸਾਰੀ ਸਮੱਗਰੀ",
  "session.search.results": "{{total}} ਨਤੀਜਿਆਂ ਵਿੱਚੋਂ {{current}}",
  "session.search.noResults": "ਕੋਈ ਨਤੀਜਾ ਨਹੀਂ",
  "session.search.loading": "ਨਤੀਜੇ ਲੋਡ ਹੋ ਰਹੇ ਹਨ...",
  "session.search.partial": "ਅਧੂਰਾ ਇਤਿਹਾਸ",
  "session.search.retry": "ਦੁਬਾਰਾ ਕੋਸ਼ਿਸ਼ ਕਰੋ",
  "session.search.previous": "ਪਿਛਲਾ ਨਤੀਜਾ",
  "session.search.next": "ਅਗਲਾ ਨਤੀਜਾ",
  "session.search.close": "ਖੋਜ ਬੰਦ ਕਰੋ",
