...
beforeAll(async () => {
  ...
  mock.module("@openctrlc/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@openctrlc/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@openctrlc/ui/icon", () => ({ Icon: () => null }))
  mock.module("@openctrlc/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
