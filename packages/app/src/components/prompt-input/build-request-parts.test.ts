...
describe("buildRequestParts", () => {
  ...
  test("preserves an external attachment source path for the model", () => {
      ...
      images: [
        {
          type: "image",
          id: "img_external",
          filename: "openctrlc.global.dat",
          sourcePath: "C:\\Users\\Luke\\AppData\\Roaming\\cn.quniv.openctrlc.beta\\openctrlc.global.dat",
          mime: "text/plain",
    ...
    expect(result.requestParts.find((part) => part.type === "file")?.filename).toBe(
      "C:\\Users\\Luke\\AppData\\Roaming\\cn.quniv.openctrlc.beta\\openctrlc.global.dat",
    )
  })
