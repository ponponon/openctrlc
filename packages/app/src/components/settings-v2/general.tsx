...
import { Switch } from "@openctrlc/ui/v2/switch-v2"
        ...
        <SettingsRowV2
          ...
          description={
            <>
              ...
              <ExternalLink class="settings-v2-link" href="https://openctrlc.pages.dev/docs/themes/">
  ...
  const GeneralSection = () => (
    <div class="settings-v2-section">
      <SettingsListV2>
        ...
        <Show when={mobile() && import.meta.env.VITE_OPENCTRLC_CHANNEL !== "prod"}>
          <SettingsRowV2
