...
import { showToast } from "@openctrlc/ui/toast"
...
import { LoaderV2 } from "@openctrlc/ui/v2/loader-v2"
import { RadioGroupV2, RadioItemV2 } from "@openctrlc/ui/v2/radio-v2"
...
function useWslAddServerController(props: DialogWslServerProps) {
  ...
  const runPrimary = async () => {
    ...
    if (action === "install-openctrlc") {
      await run(() => api.installOpenctrlc(distro))
      return
    }
