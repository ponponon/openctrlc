...
import { pluralCategory, type UiI18nPluralKey } from "@openctrlc/ui/context/i18n"
...
function readStoredLocale() {
  ...
  try {
    const raw = localStorage.getItem("openctrlc.global.dat:language")
    if (!raw) return
