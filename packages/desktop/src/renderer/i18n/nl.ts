export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van OpenCtrlC",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van OpenCtrlC is gedownload. Wil je deze installeren en OpenCtrlC opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'openctrlc' te gebruiken.",
