export const dict = {
  ...
  "desktop.updater.none.message": "OpenCtrlC-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenCtrlC-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'openctrlc' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",
