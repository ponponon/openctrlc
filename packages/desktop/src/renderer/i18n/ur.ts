export const dict = {
  ...
  "desktop.updater.none.message": "آپ پہلے ہی OpenCtrlC کا تازہ ترین ورژن استعمال کر رہے ہیں۔",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenCtrlC کا ورژن {{version}} ڈاؤن لوڈ ہو چکا ہے، کیا آپ اسے انسٹال کر کے دوبارہ لانچ کرنا چاہیں گے؟",
  ...
  "desktop.cli.installed.message":
    "CLI کو {{path}} پر انسٹال کر دیا گیا۔\n\n'openctrlc' کمانڈ استعمال کرنے کے لیے اپنا ٹرمینل دوبارہ شروع کریں۔",
