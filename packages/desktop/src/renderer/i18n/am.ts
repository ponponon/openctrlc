export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የOpenCtrlC ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከOpenCtrlC ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
