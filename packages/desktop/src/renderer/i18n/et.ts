export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse OpenCtrlC uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenCtrlC'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
  ...
  "desktop.cli.installed.message":
    "CLI installitud asukohta {{path}}\n\nKäsu „openctrlc” kasutamiseks taaskäivitage terminal.",
