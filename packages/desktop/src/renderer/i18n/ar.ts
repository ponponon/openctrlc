export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من OpenCtrlC",
  ...
  "desktop.updater.downloaded.prompt":
    "تم تنزيل الإصدار {{version}} من OpenCtrlC. هل ترغب في تثبيته وإعادة تشغيل التطبيق؟",
