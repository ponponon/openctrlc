export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon OpenCtrlC ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenCtrlCning {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'openctrlc' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",
