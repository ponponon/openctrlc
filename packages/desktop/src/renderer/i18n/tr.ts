export const dict = {
  ...
  "desktop.updater.none.message": "OpenCtrlC'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenCtrlC'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'openctrlc' komutunu kullanmak için terminalinizi yeniden başlatın.",
