export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo OpenCtrlCn uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenCtrlCn versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää OpenCtrlCn uudelleen?",
  ...
  "desktop.cli.installed.message":
    "CLI on asennettu polkuun {{path}}\n\nKäynnistä terminaali uudelleen, jotta voit käyttää 'openctrlc'-komentoa.",
