import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@openctrlc/sdk/v2"
import { SessionTurn } from "@openctrlc/session-ui/session-turn"
import { SessionReview } from "@openctrlc/session-ui/session-review"
import { DataProvider } from "@openctrlc/session-ui/context"
import { FileComponentProvider } from "@openctrlc/ui/context/file"
import { WorkerPoolProvider } from "@openctrlc/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@openctrlc/ui/logo"
import { IconButton } from "@openctrlc/ui/icon-button"
import { ProviderIcon } from "@openctrlc/ui/provider-icon"
import { iife } from "@openctrlc/core/util/iife"
...
import { MessageNav } from "@openctrlc/session-ui/message-nav"
import { FileSSR } from "@openctrlc/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@openctrlc/session-ui/pierre/worker").then((m) => ({
