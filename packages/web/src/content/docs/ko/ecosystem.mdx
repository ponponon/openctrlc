...
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | OpenCtrlC plugin 개발을 위한 템플릿입니다.                              |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | terminal 기반 AI 코딩 agent인 openctrlc용 Neovim frontend입니다.        |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | `@opencode-ai/sdk`로 OpenCtrlC를 사용하는 Vercel AI SDK provider입니다. |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | OpenCtrlC용 Web/Desktop App 및 VS Code Extension입니다.                 |
| [OpenCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian UI에 OpenCtrlC를 내장하는 Obsidian plugin입니다.               |
