...
server/runtime config schema는 [**`openctrlc.ai/config.json`**](https://opencode.ai/config.json)에 정의되어 있습니다.

TUI config는 [**`openctrlc.ai/tui.json`**](https://opencode.ai/tui.json)을 사용합니다.
