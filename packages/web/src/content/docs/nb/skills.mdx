...
Agentferdigheter lar OpenCtrlC oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går openctrlc opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
openctrlc viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `openctrlc.json`:
