---
title: Deling
description: Del dine OpenCtrlC-samtaler.
---

Delingsfunksjonen i OpenCtrlC lar deg lage offentlige lenker til dine OpenCtrlC-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, OpenCtrlC:
...
OpenCtrlC støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuell (standard)

Som standard bruker OpenCtrlC manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
...
For å håndheve dette på tvers av teamet ditt for et gitt prosjekt, legg det til `openctrlc.json` i prosjektet ditt og sjekk det inn i Git.
...
[Finn ut mer](/docs/enterprise) om bruk av openctrlc i organisasjonen din.
