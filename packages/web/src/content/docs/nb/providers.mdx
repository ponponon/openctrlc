...
1. Kjør kommandoen `/connect` i TUI, velg `OpenCtrlC Zen` og gå til [opencode.ai/auth](https://opencode.ai/zen).
...
1. Kjør kommandoen `/connect` i TUI, velg `OpenCtrlC Go`, og gå til [opencode.ai/auth](https://opencode.ai/zen).
