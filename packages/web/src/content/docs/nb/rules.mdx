...
Du kan spesifisere egendefinerte instruksjonsfiler i din `openctrlc.json` eller den globale `~/.config/opencode/openctrlc.json`. Dette lar deg og teamet ditt gjenbruke eksisterende regler i stedet for å måtte duplisere dem til AGENTS.md.
