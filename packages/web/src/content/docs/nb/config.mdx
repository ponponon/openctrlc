...
Plasser din globale OpenCode-konfigurasjon i `~/.config/openctrlc/openctrlc.json`. Bruk global konfigurasjon for brukerspesifikke preferanser som temaer, leverandører eller nøkkelbindinger.
