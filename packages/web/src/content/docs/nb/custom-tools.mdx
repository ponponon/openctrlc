...
description: Lag verktøy som LLM kan kalle inn OpenCtrlC.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med OpenCtrlC sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.openctrlc/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/openctrlc/tools/`.
