---
title: LSP-servere
description: openctrlc integreres med LSP-serverne dine.
---

OpenCtrlC kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

OpenCtrlC kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `OPENCTRLC_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og openctrlc åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i OpenCtrlC-konfigurasjonen.
