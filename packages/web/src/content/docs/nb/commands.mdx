...
Opprett `.openctrlc/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom OpenCtrlC-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i OpenCtrlC [config](/docs/config):
...
- Per prosjekt: `.openctrlc/commands/`
...
OpenCtrlC inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
