...
Erstellen Sie `.openctrlc/commands/test.md`:

```md title=".openctrlc/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die OpenCtrlC-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem OpenCtrlC [config](/docs/config):

```json title="openctrlc.jsonc" {4-12}
{
...
- Global: `~/.config/openctrlc/commands/`
- Pro Projekt: `.openctrlc/commands/`

```markdown title="~/.config/openctrlc/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".openctrlc/commands/component.md"
---
...
```md title=".openctrlc/commands/create-file.md"
---
...
```md title=".openctrlc/commands/analyze-coverage.md"
---
...
```md title=".openctrlc/commands/review-changes.md"
---
...
```md title=".openctrlc/commands/review-component.md"
---
...
OpenCtrlC enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
