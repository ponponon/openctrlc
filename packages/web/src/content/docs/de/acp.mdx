...
description: Verwenden Sie OpenCtrlC in jedem ACP-kompatiblen Editor.
---

OpenCtrlC unterstützt [Agent Client Protocol](https://agentclientprotocol.com) oder (ACP), sodass Sie es direkt in kompatiblen Editoren und IDEs verwenden können.
...
Um OpenCtrlC über ACP zu verwenden, konfigurieren Sie Ihren Editor für die Ausführung des Befehls `openctrlc acp`.

Der Befehl startet OpenCtrlC als ACP-kompatiblen Unterprozess, der über stdio über JSON-RPC mit Ihrem Editor kommuniziert.
...
Um es zu öffnen, verwenden Sie den neuen Agenten „OpenCtrlC“ in der AI Chat Agent Selector.
...
Um OpenCtrlC als ACP-Agent in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) zu verwenden, fügen Sie Folgendes zu Ihrer Neovim-Konfiguration hinzu:
...
Diese Konfiguration richtet CodeCompanion so ein, dass OpenCtrlC als ACP-Agent für den Chat verwendet wird.
...
OpenCtrlC funktioniert über ACP genauso wie im Terminal. Alle Funktionen werden unterstützt:
...
- MCP-Server, die in Ihrer OpenCtrlC-Konfiguration konfiguriert sind
