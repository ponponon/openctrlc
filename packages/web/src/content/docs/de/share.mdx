---
title: Teilen
description: Teile OpenCtrlC-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu OpenCtrlC-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht OpenCtrlC Folgendes:
...
OpenCtrlC hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt OpenCtrlC den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`openctrlc.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du openctrlc in deiner Organisation einsetzt.
