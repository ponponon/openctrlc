---
title: SDK
description: Typsicherer JS-Client fuer den openctrlc-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das openctrlc JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und openctrlc programmatisch steuern.
...
Erstelle eine openctrlc-Instanz:
...
`openctrlc.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn openctrlc bereits laeuft, kannst du nur einen Client erstellen und verbinden:
