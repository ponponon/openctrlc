...
Platzieren Sie Ihre globale OpenCode-Konfiguration in `~/.config/openctrlc/openctrlc.json`. Verwenden Sie die globale Konfiguration für benutzerweite Einstellungen wie Themen, Anbieter oder Tastenkombinationen.
