...
- **macOS/Linux**: `~/.config/opencode/openctrlc.jsonc` (oder `~/.config/opencode/openctrlc.json`)
- **macOS/Linux** (aeltere Installationen): `~/.local/share/opencode/openctrlc.jsonc`
