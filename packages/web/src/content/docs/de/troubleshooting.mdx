...
OpenCode Desktop startet im Hintergrund einen lokalen OpenCode-Server (`openctrlc-cli`-Sidecar).
...
- **Windows**: Druecke `WIN+R` und fuege ein: `%USERPROFILE%\.config\opencode\openctrlc.jsonc`
