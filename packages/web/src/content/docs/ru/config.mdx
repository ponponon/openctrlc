...
Файл конфигурации имеет схему, определенную в [**`openctrlc.ai/config.json`**](https://opencode.ai/config.json).

Конфигурация TUI использует [**`openctrlc.ai/tui.json`**](https://opencode.ai/tui.json).
