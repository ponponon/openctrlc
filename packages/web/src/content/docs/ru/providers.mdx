...
1. Запустите команду `/connect` в TUI, выберите `OpenCtrlC Zen` и перейдите по адресу [opencode.ai/auth](https://opencode.ai/zen).
...
1. Запустите команду `/connect` в TUI, выберите `OpenCtrlC Go` и перейдите по адресу [opencode.ai/auth](https://opencode.ai/zen).
