...
Mozete navesti prilagodene datoteke uputstava u `openctrlc.json` ili globalnom `~/.config/opencode/openctrlc.json`. Tako vi i tim ponovo koristite postojeca pravila bez dupliranja u AGENTS.md.
