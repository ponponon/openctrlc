---
title: TUI
description: Korištenje korisničkog interfejsa OpenCtrlC terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenCtrlC pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje OpenCtrlC pokreće TUI za trenutni direktorij.
...
Kada koristite OpenCtrlC TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u OpenCtrlC. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz OpenCtrlC. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `openctrlc.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo OpenCtrlC čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `openctrlc.default`.
