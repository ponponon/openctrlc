...
Kreiraj `.openctrlc/commands/test.md`:
...
Možete dodati prilagođene komande kroz OpenCtrlC konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom OpenCtrlC [config](/docs/config):
...
- Globalno: `~/.config/openctrlc/commands/`
- Po projektu: `.openctrlc/commands/`
...
OpenCtrlC uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
