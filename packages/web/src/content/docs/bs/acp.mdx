---
title: ACP podrška
description: Koristite OpenCtrlC u bilo kojem uređivaču kompatibilnom sa ACP.
---

OpenCtrlC podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili OpenCtrlC putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `openctrlc acp`.

Naredba pokreće OpenCtrlC kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "OpenCtrlC" agenta u AI Chat agent selektoru.
...
Da koristite OpenCtrlC kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi OpenCtrlC kao ACP chat agenta.
...
OpenCtrlC radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj OpenCtrlC konfiguraciji
