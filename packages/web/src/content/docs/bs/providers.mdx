...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite openctrlc i idite na [opencode.ai/auth](https://opencode.ai/auth).
...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite `OpenCtrlC Go` i idite na [opencode.ai/auth](https://opencode.ai/zen).
