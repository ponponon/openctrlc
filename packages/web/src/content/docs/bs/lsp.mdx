---
title: LSP serveri
description: OpenCtrlC se integriše sa vašim LSP serverima.
---

OpenCtrlC se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

OpenCtrlC dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `OPENCTRLC_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i openctrlc otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj openctrlc konfiguraciji.
