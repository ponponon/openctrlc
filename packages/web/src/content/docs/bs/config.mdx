...
Postavite svoju globalnu OpenCode konfiguraciju u `~/.config/openctrlc/openctrlc.json`. Koristite globalnu konfiguraciju za korisničke preferencije kao što su provajderi, modeli i dozvole.
