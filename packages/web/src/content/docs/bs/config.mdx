...
Konfiguracijski fajl ima šemu koja je definirana u [**`openctrlc.ai/config.json`**](https://opencode.ai/config.json).

TUI konfiguracija koristi [**`openctrlc.ai/tui.json`**](https://opencode.ai/tui.json).
