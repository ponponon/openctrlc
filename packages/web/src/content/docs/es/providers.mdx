...
1. Ejecute el comando `/connect` en TUI, seleccione openctrlc y diríjase a [opencode.ai/auth](https://opencode.ai/auth).
...
1. Ejecute el comando `/connect` en TUI, seleccione `OpenCtrlC Go` y diríjase a [opencode.ai/auth](https://opencode.ai/zen).
