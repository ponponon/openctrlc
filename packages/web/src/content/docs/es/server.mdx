...
El comando `openctrlc serve` ejecuta un servidor HTTP sin cabeza que expone un punto final OpenAPI que un cliente opencode puede usar.
...
opencode TUI ejecutándose, `openctrlc serve` iniciará un nuevo servidor.
