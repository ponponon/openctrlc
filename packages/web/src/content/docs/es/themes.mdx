...
Con OpenCtrlC puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, OpenCtrlC usa nuestro propio tema `openctrlc`.
...
OpenCtrlC viene con varios temas integrados.
...
- Quiere que OpenCtrlC coincida con la apariencia de su terminal
...
OpenCtrlC admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/openctrlc/themes/*.json` o `$XDG_CONFIG_HOME/openctrlc/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.openctrlc/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.openctrlc/themes/*.json`
