---
title: Compartir
description: Comparte tus conversaciones OpenCtrlC.
---

La función para compartir de OpenCtrlC te permite crear enlaces públicos a tus conversaciones de OpenCtrlC, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, OpenCtrlC:
...
OpenCtrlC admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, OpenCtrlC usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `openctrlc.json` en su proyecto y regístrelo en Git.
...
[Obtenga más información](/docs/enterprise) sobre el uso de openctrlc en su organización.
