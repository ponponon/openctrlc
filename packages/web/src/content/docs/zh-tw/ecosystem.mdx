...
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | 用於建置 OpenCtrlC 外掛程式的範本                              |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | OpenCtrlC 的 Neovim 前端——基於終端機的 AI 編碼代理             |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK 供應商，用於透過 @opencode-ai/sdk 使用 OpenCtrlC |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | OpenCtrlC 的 Web / 桌面應用程式和 VS Code 擴充功能             |
| [OpenCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | 將 OpenCtrlC 嵌入 Obsidian UI 的 Obsidian 外掛程式             |
