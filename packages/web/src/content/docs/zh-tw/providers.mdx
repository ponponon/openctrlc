...
1. 在 TUI 中執行 `/connect` 指令，選擇 `OpenCtrlC Zen`，然後前往 [opencode.ai/zen](https://opencode.ai/zen)。
...
1. 在 TUI 中執行 `/connect` 指令，選擇 `OpenCtrlC Go`，然後前往 [opencode.ai/zen](https://opencode.ai/zen)。
