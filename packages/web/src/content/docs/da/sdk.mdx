...
Brug den til at bygge integrasjoner og kontrollere openctrlc programmatisk.
...
Opret en forekomst av openctrlc:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `openctrlc.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av openctrlc, kan du oprete en klientforekomst for at koble til den:
