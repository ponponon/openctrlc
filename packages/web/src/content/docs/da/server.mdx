...
Kommandoen `openctrlc serve` kører en hovedløs HTTP-server, som afslører et OpenAPI-endpoint, som en opencode-klient kan bruge.
...
opencode TUI kørende, vil `openctrlc serve` starte en ny server.
