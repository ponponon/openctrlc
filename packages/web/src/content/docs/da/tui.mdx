---
title: TUI
description: Brug af OpenCtrlC-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenCtrlC giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre OpenCtrlC starter TUI for den nuværende mappe.
...
Når du bruger OpenCtrlC TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til OpenCtrlC. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut OpenCtrlC. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `openctrlc.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe OpenCtrlC venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `openctrlc.default`.
