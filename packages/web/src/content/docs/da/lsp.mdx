---
title: LSP-servere
description: OpenCtrlC integreres med dine LSP-servere.
---

OpenCtrlC kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

OpenCtrlC leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `OPENCTRLC_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og openctrlc åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din openctrlc-konfiguration.
