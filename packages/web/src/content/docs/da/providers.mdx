...
1. Kør kommandoen `/connect` i TUI, vælg openctrlc og gå til [opencode.ai/auth](https://opencode.ai/auth).
...
1. Kør kommandoen `/connect` i TUI, vælg `OpenCtrlC Go`, og gå til [opencode.ai/auth](https://opencode.ai/zen).
