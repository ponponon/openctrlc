...
O [model id](/docs/config/#models) na sua configuração do OpenCtrlC usa o formato `opencode/<model-id>`. Por exemplo, para GPT 5.5, você usaria `opencode/gpt-5.5` na sua configuração.
