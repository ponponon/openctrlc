...
O ID do modelo em sua configuração do openctrlc usa o formato `provider/model-id`. Por exemplo, se você estiver usando [OpenCtrlC Zen](/docs/zen), você usaria `opencode/gpt-5.1-codex` para GPT 5.1 Codex.
