...
1. Execute o comando `/connect` no TUI, selecione `OpenCtrlC Zen` e acesse [opencode.ai/zen](https://opencode.ai/zen).
...
1. Execute o comando `/connect` no TUI, selecione `OpenCtrlC Go` e acesse [opencode.ai/zen](https://opencode.ai/zen).
