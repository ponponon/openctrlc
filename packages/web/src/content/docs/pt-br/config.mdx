...
O esquema de configuração do servidor/tempo de execução é definido em [**`openctrlc.ai/config.json`**](https://opencode.ai/config.json).

A configuração do TUI usa [**`openctrlc.ai/tui.json`**](https://opencode.ai/tui.json).
