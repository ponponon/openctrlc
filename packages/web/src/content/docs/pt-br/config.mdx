...
Coloque sua configuração global do opencode em `~/.config/openctrlc/openctrlc.json`. Use a configuração global para preferências de todo o usuário, como provedores, modelos e permissões.
