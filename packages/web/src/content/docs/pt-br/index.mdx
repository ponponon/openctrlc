...
Se você é novo no uso de provedores de LLM, recomendamos usar o [seu provedor configurado](/docs/providers).
É uma lista selecionada de modelos que foram testados e verificados pela equipe do openctrlc.

1. Execute o comando `/connect` no TUI, selecione openctrlc e acesse [openctrlc.pages.dev/docs/providers](https://openctrlc.pages.dev/docs/providers).
