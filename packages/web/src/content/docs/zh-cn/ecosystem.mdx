...
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | 用于构建 OpenCtrlC 插件的模板                                  |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | OpenCtrlC 的 Neovim 前端——基于终端的 AI 编码代理               |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK 提供商，用于通过 @opencode-ai/sdk 使用 OpenCtrlC |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | OpenCtrlC 的 Web / 桌面应用和 VS Code 扩展                     |
| [OpenCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | 将 OpenCtrlC 嵌入 Obsidian UI 的 Obsidian 插件                 |
