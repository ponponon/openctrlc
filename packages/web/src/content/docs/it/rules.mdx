...
Puoi specificare file di istruzioni personalizzati nel tuo `openctrlc.json` o nel globale `~/.config/opencode/openctrlc.json`. Questo permette a te e al tuo team di riusare regole esistenti invece di doverle duplicare in AGENTS.md.
