...
Crea `.openctrlc/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di OpenCtrlC o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di OpenCtrlC:
...
- Globale: `~/.config/openctrlc/commands/`
- Per progetto: `.openctrlc/commands/`
...
openctrlc include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
