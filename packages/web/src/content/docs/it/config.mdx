...
Il file di configurazione ha uno schema definito in [**`openctrlc.ai/config.json`**](https://opencode.ai/config.json).

La configurazione TUI usa [**`openctrlc.ai/tui.json`**](https://opencode.ai/tui.json).
