...
L'ID modello nella configurazione OpenCtrlC usa il formato `provider/model-id`. Per esempio, se stai usando [OpenCtrlC Zen](/docs/zen), useresti `opencode/gpt-5.1-codex` per GPT 5.1 Codex.
