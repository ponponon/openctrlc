...
```javascript
import { createOpencode } from "@openctrlc-ai/sdk"
...
```javascript
import { createOpencodeClient } from "@openctrlc-ai/sdk"
...
```typescript
import type { Session, Message, Part } from "@openctrlc-ai/sdk"
```
