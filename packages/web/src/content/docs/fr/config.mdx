...
Le fichier de configuration a un schéma défini dans [**`openctrlc.ai/config.json`**](https://opencode.ai/config.json).

La configuration TUI utilise [**`openctrlc.ai/tui.json`**](https://opencode.ai/tui.json).
