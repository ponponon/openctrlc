...
Placez votre configuration globale OpenCode dans `~/.config/openctrlc/openctrlc.json`. Utilisez la configuration globale pour les préférences de l'utilisateur telles que les fournisseurs, les modèles et les autorisations.
