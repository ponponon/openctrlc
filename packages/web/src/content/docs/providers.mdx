...
1. Run the `/connect` command in the TUI, select `OpenCtrlC Zen`, and head to [opencode.ai/zen](https://opencode.ai/zen).
...
1. Run the `/connect` command in the TUI, select `OpenCtrlC Go`, and head to [opencode.ai/zen](https://opencode.ai/zen).
