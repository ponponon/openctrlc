...
يمكنك تحديد ملفات تعليمات مخصصة في `openctrlc.json` أو في الملف العام `~/.config/opencode/openctrlc.json`. يتيح ذلك لك ولفريقك إعادة استخدام القواعد الموجودة بدلًا من تكرارها داخل AGENTS.md.
