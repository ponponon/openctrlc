...
يشغّل الأمر `openctrlc serve` خادما HTTP دون واجهة ويعرض نقطة نهاية OpenAPI يمكن لعميل opencode استخدامها.
...
يمكنك تشغيل `openctrlc serve` لبدء خادم مستقل. إذا كانت واجهة opencode في terminal (TUI)
