...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في openctrlc.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في openctrlc مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.openctrlc/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/openctrlc/tools/`.
