---
title: TUI
description: استخدام واجهة المستخدم TUI في OpenCtrlC.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر OpenCtrlC واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل OpenCtrlC إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة OpenCtrlC في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى OpenCtrlC. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من OpenCtrlC. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `openctrlc.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار OpenCtrlC بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `openctrlc.default`.
