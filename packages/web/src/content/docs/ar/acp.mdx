---
title: دعم ACP
description: استخدم OpenCtrlC في أي محرر متوافق مع ACP.
---

يدعم OpenCtrlC بروتوكول [Agent Client Protocol](https://agentclientprotocol.com) أو (ACP)، مما يتيح لك استخدامه مباشرة في المحررات وبيئات التطوير المتكاملة (IDEs) المتوافقة.
...
لاستخدام OpenCtrlC عبر ACP، اضبط محررك ليشغّل الأمر `openctrlc acp`.

يشغّل هذا الأمر OpenCtrlC كعملية فرعية متوافقة مع ACP تتواصل مع محررك عبر JSON-RPC باستخدام stdio.
...
لفتحه، اختر الوكيل الجديد 'OpenCtrlC' من محدد الوكلاء في AI Chat.
...
لاستخدام OpenCtrlC كوكيل ACP في [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)، أضف التالي إلى إعدادات Neovim:
...
يضبط هذا الإعداد CodeCompanion لاستخدام OpenCtrlC كوكيل ACP للدردشة.
...
يعمل OpenCtrlC عبر ACP بالطريقة نفسها التي يعمل بها في terminal. جميع الميزات مدعومة:
...
- خوادم MCP المضبوطة في إعدادات OpenCtrlC
