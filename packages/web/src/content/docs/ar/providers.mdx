...
1. شغّل الأمر `/connect` في TUI، واختر openctrlc، ثم انتقل إلى [opencode.ai/auth](https://opencode.ai/auth).
...
1. شغّل الأمر `/connect` في TUI، واختر `OpenCtrlC Go`، ثم انتقل إلى [opencode.ai/auth](https://opencode.ai/zen).
