...
Możesz określić niestandardowe pliki instrukcji w swoim `openctrlc.json` lub globalnym `~/.config/opencode/openctrlc.json`. Dzięki temu Ty i Twój zespół możecie ponownie wykorzystać istniejące reguły, zamiast duplikować je w pliku AGENTS.md.
