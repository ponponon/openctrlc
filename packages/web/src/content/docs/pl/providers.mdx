...
1. Uruchom polecenie `/connect` w TUI, wybierz `OpenCtrlC Zen` i przejdź do [opencode.ai/zen](https://opencode.ai/zen).
...
1. Uruchom polecenie `/connect` w TUI, wybierz `OpenCtrlC Go` i przejdź do [opencode.ai/zen](https://opencode.ai/zen).
