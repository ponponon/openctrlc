...
Utwórz `.openctrlc/commands/test.md`:
...
Możesz zdefiniować polecenia w `openctrlc.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji openctrlc:
...
- Globalnie: `~/.config/openctrlc/commands/`
- Na projekt: `.openctrlc/commands/`
...
openctrlc zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
