...
Umieść swoją globalną konfigurację OpenCode w `~/.config/openctrlc/openctrlc.json`. Użyj jej do ustawień ogólnych dla użytkownika, takich jak dostawcy, modele i uprawnienia.
