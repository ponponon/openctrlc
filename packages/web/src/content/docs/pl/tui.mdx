---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala openctrlc.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

openctrlc zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie openctrlc uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI openctrlc, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do openctrlc. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij openctrlc. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `openctrlc.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo OpenCtrlC czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `openctrlc.default`.
