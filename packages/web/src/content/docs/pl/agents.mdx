...
Identyfikator modelu jest taki sam, jak w konfiguracji OpenCtrlC w `provider/model-id`. Na przykład, [OpenCtrlC Zen](/docs/zen), użyj `opencode/gpt-5.1-codex` dla GPT 5.1 Codex.
