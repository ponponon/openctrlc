---
title: ACP
description: Używanie OpenCtrlC z protokołem Agent Client Protocol (ACP).
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenCtrlC obsługuje [Agent Client Protocol](https://agentclientprotocol.com) (ACP), który umożliwia korzystanie z OpenCtrlC bezpośrednio w edytorach i środowiskach IDE.
...
Aby używać OpenCtrlC przez ACP, skonfiguruj swój edytor tak, aby uruchamiał polecenie `openctrlc acp`.

Uruchamia to OpenCtrlC jako podproces zgodny z ACP, który komunikuje się z edytorem za pomocą JSON-RPC przez stdio.
...
Następnie wybierz „OpenCtrlC” w selektorze agentów AI Chat.
...
Aby używać OpenCtrlC jako agenta ACP w [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodaj następującą konfigurację do Neovim:
...
Ta konfiguracja sprawia, że CodeCompanion używa OpenCtrlC jako agenta ACP do czatu.
...
OpenCtrlC działa przez ACP tak samo, jak w terminalu. Obsługiwane są wszystkie główne funkcje:
...
- Serwery MCP zdefiniowane w konfiguracji OpenCtrlC
