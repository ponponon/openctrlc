---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez OpenCtrlC.
---
...
OpenCtrlC Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół OpenCtrlC.

Zen działa jak każdy inny dostawca w OpenCtrlC. Logujesz się do OpenCtrlC Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z OpenCtrlC.
:::
...
OpenCtrlC Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

OpenCtrlC Zen działa jak każdy inny dostawca w OpenCtrlC.

1. Logujesz się do **<a href={console}>OpenCtrlC Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz OpenCtrlC Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji OpenCtrlC używa formatu
`openctrlc/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`opencode/gpt-5.5`.
...
W historii użycia możesz zauważyć [niedrogie modele](/docs/config/#models), takie jak Haiku, Nano lub Flash. OpenCtrlC używa tych modeli do generowania tytułów sesji.
...
- DeepSeek V4 Flash Free jest dostępny w OpenCtrlC przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w OpenCtrlC przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Hy3 Free jest dostępny w OpenCtrlC przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Laguna S 2.1 Free jest dostępny w OpenCtrlC przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w OpenCtrlC przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3.5 Lightning Free jest dostępny w OpenCtrlC przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w OpenCtrlC przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
Stworzyliśmy OpenCtrlC Zen, aby:
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w OpenCtrlC także dowolnego innego dostawcy.
