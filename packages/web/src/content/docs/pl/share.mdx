---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące openctrlc.
---

Funkcja udostępniania openctrlc umożliwia tworzenie publicznych linków do konwersacji openctrlc, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, openctrlc:
...
openctrlc obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie openctrlc korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `openctrlc.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu openctrlc w Twojej organizacji.
