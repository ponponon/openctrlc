...
สร้าง `.openctrlc/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ OpenCtrlC:
...
- ระดับผู้ใช้ (Global): `~/.config/openctrlc/commands/`
- ระดับโปรเจ็กต์: `.openctrlc/commands/`
...
OpenCtrlC มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
