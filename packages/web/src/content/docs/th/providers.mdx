...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก openctrlc และไปที่ [opencode.ai/auth](https://opencode.ai/auth)
...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก `OpenCtrlC Go` และไปที่ [opencode.ai/auth](https://opencode.ai/zen)
