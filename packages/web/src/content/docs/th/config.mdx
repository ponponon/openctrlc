...
ไฟล์กำหนดค่ามีสคีมาที่กำหนดไว้ใน [**`openctrlc.ai/config.json`**](https://opencode.ai/config.json)

การกำหนดค่า TUI ใช้ [**`openctrlc.ai/tui.json`**](https://opencode.ai/tui.json)
