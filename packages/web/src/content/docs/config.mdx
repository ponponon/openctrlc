...
The server/runtime config schema is defined in [**`openctrlc.ai/config.json`**](https://opencode.ai/config.json).

TUI config uses [**`openctrlc.ai/tui.json`**](https://opencode.ai/tui.json).
