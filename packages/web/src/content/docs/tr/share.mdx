---
title: Paylasim
description: openctrlc konusmalarini genel baglantilarla paylasin.
---

openctrlc'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda openctrlc:
...
openctrlc, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak openctrlc manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `openctrlc.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda openctrlc kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
