...
opencode, VS Code, Cursor veya bir terminali destekleyen herhangi bir IDE ile entegre olur. Başlamak için terminalde `openctrlc` komutunu çalıştırmanız yeterli.
