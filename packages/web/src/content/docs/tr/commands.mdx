...
`.openctrlc/commands/test.md` oluştur:
...
openctrlc işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

openctrlc [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/openctrlc/commands/`
- Proje başına: `.openctrlc/commands/`
...
openctrlc, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
