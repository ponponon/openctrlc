...
Global opencode yapılandırmanızı `~/.config/openctrlc/openctrlc.json` içine yerleştirin. Temalar, sağlayıcılar veya tuş atamaları gibi kullanıcı çapındaki tercihler için genel yapılandırmayı kullanın.
