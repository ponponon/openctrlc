---
title: SDK
description: openctrlc sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

openctrlc JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
openctrlc'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Bir openctrlc örneği oluşturun:
...
Davranışı özelleştirmek için bir yapılandırma nesnesi iletebilirsiniz. Örnek yine de `openctrlc.json` dosyanızı alır, ancak yapılandırmayı satır içi olarak geçersiz kılabilir veya ekleyebilirsiniz:
...
Halihazırda çalışan bir openctrlc örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
