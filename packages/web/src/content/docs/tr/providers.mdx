...
1. TUI'de `/connect` komutunu çalıştırın, openctrlc'u seçin ve [opencode.ai/auth](https://opencode.ai/auth)'ye gidin.
...
1. TUI'de `/connect` komutunu çalıştırın, `OpenCtrlC Go`'yu seçin ve [opencode.ai/auth](https://opencode.ai/zen) adresine gidin.
