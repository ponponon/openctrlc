...
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | OpenCtrlC eklentileri oluşturmak için şablon                                     |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | openctrlc için Neovim ön yüzü - terminal tabanlı bir yapay zeka kodlama aracısı  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | @opencode-ai/sdk aracılığıyla OpenCtrlC kullanmak için Vercel AI SDK sağlayıcısı |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | OpenCtrlC için Web / Masaüstü Uygulaması ve VS Code Uzantısı                     |
| [OpenCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | OpenCtrlC'u Obsidian arayüzüne gömen Obsidian eklentisi                          |
