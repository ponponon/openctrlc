...
import { ProjectDirectoryTable, ProjectTable } from "@openctrlc/core/project/sql"
import { ProjectDirectories } from "@openctrlc/core/project/directories"
...
import { which } from "@openctrlc/core/util/which"
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.OPENCTRLC_FAKE_VCS)
