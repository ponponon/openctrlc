...
import { EventSequenceTable, EventTable } from "@openctrlc/core/event/sql"
import { FSUtil } from "@openctrlc/core/fs-util"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { ProjectV2 } from "@openctrlc/core/project"
import { Slug } from "@openctrlc/core/util/slug"
...
import { WorkspaceEvent } from "@openctrlc/schema/workspace-event"
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        OPENCTRLC_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        OPENCTRLC_WORKSPACE_ID: config.id,
        OPENCTRLC_EXPERIMENTAL_WORKSPACES: "true",
