...
import { llmClient } from "@openctrlc/core/effect/app-node-platform"
...
import type { LLMEvent } from "@openctrlc/llm"
import { LLMClient } from "@openctrlc/llm/route"
import type { LLMClientService } from "@openctrlc/llm/route"
...
export type StreamInput = {
  ...
  onSystem?: (system: readonly string[]) => Effect.Effect<void>
}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      if (input.onSystem) yield* input.onSystem(prepared.system)
