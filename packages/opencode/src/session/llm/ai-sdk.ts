import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@openctrlc/llm"
...
// Move this extraction into @openctrlc/llm when Copilot is handled by the native runtime.
