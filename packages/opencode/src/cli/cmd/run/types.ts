// Shared type vocabulary for the direct interactive mode (`openctrlc --mini`).
//
...
import type { OpencodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@openctrlc/sdk/v2"
import type { TuiConfig } from "@openctrlc/tui/config"
