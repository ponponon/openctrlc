...
if (!Script.preview) {
  ...
  const binaryPkgbuild = [
    ...
    "depends=('ripgrep')",
    "",
    `source_aarch64=("\${pkgname}_\${pkgver}_aarch64.tar.gz::https://github.com/anomalyco/opencode/releases/download/v\${pkgver}\${_subver}/openctrlc-linux-arm64.tar.gz")`,
    `sha256sums_aarch64=('${arm64Sha}')`,

    `source_x86_64=("\${pkgname}_\${pkgver}_x86_64.tar.gz::https://github.com/anomalyco/opencode/releases/download/v\${pkgver}\${_subver}/openctrlc-linux-x64.tar.gz")`,
  ...
  const homebrewFormula = [
    ...
    "    if Hardware::CPU.intel?",
      `      url "https://github.com/anomalyco/opencode/releases/download/v${Script.version}/openctrlc-darwin-x64.zip"`,
    `      sha256 "${macX64Sha}"`,
    "",
    "      def install",
    ...
    "    end",
    "    if Hardware::CPU.arm?",
      `      url "https://github.com/anomalyco/opencode/releases/download/v${Script.version}/openctrlc-darwin-arm64.zip"`,
    `      sha256 "${macArm64Sha}"`,
    "",
    "      def install",
    '        bin.install "openctrlc"',
    ...
    "    if Hardware::CPU.intel? and Hardware::CPU.is_64_bit?",
      `      url "https://github.com/anomalyco/opencode/releases/download/v${Script.version}/openctrlc-linux-x64.tar.gz"`,
    `      sha256 "${x64Sha}"`,
    "      def install",
    '        bin.install "openctrlc"',
    "      end",
    ...
    "    if Hardware::CPU.arm? and Hardware::CPU.is_64_bit?",
      `      url "https://github.com/anomalyco/opencode/releases/download/v${Script.version}/openctrlc-linux-arm64.tar.gz"`,
    `      sha256 "${arm64Sha}"`,
    "      def install",
    '        bin.install "openctrlc"',
    "      end",
