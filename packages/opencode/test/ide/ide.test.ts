...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OPENCTRLC_CALLER", () => {
    process.env["OPENCTRLC_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OPENCTRLC_CALLER", () => {
    process.env["OPENCTRLC_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OPENCTRLC_CALLER", () => {
    process.env["OPENCTRLC_CALLER"] = "unknown"
