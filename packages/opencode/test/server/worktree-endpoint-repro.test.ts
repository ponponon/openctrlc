...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      OPENCTRLC_EXPERIMENTAL_WORKSPACES: Flag.OPENCTRLC_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.OPENCTRLC_EXPERIMENTAL_WORKSPACES = original.OPENCTRLC_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
