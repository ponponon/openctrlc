// Generated by @openctrlc/httpapi-codegen. Do not edit.
...
type Endpoint3_4Request = Parameters<RawClient["server.session"]["session.systemPromptSnapshot"]>[0]
...
const Endpoint3_4 = (raw: RawClient["server.session"]) => (input: Endpoint3_4Input) =>
  raw["session.systemPromptSnapshot"]({ params: { sessionID: input["sessionID"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )
...
const adaptGroup3 = (raw: RawClient["server.session"]) => ({
  ...
  get: Endpoint3_3(raw),
  systemPromptSnapshot: Endpoint3_4(raw),
