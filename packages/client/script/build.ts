...
import { compile, emitEffectImported, emitPromise, write } from "@openctrlc/httpapi-codegen"
        ...
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              ...
              import: 'import type { OpenCodeEventEncoded } from "@openctrlc/protocol/groups/event"',
            },
          },
        }),
