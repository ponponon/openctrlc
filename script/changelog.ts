...
Generates UPCOMING_CHANGELOG.md by running the OpenCtrlC changelog command.
...
Options:
  ...
  -t, --to <ref>         Ending ref (default: HEAD)
      ...
      --quiet            Suppress openctrlc command output unless it fails
