...
const required: Array<[string, string[]]> = [
  ...
  ["github/action.yml", ["https://raw.githubusercontent.com/ponponon/openctrlc/dev/install", "| OPENCTRLC_INSTALL_DIR=\"$HOME/.openctrlc/bin\" bash", "run: openctrlc github run"]],
