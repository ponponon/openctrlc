...
const env = {
  ...
  OPENCTRLC_TEST_HOME: directories["legacy-sentinel"],
...
if (beforeHash !== afterHash || new TextDecoder().decode(after) !== sentinelText)
...
console.log("OpenCtrlC runtime smoke passed")
