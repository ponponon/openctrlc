...
- `OpenCtrlC` (preserve casing in prose; keep `openctrlc` only when it is part of commands, package names, paths, or code)
- `OpenCtrlC Zen`
- `OpenCtrlC CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `openctrlc` in prose when referring to the product name; use `OpenCtrlC`
