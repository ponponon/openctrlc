...
- `OpenCtrlC` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `openctrlc` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `OpenCtrlC` in prose, `openctrlc` only for exact technical identifiers
...
- Avoid changing `openctrlc` to `OpenCtrlC` inside commands, URLs, package names, or code literals
